#[doc = "Reader of register SMDISMAP0"]
pub type R = crate::R<u16, super::SMDISMAP0>;
#[doc = "Writer for register SMDISMAP0"]
pub type W = crate::W<u16, super::SMDISMAP0>;
#[doc = "Register SMDISMAP0 `reset()`'s with value 0xffff"]
impl crate::ResetValue for super::SMDISMAP0 {
    type Type = u16;
    #[inline(always)]
