#[doc = "Reader of register SMCAPTCOMPX"]
pub type R = crate::R<u16, super::SMCAPTCOMPX>;
#[doc = "Writer for register SMCAPTCOMPX"]
pub type W = crate::W<u16, super::SMCAPTCOMPX>;
#[doc = "Register SMCAPTCOMPX `reset()`'s with value 0"]
impl crate::ResetValue for super::SMCAPTCOMPX {
    type Type = u16;
    #[inline(always)]
