#[doc = "Reader of register CS30"]
pub type R = crate::R<u32, super::CS30>;
#[doc = "Writer for register CS30"]
pub type W = crate::W<u32, super::CS30>;
#[doc = "Register CS30 `reset()`'s with value 0"]
impl crate::ResetValue for super::CS30 {
    type Type = u32;
    #[inline(always)]
