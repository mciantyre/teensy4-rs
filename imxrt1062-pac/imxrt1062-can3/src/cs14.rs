#[doc = "Reader of register CS14"]
pub type R = crate::R<u32, super::CS14>;
#[doc = "Writer for register CS14"]
pub type W = crate::W<u32, super::CS14>;
#[doc = "Register CS14 `reset()`'s with value 0"]
impl crate::ResetValue for super::CS14 {
    type Type = u32;
    #[inline(always)]
