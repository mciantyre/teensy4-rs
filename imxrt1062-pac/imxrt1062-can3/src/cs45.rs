#[doc = "Reader of register CS45"]
pub type R = crate::R<u32, super::CS45>;
#[doc = "Writer for register CS45"]
pub type W = crate::W<u32, super::CS45>;
#[doc = "Register CS45 `reset()`'s with value 0"]
impl crate::ResetValue for super::CS45 {
    type Type = u32;
    #[inline(always)]
