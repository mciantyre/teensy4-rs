#[doc = "Reader of register CS40"]
pub type R = crate::R<u32, super::CS40>;
#[doc = "Writer for register CS40"]
pub type W = crate::W<u32, super::CS40>;
#[doc = "Register CS40 `reset()`'s with value 0"]
impl crate::ResetValue for super::CS40 {
    type Type = u32;
    #[inline(always)]
