#[doc = "Reader of register CS24"]
pub type R = crate::R<u32, super::CS24>;
#[doc = "Writer for register CS24"]
pub type W = crate::W<u32, super::CS24>;
#[doc = "Register CS24 `reset()`'s with value 0"]
impl crate::ResetValue for super::CS24 {
    type Type = u32;
    #[inline(always)]
