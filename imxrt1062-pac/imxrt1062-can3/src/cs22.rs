#[doc = "Reader of register CS22"]
pub type R = crate::R<u32, super::CS22>;
#[doc = "Writer for register CS22"]
pub type W = crate::W<u32, super::CS22>;
#[doc = "Register CS22 `reset()`'s with value 0"]
impl crate::ResetValue for super::CS22 {
    type Type = u32;
    #[inline(always)]
