#[doc = "Reader of register ID48"]
pub type R = crate::R<u32, super::ID48>;
#[doc = "Writer for register ID48"]
pub type W = crate::W<u32, super::ID48>;
#[doc = "Register ID48 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID48 {
    type Type = u32;
    #[inline(always)]
