#[doc = "Reader of register CS51"]
pub type R = crate::R<u32, super::CS51>;
#[doc = "Writer for register CS51"]
pub type W = crate::W<u32, super::CS51>;
#[doc = "Register CS51 `reset()`'s with value 0"]
impl crate::ResetValue for super::CS51 {
    type Type = u32;
    #[inline(always)]
