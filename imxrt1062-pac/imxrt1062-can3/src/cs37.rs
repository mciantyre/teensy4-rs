#[doc = "Reader of register CS37"]
pub type R = crate::R<u32, super::CS37>;
#[doc = "Writer for register CS37"]
pub type W = crate::W<u32, super::CS37>;
#[doc = "Register CS37 `reset()`'s with value 0"]
impl crate::ResetValue for super::CS37 {
    type Type = u32;
    #[inline(always)]
