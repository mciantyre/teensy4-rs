#[doc = "Reader of register CS62"]
pub type R = crate::R<u32, super::CS62>;
#[doc = "Writer for register CS62"]
pub type W = crate::W<u32, super::CS62>;
#[doc = "Register CS62 `reset()`'s with value 0"]
impl crate::ResetValue for super::CS62 {
    type Type = u32;
    #[inline(always)]
