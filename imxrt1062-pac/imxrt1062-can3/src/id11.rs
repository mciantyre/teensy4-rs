#[doc = "Reader of register ID11"]
pub type R = crate::R<u32, super::ID11>;
#[doc = "Writer for register ID11"]
pub type W = crate::W<u32, super::ID11>;
#[doc = "Register ID11 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID11 {
    type Type = u32;
    #[inline(always)]
