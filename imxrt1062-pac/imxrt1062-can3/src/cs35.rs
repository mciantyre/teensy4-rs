#[doc = "Reader of register CS35"]
pub type R = crate::R<u32, super::CS35>;
#[doc = "Writer for register CS35"]
pub type W = crate::W<u32, super::CS35>;
#[doc = "Register CS35 `reset()`'s with value 0"]
impl crate::ResetValue for super::CS35 {
    type Type = u32;
    #[inline(always)]
