#[doc = "Reader of register CS29"]
pub type R = crate::R<u32, super::CS29>;
#[doc = "Writer for register CS29"]
pub type W = crate::W<u32, super::CS29>;
#[doc = "Register CS29 `reset()`'s with value 0"]
impl crate::ResetValue for super::CS29 {
    type Type = u32;
    #[inline(always)]
