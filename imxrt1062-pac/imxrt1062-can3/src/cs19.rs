#[doc = "Reader of register CS19"]
pub type R = crate::R<u32, super::CS19>;
#[doc = "Writer for register CS19"]
pub type W = crate::W<u32, super::CS19>;
#[doc = "Register CS19 `reset()`'s with value 0"]
impl crate::ResetValue for super::CS19 {
    type Type = u32;
    #[inline(always)]
