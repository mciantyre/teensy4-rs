#[doc = "Reader of register CS17"]
pub type R = crate::R<u32, super::CS17>;
#[doc = "Writer for register CS17"]
pub type W = crate::W<u32, super::CS17>;
#[doc = "Register CS17 `reset()`'s with value 0"]
impl crate::ResetValue for super::CS17 {
    type Type = u32;
    #[inline(always)]
