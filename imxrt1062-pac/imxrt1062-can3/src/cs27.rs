#[doc = "Reader of register CS27"]
pub type R = crate::R<u32, super::CS27>;
#[doc = "Writer for register CS27"]
pub type W = crate::W<u32, super::CS27>;
#[doc = "Register CS27 `reset()`'s with value 0"]
impl crate::ResetValue for super::CS27 {
    type Type = u32;
    #[inline(always)]
