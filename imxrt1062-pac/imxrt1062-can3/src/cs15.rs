#[doc = "Reader of register CS15"]
pub type R = crate::R<u32, super::CS15>;
#[doc = "Writer for register CS15"]
pub type W = crate::W<u32, super::CS15>;
#[doc = "Register CS15 `reset()`'s with value 0"]
impl crate::ResetValue for super::CS15 {
    type Type = u32;
    #[inline(always)]
