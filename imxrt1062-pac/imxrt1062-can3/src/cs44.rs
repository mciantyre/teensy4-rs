#[doc = "Reader of register CS44"]
pub type R = crate::R<u32, super::CS44>;
#[doc = "Writer for register CS44"]
pub type W = crate::W<u32, super::CS44>;
#[doc = "Register CS44 `reset()`'s with value 0"]
impl crate::ResetValue for super::CS44 {
    type Type = u32;
    #[inline(always)]
