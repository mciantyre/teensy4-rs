#[doc = "Reader of register ID36"]
pub type R = crate::R<u32, super::ID36>;
#[doc = "Writer for register ID36"]
pub type W = crate::W<u32, super::ID36>;
#[doc = "Register ID36 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID36 {
    type Type = u32;
    #[inline(always)]
