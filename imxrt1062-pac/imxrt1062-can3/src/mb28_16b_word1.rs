#[doc = "Reader of register MB28_16B_WORD1"]
pub type R = crate::R<u32, super::MB28_16B_WORD1>;
#[doc = "Writer for register MB28_16B_WORD1"]
pub type W = crate::W<u32, super::MB28_16B_WORD1>;
#[doc = "Register MB28_16B_WORD1 `reset()`'s with value 0"]
impl crate::ResetValue for super::MB28_16B_WORD1 {
    type Type = u32;
    #[inline(always)]
