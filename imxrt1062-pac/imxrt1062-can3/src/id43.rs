#[doc = "Reader of register ID43"]
pub type R = crate::R<u32, super::ID43>;
#[doc = "Writer for register ID43"]
pub type W = crate::W<u32, super::ID43>;
#[doc = "Register ID43 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID43 {
    type Type = u32;
    #[inline(always)]
