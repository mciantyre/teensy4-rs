#[doc = "Reader of register CS28"]
pub type R = crate::R<u32, super::CS28>;
#[doc = "Writer for register CS28"]
pub type W = crate::W<u32, super::CS28>;
#[doc = "Register CS28 `reset()`'s with value 0"]
impl crate::ResetValue for super::CS28 {
    type Type = u32;
    #[inline(always)]
