#[doc = "Reader of register ID32"]
pub type R = crate::R<u32, super::ID32>;
#[doc = "Writer for register ID32"]
pub type W = crate::W<u32, super::ID32>;
#[doc = "Register ID32 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID32 {
    type Type = u32;
    #[inline(always)]
