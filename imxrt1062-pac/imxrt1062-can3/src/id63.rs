#[doc = "Reader of register ID63"]
pub type R = crate::R<u32, super::ID63>;
#[doc = "Writer for register ID63"]
pub type W = crate::W<u32, super::ID63>;
#[doc = "Register ID63 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID63 {
    type Type = u32;
    #[inline(always)]
