#[doc = "Reader of register ID33"]
pub type R = crate::R<u32, super::ID33>;
#[doc = "Writer for register ID33"]
pub type W = crate::W<u32, super::ID33>;
#[doc = "Register ID33 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID33 {
    type Type = u32;
    #[inline(always)]
