#[doc = "Reader of register CS8"]
pub type R = crate::R<u32, super::CS8>;
#[doc = "Writer for register CS8"]
pub type W = crate::W<u32, super::CS8>;
#[doc = "Register CS8 `reset()`'s with value 0"]
impl crate::ResetValue for super::CS8 {
    type Type = u32;
    #[inline(always)]
