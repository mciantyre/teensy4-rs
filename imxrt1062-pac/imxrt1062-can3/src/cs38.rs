#[doc = "Reader of register CS38"]
pub type R = crate::R<u32, super::CS38>;
#[doc = "Writer for register CS38"]
pub type W = crate::W<u32, super::CS38>;
#[doc = "Register CS38 `reset()`'s with value 0"]
impl crate::ResetValue for super::CS38 {
    type Type = u32;
    #[inline(always)]
