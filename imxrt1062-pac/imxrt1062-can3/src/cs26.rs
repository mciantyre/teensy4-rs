#[doc = "Reader of register CS26"]
pub type R = crate::R<u32, super::CS26>;
#[doc = "Writer for register CS26"]
pub type W = crate::W<u32, super::CS26>;
#[doc = "Register CS26 `reset()`'s with value 0"]
impl crate::ResetValue for super::CS26 {
    type Type = u32;
    #[inline(always)]
