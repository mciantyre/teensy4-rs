#[doc = "Reader of register CS48"]
pub type R = crate::R<u32, super::CS48>;
#[doc = "Writer for register CS48"]
pub type W = crate::W<u32, super::CS48>;
#[doc = "Register CS48 `reset()`'s with value 0"]
impl crate::ResetValue for super::CS48 {
    type Type = u32;
    #[inline(always)]
