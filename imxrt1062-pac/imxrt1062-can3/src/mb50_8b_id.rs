#[doc = "Reader of register MB50_8B_ID"]
pub type R = crate::R<u32, super::MB50_8B_ID>;
#[doc = "Writer for register MB50_8B_ID"]
pub type W = crate::W<u32, super::MB50_8B_ID>;
#[doc = "Register MB50_8B_ID `reset()`'s with value 0"]
impl crate::ResetValue for super::MB50_8B_ID {
    type Type = u32;
    #[inline(always)]
