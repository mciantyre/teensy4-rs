#[doc = "Reader of register CS25"]
pub type R = crate::R<u32, super::CS25>;
#[doc = "Writer for register CS25"]
pub type W = crate::W<u32, super::CS25>;
#[doc = "Register CS25 `reset()`'s with value 0"]
impl crate::ResetValue for super::CS25 {
    type Type = u32;
    #[inline(always)]
