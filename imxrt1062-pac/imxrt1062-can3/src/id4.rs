#[doc = "Reader of register ID4"]
pub type R = crate::R<u32, super::ID4>;
#[doc = "Writer for register ID4"]
pub type W = crate::W<u32, super::ID4>;
#[doc = "Register ID4 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID4 {
    type Type = u32;
    #[inline(always)]
