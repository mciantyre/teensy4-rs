#[doc = "Reader of register ID22"]
pub type R = crate::R<u32, super::ID22>;
#[doc = "Writer for register ID22"]
pub type W = crate::W<u32, super::ID22>;
#[doc = "Register ID22 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID22 {
    type Type = u32;
    #[inline(always)]
