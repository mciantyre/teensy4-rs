#[doc = "Reader of register ID47"]
pub type R = crate::R<u32, super::ID47>;
#[doc = "Writer for register ID47"]
pub type W = crate::W<u32, super::ID47>;
#[doc = "Register ID47 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID47 {
    type Type = u32;
    #[inline(always)]
