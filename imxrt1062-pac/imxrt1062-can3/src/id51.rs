#[doc = "Reader of register ID51"]
pub type R = crate::R<u32, super::ID51>;
#[doc = "Writer for register ID51"]
pub type W = crate::W<u32, super::ID51>;
#[doc = "Register ID51 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID51 {
    type Type = u32;
    #[inline(always)]
