#[doc = "Reader of register CS13"]
pub type R = crate::R<u32, super::CS13>;
#[doc = "Writer for register CS13"]
pub type W = crate::W<u32, super::CS13>;
#[doc = "Register CS13 `reset()`'s with value 0"]
impl crate::ResetValue for super::CS13 {
    type Type = u32;
    #[inline(always)]
