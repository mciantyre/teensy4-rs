#[doc = "Reader of register ID46"]
pub type R = crate::R<u32, super::ID46>;
#[doc = "Writer for register ID46"]
pub type W = crate::W<u32, super::ID46>;
#[doc = "Register ID46 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID46 {
    type Type = u32;
    #[inline(always)]
