#[doc = "Reader of register ID35"]
pub type R = crate::R<u32, super::ID35>;
#[doc = "Writer for register ID35"]
pub type W = crate::W<u32, super::ID35>;
#[doc = "Register ID35 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID35 {
    type Type = u32;
    #[inline(always)]
