#[doc = "Reader of register CS12"]
pub type R = crate::R<u32, super::CS12>;
#[doc = "Writer for register CS12"]
pub type W = crate::W<u32, super::CS12>;
#[doc = "Register CS12 `reset()`'s with value 0"]
impl crate::ResetValue for super::CS12 {
    type Type = u32;
    #[inline(always)]
