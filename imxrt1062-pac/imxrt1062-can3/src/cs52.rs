#[doc = "Reader of register CS52"]
pub type R = crate::R<u32, super::CS52>;
#[doc = "Writer for register CS52"]
pub type W = crate::W<u32, super::CS52>;
#[doc = "Register CS52 `reset()`'s with value 0"]
impl crate::ResetValue for super::CS52 {
    type Type = u32;
    #[inline(always)]
