#[doc = "Reader of register CS36"]
pub type R = crate::R<u32, super::CS36>;
#[doc = "Writer for register CS36"]
pub type W = crate::W<u32, super::CS36>;
#[doc = "Register CS36 `reset()`'s with value 0"]
impl crate::ResetValue for super::CS36 {
    type Type = u32;
    #[inline(always)]
