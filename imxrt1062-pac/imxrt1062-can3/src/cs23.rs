#[doc = "Reader of register CS23"]
pub type R = crate::R<u32, super::CS23>;
#[doc = "Writer for register CS23"]
pub type W = crate::W<u32, super::CS23>;
#[doc = "Register CS23 `reset()`'s with value 0"]
impl crate::ResetValue for super::CS23 {
    type Type = u32;
    #[inline(always)]
