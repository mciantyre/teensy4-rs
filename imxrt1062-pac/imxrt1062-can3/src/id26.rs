#[doc = "Reader of register ID26"]
pub type R = crate::R<u32, super::ID26>;
#[doc = "Writer for register ID26"]
pub type W = crate::W<u32, super::ID26>;
#[doc = "Register ID26 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID26 {
    type Type = u32;
    #[inline(always)]
