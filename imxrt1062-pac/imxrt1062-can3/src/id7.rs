#[doc = "Reader of register ID7"]
pub type R = crate::R<u32, super::ID7>;
#[doc = "Writer for register ID7"]
pub type W = crate::W<u32, super::ID7>;
#[doc = "Register ID7 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID7 {
    type Type = u32;
    #[inline(always)]
