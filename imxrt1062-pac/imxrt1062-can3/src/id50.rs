#[doc = "Reader of register ID50"]
pub type R = crate::R<u32, super::ID50>;
#[doc = "Writer for register ID50"]
pub type W = crate::W<u32, super::ID50>;
#[doc = "Register ID50 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID50 {
    type Type = u32;
    #[inline(always)]
