#[doc = "Reader of register ID60"]
pub type R = crate::R<u32, super::ID60>;
#[doc = "Writer for register ID60"]
pub type W = crate::W<u32, super::ID60>;
#[doc = "Register ID60 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID60 {
    type Type = u32;
    #[inline(always)]
