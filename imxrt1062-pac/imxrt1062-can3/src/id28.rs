#[doc = "Reader of register ID28"]
pub type R = crate::R<u32, super::ID28>;
#[doc = "Writer for register ID28"]
pub type W = crate::W<u32, super::ID28>;
#[doc = "Register ID28 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID28 {
    type Type = u32;
    #[inline(always)]
