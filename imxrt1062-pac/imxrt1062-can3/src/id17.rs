#[doc = "Reader of register ID17"]
pub type R = crate::R<u32, super::ID17>;
#[doc = "Writer for register ID17"]
pub type W = crate::W<u32, super::ID17>;
#[doc = "Register ID17 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID17 {
    type Type = u32;
    #[inline(always)]
