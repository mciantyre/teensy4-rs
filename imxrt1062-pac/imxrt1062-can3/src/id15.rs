#[doc = "Reader of register ID15"]
pub type R = crate::R<u32, super::ID15>;
#[doc = "Writer for register ID15"]
pub type W = crate::W<u32, super::ID15>;
#[doc = "Register ID15 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID15 {
    type Type = u32;
    #[inline(always)]
