#[doc = "Reader of register ID45"]
pub type R = crate::R<u32, super::ID45>;
#[doc = "Writer for register ID45"]
pub type W = crate::W<u32, super::ID45>;
#[doc = "Register ID45 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID45 {
    type Type = u32;
    #[inline(always)]
