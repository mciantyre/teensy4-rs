#[doc = "Reader of register ID59"]
pub type R = crate::R<u32, super::ID59>;
#[doc = "Writer for register ID59"]
pub type W = crate::W<u32, super::ID59>;
#[doc = "Register ID59 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID59 {
    type Type = u32;
    #[inline(always)]
