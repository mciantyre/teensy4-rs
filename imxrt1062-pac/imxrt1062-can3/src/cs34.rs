#[doc = "Reader of register CS34"]
pub type R = crate::R<u32, super::CS34>;
#[doc = "Writer for register CS34"]
pub type W = crate::W<u32, super::CS34>;
#[doc = "Register CS34 `reset()`'s with value 0"]
impl crate::ResetValue for super::CS34 {
    type Type = u32;
    #[inline(always)]
