#[doc = "Reader of register MB4_16B_ID"]
pub type R = crate::R<u32, super::MB4_16B_ID>;
#[doc = "Writer for register MB4_16B_ID"]
pub type W = crate::W<u32, super::MB4_16B_ID>;
#[doc = "Register MB4_16B_ID `reset()`'s with value 0"]
impl crate::ResetValue for super::MB4_16B_ID {
    type Type = u32;
    #[inline(always)]
