#[doc = "Reader of register ID19"]
pub type R = crate::R<u32, super::ID19>;
#[doc = "Writer for register ID19"]
pub type W = crate::W<u32, super::ID19>;
#[doc = "Register ID19 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID19 {
    type Type = u32;
    #[inline(always)]
