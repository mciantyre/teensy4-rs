#[doc = "Reader of register CS41"]
pub type R = crate::R<u32, super::CS41>;
#[doc = "Writer for register CS41"]
pub type W = crate::W<u32, super::CS41>;
#[doc = "Register CS41 `reset()`'s with value 0"]
impl crate::ResetValue for super::CS41 {
    type Type = u32;
    #[inline(always)]
