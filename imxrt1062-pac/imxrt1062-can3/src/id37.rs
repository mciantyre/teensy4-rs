#[doc = "Reader of register ID37"]
pub type R = crate::R<u32, super::ID37>;
#[doc = "Writer for register ID37"]
pub type W = crate::W<u32, super::ID37>;
#[doc = "Register ID37 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID37 {
    type Type = u32;
    #[inline(always)]
