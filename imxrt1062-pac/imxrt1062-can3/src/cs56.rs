#[doc = "Reader of register CS56"]
pub type R = crate::R<u32, super::CS56>;
#[doc = "Writer for register CS56"]
pub type W = crate::W<u32, super::CS56>;
#[doc = "Register CS56 `reset()`'s with value 0"]
impl crate::ResetValue for super::CS56 {
    type Type = u32;
    #[inline(always)]
