#[doc = "Reader of register ID41"]
pub type R = crate::R<u32, super::ID41>;
#[doc = "Writer for register ID41"]
pub type W = crate::W<u32, super::ID41>;
#[doc = "Register ID41 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID41 {
    type Type = u32;
    #[inline(always)]
