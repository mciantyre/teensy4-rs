#[doc = "Reader of register MB5_8B_WORD0"]
pub type R = crate::R<u32, super::MB5_8B_WORD0>;
#[doc = "Writer for register MB5_8B_WORD0"]
pub type W = crate::W<u32, super::MB5_8B_WORD0>;
#[doc = "Register MB5_8B_WORD0 `reset()`'s with value 0"]
impl crate::ResetValue for super::MB5_8B_WORD0 {
    type Type = u32;
    #[inline(always)]
