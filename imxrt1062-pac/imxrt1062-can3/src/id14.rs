#[doc = "Reader of register ID14"]
pub type R = crate::R<u32, super::ID14>;
#[doc = "Writer for register ID14"]
pub type W = crate::W<u32, super::ID14>;
#[doc = "Register ID14 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID14 {
    type Type = u32;
    #[inline(always)]
