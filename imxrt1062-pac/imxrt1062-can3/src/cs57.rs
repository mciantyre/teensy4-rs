#[doc = "Reader of register CS57"]
pub type R = crate::R<u32, super::CS57>;
#[doc = "Writer for register CS57"]
pub type W = crate::W<u32, super::CS57>;
#[doc = "Register CS57 `reset()`'s with value 0"]
impl crate::ResetValue for super::CS57 {
    type Type = u32;
    #[inline(always)]
