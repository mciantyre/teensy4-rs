#[doc = "Reader of register CS53"]
pub type R = crate::R<u32, super::CS53>;
#[doc = "Writer for register CS53"]
pub type W = crate::W<u32, super::CS53>;
#[doc = "Register CS53 `reset()`'s with value 0"]
impl crate::ResetValue for super::CS53 {
    type Type = u32;
    #[inline(always)]
