#[doc = "Reader of register CS63"]
pub type R = crate::R<u32, super::CS63>;
#[doc = "Writer for register CS63"]
pub type W = crate::W<u32, super::CS63>;
#[doc = "Register CS63 `reset()`'s with value 0"]
impl crate::ResetValue for super::CS63 {
    type Type = u32;
    #[inline(always)]
