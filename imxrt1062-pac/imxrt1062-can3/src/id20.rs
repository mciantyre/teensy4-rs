#[doc = "Reader of register ID20"]
pub type R = crate::R<u32, super::ID20>;
#[doc = "Writer for register ID20"]
pub type W = crate::W<u32, super::ID20>;
#[doc = "Register ID20 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID20 {
    type Type = u32;
    #[inline(always)]
