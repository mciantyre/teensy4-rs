#[doc = "Reader of register ID18"]
pub type R = crate::R<u32, super::ID18>;
#[doc = "Writer for register ID18"]
pub type W = crate::W<u32, super::ID18>;
#[doc = "Register ID18 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID18 {
    type Type = u32;
    #[inline(always)]
