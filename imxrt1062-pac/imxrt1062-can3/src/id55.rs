#[doc = "Reader of register ID55"]
pub type R = crate::R<u32, super::ID55>;
#[doc = "Writer for register ID55"]
pub type W = crate::W<u32, super::ID55>;
#[doc = "Register ID55 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID55 {
    type Type = u32;
    #[inline(always)]
