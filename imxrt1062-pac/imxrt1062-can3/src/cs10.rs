#[doc = "Reader of register CS10"]
pub type R = crate::R<u32, super::CS10>;
#[doc = "Writer for register CS10"]
pub type W = crate::W<u32, super::CS10>;
#[doc = "Register CS10 `reset()`'s with value 0"]
impl crate::ResetValue for super::CS10 {
    type Type = u32;
    #[inline(always)]
