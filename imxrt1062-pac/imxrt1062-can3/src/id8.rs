#[doc = "Reader of register ID8"]
pub type R = crate::R<u32, super::ID8>;
#[doc = "Writer for register ID8"]
pub type W = crate::W<u32, super::ID8>;
#[doc = "Register ID8 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID8 {
    type Type = u32;
    #[inline(always)]
