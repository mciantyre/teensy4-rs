#[doc = "Reader of register ID16"]
pub type R = crate::R<u32, super::ID16>;
#[doc = "Writer for register ID16"]
pub type W = crate::W<u32, super::ID16>;
#[doc = "Register ID16 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID16 {
    type Type = u32;
    #[inline(always)]
