#[doc = "Reader of register CS43"]
pub type R = crate::R<u32, super::CS43>;
#[doc = "Writer for register CS43"]
pub type W = crate::W<u32, super::CS43>;
#[doc = "Register CS43 `reset()`'s with value 0"]
impl crate::ResetValue for super::CS43 {
    type Type = u32;
    #[inline(always)]
