#[doc = "Reader of register ID31"]
pub type R = crate::R<u32, super::ID31>;
#[doc = "Writer for register ID31"]
pub type W = crate::W<u32, super::ID31>;
#[doc = "Register ID31 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID31 {
    type Type = u32;
    #[inline(always)]
