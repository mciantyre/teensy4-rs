#[doc = "Reader of register ID54"]
pub type R = crate::R<u32, super::ID54>;
#[doc = "Writer for register ID54"]
pub type W = crate::W<u32, super::ID54>;
#[doc = "Register ID54 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID54 {
    type Type = u32;
    #[inline(always)]
