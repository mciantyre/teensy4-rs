#[doc = "Reader of register CS32"]
pub type R = crate::R<u32, super::CS32>;
#[doc = "Writer for register CS32"]
pub type W = crate::W<u32, super::CS32>;
#[doc = "Register CS32 `reset()`'s with value 0"]
impl crate::ResetValue for super::CS32 {
    type Type = u32;
    #[inline(always)]
