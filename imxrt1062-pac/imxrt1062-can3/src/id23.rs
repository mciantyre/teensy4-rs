#[doc = "Reader of register ID23"]
pub type R = crate::R<u32, super::ID23>;
#[doc = "Writer for register ID23"]
pub type W = crate::W<u32, super::ID23>;
#[doc = "Register ID23 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID23 {
    type Type = u32;
    #[inline(always)]
