#[doc = "Reader of register ID13"]
pub type R = crate::R<u32, super::ID13>;
#[doc = "Writer for register ID13"]
pub type W = crate::W<u32, super::ID13>;
#[doc = "Register ID13 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID13 {
    type Type = u32;
    #[inline(always)]
