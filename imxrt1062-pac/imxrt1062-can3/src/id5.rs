#[doc = "Reader of register ID5"]
pub type R = crate::R<u32, super::ID5>;
#[doc = "Writer for register ID5"]
pub type W = crate::W<u32, super::ID5>;
#[doc = "Register ID5 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID5 {
    type Type = u32;
    #[inline(always)]
