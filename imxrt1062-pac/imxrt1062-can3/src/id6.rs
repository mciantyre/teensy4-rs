#[doc = "Reader of register ID6"]
pub type R = crate::R<u32, super::ID6>;
#[doc = "Writer for register ID6"]
pub type W = crate::W<u32, super::ID6>;
#[doc = "Register ID6 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID6 {
    type Type = u32;
    #[inline(always)]
