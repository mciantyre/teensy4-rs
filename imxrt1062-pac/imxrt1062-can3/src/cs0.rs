#[doc = "Reader of register CS0"]
pub type R = crate::R<u32, super::CS0>;
#[doc = "Writer for register CS0"]
pub type W = crate::W<u32, super::CS0>;
#[doc = "Register CS0 `reset()`'s with value 0"]
impl crate::ResetValue for super::CS0 {
    type Type = u32;
    #[inline(always)]
