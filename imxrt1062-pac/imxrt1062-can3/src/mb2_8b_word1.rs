#[doc = "Reader of register MB2_8B_WORD1"]
pub type R = crate::R<u32, super::MB2_8B_WORD1>;
#[doc = "Writer for register MB2_8B_WORD1"]
pub type W = crate::W<u32, super::MB2_8B_WORD1>;
#[doc = "Register MB2_8B_WORD1 `reset()`'s with value 0"]
impl crate::ResetValue for super::MB2_8B_WORD1 {
    type Type = u32;
    #[inline(always)]
