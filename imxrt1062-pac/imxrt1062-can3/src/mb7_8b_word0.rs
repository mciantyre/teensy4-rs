#[doc = "Reader of register MB7_8B_WORD0"]
pub type R = crate::R<u32, super::MB7_8B_WORD0>;
#[doc = "Writer for register MB7_8B_WORD0"]
pub type W = crate::W<u32, super::MB7_8B_WORD0>;
#[doc = "Register MB7_8B_WORD0 `reset()`'s with value 0"]
impl crate::ResetValue for super::MB7_8B_WORD0 {
    type Type = u32;
    #[inline(always)]
