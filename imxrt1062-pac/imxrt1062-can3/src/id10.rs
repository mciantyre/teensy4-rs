#[doc = "Reader of register ID10"]
pub type R = crate::R<u32, super::ID10>;
#[doc = "Writer for register ID10"]
pub type W = crate::W<u32, super::ID10>;
#[doc = "Register ID10 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID10 {
    type Type = u32;
    #[inline(always)]
