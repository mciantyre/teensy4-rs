#[doc = "Reader of register ID49"]
pub type R = crate::R<u32, super::ID49>;
#[doc = "Writer for register ID49"]
pub type W = crate::W<u32, super::ID49>;
#[doc = "Register ID49 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID49 {
    type Type = u32;
    #[inline(always)]
