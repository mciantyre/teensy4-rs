#[doc = "Reader of register CS11"]
pub type R = crate::R<u32, super::CS11>;
#[doc = "Writer for register CS11"]
pub type W = crate::W<u32, super::CS11>;
#[doc = "Register CS11 `reset()`'s with value 0"]
impl crate::ResetValue for super::CS11 {
    type Type = u32;
    #[inline(always)]
