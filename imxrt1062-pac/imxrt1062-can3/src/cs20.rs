#[doc = "Reader of register CS20"]
pub type R = crate::R<u32, super::CS20>;
#[doc = "Writer for register CS20"]
pub type W = crate::W<u32, super::CS20>;
#[doc = "Register CS20 `reset()`'s with value 0"]
impl crate::ResetValue for super::CS20 {
    type Type = u32;
    #[inline(always)]
