#[doc = "Reader of register CS58"]
pub type R = crate::R<u32, super::CS58>;
#[doc = "Writer for register CS58"]
pub type W = crate::W<u32, super::CS58>;
#[doc = "Register CS58 `reset()`'s with value 0"]
impl crate::ResetValue for super::CS58 {
    type Type = u32;
    #[inline(always)]
