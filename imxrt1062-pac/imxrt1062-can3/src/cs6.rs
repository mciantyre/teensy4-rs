#[doc = "Reader of register CS6"]
pub type R = crate::R<u32, super::CS6>;
#[doc = "Writer for register CS6"]
pub type W = crate::W<u32, super::CS6>;
#[doc = "Register CS6 `reset()`'s with value 0"]
impl crate::ResetValue for super::CS6 {
    type Type = u32;
    #[inline(always)]
