#[doc = "Reader of register CS39"]
pub type R = crate::R<u32, super::CS39>;
#[doc = "Writer for register CS39"]
pub type W = crate::W<u32, super::CS39>;
#[doc = "Register CS39 `reset()`'s with value 0"]
impl crate::ResetValue for super::CS39 {
    type Type = u32;
    #[inline(always)]
