#[doc = "Reader of register CS47"]
pub type R = crate::R<u32, super::CS47>;
#[doc = "Writer for register CS47"]
pub type W = crate::W<u32, super::CS47>;
#[doc = "Register CS47 `reset()`'s with value 0"]
impl crate::ResetValue for super::CS47 {
    type Type = u32;
    #[inline(always)]
