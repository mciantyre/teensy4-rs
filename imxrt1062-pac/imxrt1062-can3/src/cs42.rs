#[doc = "Reader of register CS42"]
pub type R = crate::R<u32, super::CS42>;
#[doc = "Writer for register CS42"]
pub type W = crate::W<u32, super::CS42>;
#[doc = "Register CS42 `reset()`'s with value 0"]
impl crate::ResetValue for super::CS42 {
    type Type = u32;
    #[inline(always)]
