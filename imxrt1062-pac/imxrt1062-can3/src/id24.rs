#[doc = "Reader of register ID24"]
pub type R = crate::R<u32, super::ID24>;
#[doc = "Writer for register ID24"]
pub type W = crate::W<u32, super::ID24>;
#[doc = "Register ID24 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID24 {
    type Type = u32;
    #[inline(always)]
