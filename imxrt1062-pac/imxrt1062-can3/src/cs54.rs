#[doc = "Reader of register CS54"]
pub type R = crate::R<u32, super::CS54>;
#[doc = "Writer for register CS54"]
pub type W = crate::W<u32, super::CS54>;
#[doc = "Register CS54 `reset()`'s with value 0"]
impl crate::ResetValue for super::CS54 {
    type Type = u32;
    #[inline(always)]
