#[doc = "Reader of register ID29"]
pub type R = crate::R<u32, super::ID29>;
#[doc = "Writer for register ID29"]
pub type W = crate::W<u32, super::ID29>;
#[doc = "Register ID29 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID29 {
    type Type = u32;
    #[inline(always)]
