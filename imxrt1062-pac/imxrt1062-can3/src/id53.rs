#[doc = "Reader of register ID53"]
pub type R = crate::R<u32, super::ID53>;
#[doc = "Writer for register ID53"]
pub type W = crate::W<u32, super::ID53>;
#[doc = "Register ID53 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID53 {
    type Type = u32;
    #[inline(always)]
