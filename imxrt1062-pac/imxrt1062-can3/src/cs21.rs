#[doc = "Reader of register CS21"]
pub type R = crate::R<u32, super::CS21>;
#[doc = "Writer for register CS21"]
pub type W = crate::W<u32, super::CS21>;
#[doc = "Register CS21 `reset()`'s with value 0"]
impl crate::ResetValue for super::CS21 {
    type Type = u32;
    #[inline(always)]
