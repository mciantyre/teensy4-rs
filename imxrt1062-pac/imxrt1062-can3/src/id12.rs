#[doc = "Reader of register ID12"]
pub type R = crate::R<u32, super::ID12>;
#[doc = "Writer for register ID12"]
pub type W = crate::W<u32, super::ID12>;
#[doc = "Register ID12 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID12 {
    type Type = u32;
    #[inline(always)]
