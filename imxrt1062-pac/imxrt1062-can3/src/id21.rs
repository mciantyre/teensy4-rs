#[doc = "Reader of register ID21"]
pub type R = crate::R<u32, super::ID21>;
#[doc = "Writer for register ID21"]
pub type W = crate::W<u32, super::ID21>;
#[doc = "Register ID21 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID21 {
    type Type = u32;
    #[inline(always)]
