#[doc = "Reader of register ID9"]
pub type R = crate::R<u32, super::ID9>;
#[doc = "Writer for register ID9"]
pub type W = crate::W<u32, super::ID9>;
#[doc = "Register ID9 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID9 {
    type Type = u32;
    #[inline(always)]
