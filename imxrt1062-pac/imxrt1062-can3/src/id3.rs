#[doc = "Reader of register ID3"]
pub type R = crate::R<u32, super::ID3>;
#[doc = "Writer for register ID3"]
pub type W = crate::W<u32, super::ID3>;
#[doc = "Register ID3 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID3 {
    type Type = u32;
    #[inline(always)]
