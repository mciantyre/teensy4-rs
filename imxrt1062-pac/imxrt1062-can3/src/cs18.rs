#[doc = "Reader of register CS18"]
pub type R = crate::R<u32, super::CS18>;
#[doc = "Writer for register CS18"]
pub type W = crate::W<u32, super::CS18>;
#[doc = "Register CS18 `reset()`'s with value 0"]
impl crate::ResetValue for super::CS18 {
    type Type = u32;
    #[inline(always)]
