#[doc = "Reader of register CS55"]
pub type R = crate::R<u32, super::CS55>;
#[doc = "Writer for register CS55"]
pub type W = crate::W<u32, super::CS55>;
#[doc = "Register CS55 `reset()`'s with value 0"]
impl crate::ResetValue for super::CS55 {
    type Type = u32;
    #[inline(always)]
