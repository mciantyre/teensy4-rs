#[doc = "Reader of register CS46"]
pub type R = crate::R<u32, super::CS46>;
#[doc = "Writer for register CS46"]
pub type W = crate::W<u32, super::CS46>;
#[doc = "Register CS46 `reset()`'s with value 0"]
impl crate::ResetValue for super::CS46 {
    type Type = u32;
    #[inline(always)]
