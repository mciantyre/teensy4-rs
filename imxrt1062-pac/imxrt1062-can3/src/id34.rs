#[doc = "Reader of register ID34"]
pub type R = crate::R<u32, super::ID34>;
#[doc = "Writer for register ID34"]
pub type W = crate::W<u32, super::ID34>;
#[doc = "Register ID34 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID34 {
    type Type = u32;
    #[inline(always)]
