#[doc = "Reader of register ID42"]
pub type R = crate::R<u32, super::ID42>;
#[doc = "Writer for register ID42"]
pub type W = crate::W<u32, super::ID42>;
#[doc = "Register ID42 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID42 {
    type Type = u32;
    #[inline(always)]
