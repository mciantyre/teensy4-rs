#[doc = "Reader of register CS59"]
pub type R = crate::R<u32, super::CS59>;
#[doc = "Writer for register CS59"]
pub type W = crate::W<u32, super::CS59>;
#[doc = "Register CS59 `reset()`'s with value 0"]
impl crate::ResetValue for super::CS59 {
    type Type = u32;
    #[inline(always)]
