#[doc = "Reader of register CS49"]
pub type R = crate::R<u32, super::CS49>;
#[doc = "Writer for register CS49"]
pub type W = crate::W<u32, super::CS49>;
#[doc = "Register CS49 `reset()`'s with value 0"]
impl crate::ResetValue for super::CS49 {
    type Type = u32;
    #[inline(always)]
