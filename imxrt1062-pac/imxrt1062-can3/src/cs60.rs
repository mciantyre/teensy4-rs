#[doc = "Reader of register CS60"]
pub type R = crate::R<u32, super::CS60>;
#[doc = "Writer for register CS60"]
pub type W = crate::W<u32, super::CS60>;
#[doc = "Register CS60 `reset()`'s with value 0"]
impl crate::ResetValue for super::CS60 {
    type Type = u32;
    #[inline(always)]
