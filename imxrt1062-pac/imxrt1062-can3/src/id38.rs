#[doc = "Reader of register ID38"]
pub type R = crate::R<u32, super::ID38>;
#[doc = "Writer for register ID38"]
pub type W = crate::W<u32, super::ID38>;
#[doc = "Register ID38 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID38 {
    type Type = u32;
    #[inline(always)]
