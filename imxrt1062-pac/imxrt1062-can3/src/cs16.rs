#[doc = "Reader of register CS16"]
pub type R = crate::R<u32, super::CS16>;
#[doc = "Writer for register CS16"]
pub type W = crate::W<u32, super::CS16>;
#[doc = "Register CS16 `reset()`'s with value 0"]
impl crate::ResetValue for super::CS16 {
    type Type = u32;
    #[inline(always)]
