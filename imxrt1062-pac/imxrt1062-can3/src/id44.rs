#[doc = "Reader of register ID44"]
pub type R = crate::R<u32, super::ID44>;
#[doc = "Writer for register ID44"]
pub type W = crate::W<u32, super::ID44>;
#[doc = "Register ID44 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID44 {
    type Type = u32;
    #[inline(always)]
