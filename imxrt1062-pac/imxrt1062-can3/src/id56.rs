#[doc = "Reader of register ID56"]
pub type R = crate::R<u32, super::ID56>;
#[doc = "Writer for register ID56"]
pub type W = crate::W<u32, super::ID56>;
#[doc = "Register ID56 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID56 {
    type Type = u32;
    #[inline(always)]
