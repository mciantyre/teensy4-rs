#[doc = "Reader of register ID40"]
pub type R = crate::R<u32, super::ID40>;
#[doc = "Writer for register ID40"]
pub type W = crate::W<u32, super::ID40>;
#[doc = "Register ID40 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID40 {
    type Type = u32;
    #[inline(always)]
