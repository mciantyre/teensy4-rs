#[doc = "Reader of register ID57"]
pub type R = crate::R<u32, super::ID57>;
#[doc = "Writer for register ID57"]
pub type W = crate::W<u32, super::ID57>;
#[doc = "Register ID57 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID57 {
    type Type = u32;
    #[inline(always)]
