#[doc = "Reader of register CS31"]
pub type R = crate::R<u32, super::CS31>;
#[doc = "Writer for register CS31"]
pub type W = crate::W<u32, super::CS31>;
#[doc = "Register CS31 `reset()`'s with value 0"]
impl crate::ResetValue for super::CS31 {
    type Type = u32;
    #[inline(always)]
