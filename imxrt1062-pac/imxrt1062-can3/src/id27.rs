#[doc = "Reader of register ID27"]
pub type R = crate::R<u32, super::ID27>;
#[doc = "Writer for register ID27"]
pub type W = crate::W<u32, super::ID27>;
#[doc = "Register ID27 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID27 {
    type Type = u32;
    #[inline(always)]
