#[doc = "Reader of register ID58"]
pub type R = crate::R<u32, super::ID58>;
#[doc = "Writer for register ID58"]
pub type W = crate::W<u32, super::ID58>;
#[doc = "Register ID58 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID58 {
    type Type = u32;
    #[inline(always)]
