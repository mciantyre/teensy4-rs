#[doc = "Reader of register ID61"]
pub type R = crate::R<u32, super::ID61>;
#[doc = "Writer for register ID61"]
pub type W = crate::W<u32, super::ID61>;
#[doc = "Register ID61 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID61 {
    type Type = u32;
    #[inline(always)]
