#[doc = "Reader of register ID39"]
pub type R = crate::R<u32, super::ID39>;
#[doc = "Writer for register ID39"]
pub type W = crate::W<u32, super::ID39>;
#[doc = "Register ID39 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID39 {
    type Type = u32;
    #[inline(always)]
