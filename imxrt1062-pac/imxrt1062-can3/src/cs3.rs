#[doc = "Reader of register CS3"]
pub type R = crate::R<u32, super::CS3>;
#[doc = "Writer for register CS3"]
pub type W = crate::W<u32, super::CS3>;
#[doc = "Register CS3 `reset()`'s with value 0"]
impl crate::ResetValue for super::CS3 {
    type Type = u32;
    #[inline(always)]
