#[doc = "Reader of register CS7"]
pub type R = crate::R<u32, super::CS7>;
#[doc = "Writer for register CS7"]
pub type W = crate::W<u32, super::CS7>;
#[doc = "Register CS7 `reset()`'s with value 0"]
impl crate::ResetValue for super::CS7 {
    type Type = u32;
    #[inline(always)]
