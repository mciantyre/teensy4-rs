#[doc = "Reader of register ID25"]
pub type R = crate::R<u32, super::ID25>;
#[doc = "Writer for register ID25"]
pub type W = crate::W<u32, super::ID25>;
#[doc = "Register ID25 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID25 {
    type Type = u32;
    #[inline(always)]
