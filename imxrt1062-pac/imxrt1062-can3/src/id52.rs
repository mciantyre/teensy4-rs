#[doc = "Reader of register ID52"]
pub type R = crate::R<u32, super::ID52>;
#[doc = "Writer for register ID52"]
pub type W = crate::W<u32, super::ID52>;
#[doc = "Register ID52 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID52 {
    type Type = u32;
    #[inline(always)]
