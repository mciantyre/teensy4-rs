#[doc = "Reader of register CS50"]
pub type R = crate::R<u32, super::CS50>;
#[doc = "Writer for register CS50"]
pub type W = crate::W<u32, super::CS50>;
#[doc = "Register CS50 `reset()`'s with value 0"]
impl crate::ResetValue for super::CS50 {
    type Type = u32;
    #[inline(always)]
