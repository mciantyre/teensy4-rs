#[doc = "Reader of register CS61"]
pub type R = crate::R<u32, super::CS61>;
#[doc = "Writer for register CS61"]
pub type W = crate::W<u32, super::CS61>;
#[doc = "Register CS61 `reset()`'s with value 0"]
impl crate::ResetValue for super::CS61 {
    type Type = u32;
    #[inline(always)]
