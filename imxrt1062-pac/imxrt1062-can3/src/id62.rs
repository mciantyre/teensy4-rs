#[doc = "Reader of register ID62"]
pub type R = crate::R<u32, super::ID62>;
#[doc = "Writer for register ID62"]
pub type W = crate::W<u32, super::ID62>;
#[doc = "Register ID62 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID62 {
    type Type = u32;
    #[inline(always)]
