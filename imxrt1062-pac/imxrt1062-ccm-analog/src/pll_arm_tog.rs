#[doc = "Reader of register PLL_ARM_TOG"]
pub type R = crate::R<u32, super::PLL_ARM_TOG>;
#[doc = "Writer for register PLL_ARM_TOG"]
pub type W = crate::W<u32, super::PLL_ARM_TOG>;
#[doc = "Register PLL_ARM_TOG `reset()`'s with value 0x0001_3063"]
impl crate::ResetValue for super::PLL_ARM_TOG {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `PLL_SEL`"]
pub type PLL_SEL_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `PLL_SEL`"]
pub struct PLL_SEL_W<'a> {
    w: &'a mut W,
}
impl<'a> PLL_SEL_W<'a> {
    #[doc = r"Sets the field bit"]
...
impl R {
    ...
    #[doc = "Bit 19 - Reserved"]
    #[inline(always)]
    pub fn pll_sel(&self) -> PLL_SEL_R {
        PLL_SEL_R::new(((self.bits >> 19) & 0x01) != 0)
    }
...
impl W {
    ...
    #[doc = "Bit 19 - Reserved"]
    #[inline(always)]
    pub fn pll_sel(&mut self) -> PLL_SEL_W {
        PLL_SEL_W { w: self }
    }
}
