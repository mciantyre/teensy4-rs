...
pub type R = crate::R<u32, super::PLL_VIDEO_TOG>;
#[doc = "Writer for register PLL_VIDEO_TOG"]
pub type W = crate::W<u32, super::PLL_VIDEO_TOG>;
#[doc = "Register PLL_VIDEO_TOG `reset()`'s with value 0x0001_100c"]
impl crate::ResetValue for super::PLL_VIDEO_TOG {
    type Type = u32;
    #[inline(always)]
