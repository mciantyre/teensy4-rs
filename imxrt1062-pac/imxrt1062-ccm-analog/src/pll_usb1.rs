#[doc = "Reader of register PLL_USB1"]
pub type R = crate::R<u32, super::PLL_USB1>;
#[doc = "Writer for register PLL_USB1"]
pub type W = crate::W<u32, super::PLL_USB1>;
#[doc = "Register PLL_USB1 `reset()`'s with value 0x0001_2000"]
impl crate::ResetValue for super::PLL_USB1 {
    type Type = u32;
    #[inline(always)]
