#[doc = "Reader of register TEMPSENSE2"]
pub type R = crate::R<u32, super::TEMPSENSE2>;
#[doc = "Writer for register TEMPSENSE2"]
pub type W = crate::W<u32, super::TEMPSENSE2>;
#[doc = "Register TEMPSENSE2 `reset()`'s with value 0"]
impl crate::ResetValue for super::TEMPSENSE2 {
    type Type = u32;
    #[inline(always)]
