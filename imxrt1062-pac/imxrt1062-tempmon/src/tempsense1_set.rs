#[doc = "Reader of register TEMPSENSE1_SET"]
pub type R = crate::R<u32, super::TEMPSENSE1_SET>;
#[doc = "Writer for register TEMPSENSE1_SET"]
pub type W = crate::W<u32, super::TEMPSENSE1_SET>;
#[doc = "Register TEMPSENSE1_SET `reset()`'s with value 0x01"]
impl crate::ResetValue for super::TEMPSENSE1_SET {
    type Type = u32;
    #[inline(always)]
