#[doc = "Reader of register TEMPSENSE2_SET"]
pub type R = crate::R<u32, super::TEMPSENSE2_SET>;
#[doc = "Writer for register TEMPSENSE2_SET"]
pub type W = crate::W<u32, super::TEMPSENSE2_SET>;
#[doc = "Register TEMPSENSE2_SET `reset()`'s with value 0"]
impl crate::ResetValue for super::TEMPSENSE2_SET {
    type Type = u32;
    #[inline(always)]
