#[doc = "Reader of register TEMPSENSE1_CLR"]
pub type R = crate::R<u32, super::TEMPSENSE1_CLR>;
#[doc = "Writer for register TEMPSENSE1_CLR"]
pub type W = crate::W<u32, super::TEMPSENSE1_CLR>;
#[doc = "Register TEMPSENSE1_CLR `reset()`'s with value 0x01"]
impl crate::ResetValue for super::TEMPSENSE1_CLR {
    type Type = u32;
    #[inline(always)]
