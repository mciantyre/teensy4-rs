#[doc = "Reader of register TEMPSENSE1_TOG"]
pub type R = crate::R<u32, super::TEMPSENSE1_TOG>;
#[doc = "Writer for register TEMPSENSE1_TOG"]
pub type W = crate::W<u32, super::TEMPSENSE1_TOG>;
#[doc = "Register TEMPSENSE1_TOG `reset()`'s with value 0x01"]
impl crate::ResetValue for super::TEMPSENSE1_TOG {
    type Type = u32;
    #[inline(always)]
