#[doc = "Reader of register CH3SEMA"]
pub type R = crate::R<u32, super::CH3SEMA>;
#[doc = "Writer for register CH3SEMA"]
pub type W = crate::W<u32, super::CH3SEMA>;
#[doc = "Register CH3SEMA `reset()`'s with value 0"]
impl crate::ResetValue for super::CH3SEMA {
    type Type = u32;
    #[inline(always)]
