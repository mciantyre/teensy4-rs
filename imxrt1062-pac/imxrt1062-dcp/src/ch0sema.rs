#[doc = "Reader of register CH0SEMA"]
pub type R = crate::R<u32, super::CH0SEMA>;
#[doc = "Writer for register CH0SEMA"]
pub type W = crate::W<u32, super::CH0SEMA>;
#[doc = "Register CH0SEMA `reset()`'s with value 0"]
impl crate::ResetValue for super::CH0SEMA {
    type Type = u32;
    #[inline(always)]
