#[doc = "Reader of register CH1OPTS_CLR"]
pub type R = crate::R<u32, super::CH1OPTS_CLR>;
#[doc = "Writer for register CH1OPTS_CLR"]
pub type W = crate::W<u32, super::CH1OPTS_CLR>;
#[doc = "Register CH1OPTS_CLR `reset()`'s with value 0"]
impl crate::ResetValue for super::CH1OPTS_CLR {
    type Type = u32;
    #[inline(always)]
