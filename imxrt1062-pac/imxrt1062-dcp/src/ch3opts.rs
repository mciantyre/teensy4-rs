#[doc = "Reader of register CH3OPTS"]
pub type R = crate::R<u32, super::CH3OPTS>;
#[doc = "Writer for register CH3OPTS"]
pub type W = crate::W<u32, super::CH3OPTS>;
#[doc = "Register CH3OPTS `reset()`'s with value 0"]
impl crate::ResetValue for super::CH3OPTS {
    type Type = u32;
    #[inline(always)]
