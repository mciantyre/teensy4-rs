#[doc = "Reader of register CH0OPTS_CLR"]
pub type R = crate::R<u32, super::CH0OPTS_CLR>;
#[doc = "Writer for register CH0OPTS_CLR"]
pub type W = crate::W<u32, super::CH0OPTS_CLR>;
#[doc = "Register CH0OPTS_CLR `reset()`'s with value 0"]
impl crate::ResetValue for super::CH0OPTS_CLR {
    type Type = u32;
    #[inline(always)]
