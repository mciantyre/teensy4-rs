#[doc = "Reader of register CH3OPTS_CLR"]
pub type R = crate::R<u32, super::CH3OPTS_CLR>;
#[doc = "Writer for register CH3OPTS_CLR"]
pub type W = crate::W<u32, super::CH3OPTS_CLR>;
#[doc = "Register CH3OPTS_CLR `reset()`'s with value 0"]
impl crate::ResetValue for super::CH3OPTS_CLR {
    type Type = u32;
    #[inline(always)]
