#[doc = "Reader of register CH2OPTS"]
pub type R = crate::R<u32, super::CH2OPTS>;
#[doc = "Writer for register CH2OPTS"]
pub type W = crate::W<u32, super::CH2OPTS>;
#[doc = "Register CH2OPTS `reset()`'s with value 0"]
impl crate::ResetValue for super::CH2OPTS {
    type Type = u32;
    #[inline(always)]
