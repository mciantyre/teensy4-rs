#[doc = "Reader of register CH2OPTS_SET"]
pub type R = crate::R<u32, super::CH2OPTS_SET>;
#[doc = "Writer for register CH2OPTS_SET"]
pub type W = crate::W<u32, super::CH2OPTS_SET>;
#[doc = "Register CH2OPTS_SET `reset()`'s with value 0"]
impl crate::ResetValue for super::CH2OPTS_SET {
    type Type = u32;
    #[inline(always)]
