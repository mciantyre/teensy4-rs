#[doc = "Reader of register CH0OPTS"]
pub type R = crate::R<u32, super::CH0OPTS>;
#[doc = "Writer for register CH0OPTS"]
pub type W = crate::W<u32, super::CH0OPTS>;
#[doc = "Register CH0OPTS `reset()`'s with value 0"]
impl crate::ResetValue for super::CH0OPTS {
    type Type = u32;
    #[inline(always)]
