#[doc = "Reader of register CH3OPTS_TOG"]
pub type R = crate::R<u32, super::CH3OPTS_TOG>;
#[doc = "Writer for register CH3OPTS_TOG"]
pub type W = crate::W<u32, super::CH3OPTS_TOG>;
#[doc = "Register CH3OPTS_TOG `reset()`'s with value 0"]
impl crate::ResetValue for super::CH3OPTS_TOG {
    type Type = u32;
    #[inline(always)]
