#[doc = "Reader of register CH3OPTS_SET"]
pub type R = crate::R<u32, super::CH3OPTS_SET>;
#[doc = "Writer for register CH3OPTS_SET"]
pub type W = crate::W<u32, super::CH3OPTS_SET>;
#[doc = "Register CH3OPTS_SET `reset()`'s with value 0"]
impl crate::ResetValue for super::CH3OPTS_SET {
    type Type = u32;
    #[inline(always)]
