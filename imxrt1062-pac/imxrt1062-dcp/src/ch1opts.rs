#[doc = "Reader of register CH1OPTS"]
pub type R = crate::R<u32, super::CH1OPTS>;
#[doc = "Writer for register CH1OPTS"]
pub type W = crate::W<u32, super::CH1OPTS>;
#[doc = "Register CH1OPTS `reset()`'s with value 0"]
impl crate::ResetValue for super::CH1OPTS {
    type Type = u32;
    #[inline(always)]
