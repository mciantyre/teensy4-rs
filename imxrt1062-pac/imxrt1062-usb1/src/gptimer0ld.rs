#[doc = "Reader of register GPTIMER0LD"]
pub type R = crate::R<u32, super::GPTIMER0LD>;
#[doc = "Writer for register GPTIMER0LD"]
pub type W = crate::W<u32, super::GPTIMER0LD>;
#[doc = "Register GPTIMER0LD `reset()`'s with value 0"]
impl crate::ResetValue for super::GPTIMER0LD {
    type Type = u32;
    #[inline(always)]
