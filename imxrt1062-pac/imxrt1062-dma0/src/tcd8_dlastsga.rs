#[doc = "Reader of register TCD8_DLASTSGA"]
pub type R = crate::R<u32, super::TCD8_DLASTSGA>;
#[doc = "Writer for register TCD8_DLASTSGA"]
pub type W = crate::W<u32, super::TCD8_DLASTSGA>;
#[doc = "Register TCD8_DLASTSGA `reset()`'s with value 0"]
impl crate::ResetValue for super::TCD8_DLASTSGA {
    type Type = u32;
    #[inline(always)]
