#[doc = "Reader of register TCD17_SLAST"]
pub type R = crate::R<u32, super::TCD17_SLAST>;
#[doc = "Writer for register TCD17_SLAST"]
pub type W = crate::W<u32, super::TCD17_SLAST>;
#[doc = "Register TCD17_SLAST `reset()`'s with value 0"]
impl crate::ResetValue for super::TCD17_SLAST {
    type Type = u32;
    #[inline(always)]
