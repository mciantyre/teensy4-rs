#[doc = "Reader of register TCD29_SLAST"]
pub type R = crate::R<u32, super::TCD29_SLAST>;
#[doc = "Writer for register TCD29_SLAST"]
pub type W = crate::W<u32, super::TCD29_SLAST>;
#[doc = "Register TCD29_SLAST `reset()`'s with value 0"]
impl crate::ResetValue for super::TCD29_SLAST {
    type Type = u32;
    #[inline(always)]
