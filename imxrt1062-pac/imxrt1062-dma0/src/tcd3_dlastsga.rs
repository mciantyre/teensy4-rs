#[doc = "Reader of register TCD3_DLASTSGA"]
pub type R = crate::R<u32, super::TCD3_DLASTSGA>;
#[doc = "Writer for register TCD3_DLASTSGA"]
pub type W = crate::W<u32, super::TCD3_DLASTSGA>;
#[doc = "Register TCD3_DLASTSGA `reset()`'s with value 0"]
impl crate::ResetValue for super::TCD3_DLASTSGA {
    type Type = u32;
    #[inline(always)]
