#[doc = "Reader of register TCD22_SLAST"]
pub type R = crate::R<u32, super::TCD22_SLAST>;
#[doc = "Writer for register TCD22_SLAST"]
pub type W = crate::W<u32, super::TCD22_SLAST>;
#[doc = "Register TCD22_SLAST `reset()`'s with value 0"]
impl crate::ResetValue for super::TCD22_SLAST {
    type Type = u32;
    #[inline(always)]
