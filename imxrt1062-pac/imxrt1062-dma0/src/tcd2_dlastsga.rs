#[doc = "Reader of register TCD2_DLASTSGA"]
pub type R = crate::R<u32, super::TCD2_DLASTSGA>;
#[doc = "Writer for register TCD2_DLASTSGA"]
pub type W = crate::W<u32, super::TCD2_DLASTSGA>;
#[doc = "Register TCD2_DLASTSGA `reset()`'s with value 0"]
impl crate::ResetValue for super::TCD2_DLASTSGA {
    type Type = u32;
    #[inline(always)]
