#[doc = "Reader of register TCD5_DLASTSGA"]
pub type R = crate::R<u32, super::TCD5_DLASTSGA>;
#[doc = "Writer for register TCD5_DLASTSGA"]
pub type W = crate::W<u32, super::TCD5_DLASTSGA>;
#[doc = "Register TCD5_DLASTSGA `reset()`'s with value 0"]
impl crate::ResetValue for super::TCD5_DLASTSGA {
    type Type = u32;
    #[inline(always)]
