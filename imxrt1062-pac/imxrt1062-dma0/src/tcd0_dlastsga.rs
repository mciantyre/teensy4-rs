#[doc = "Reader of register TCD0_DLASTSGA"]
pub type R = crate::R<u32, super::TCD0_DLASTSGA>;
#[doc = "Writer for register TCD0_DLASTSGA"]
pub type W = crate::W<u32, super::TCD0_DLASTSGA>;
#[doc = "Register TCD0_DLASTSGA `reset()`'s with value 0"]
impl crate::ResetValue for super::TCD0_DLASTSGA {
    type Type = u32;
    #[inline(always)]
