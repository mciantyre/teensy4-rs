#[doc = "Reader of register TCD18_SLAST"]
pub type R = crate::R<u32, super::TCD18_SLAST>;
#[doc = "Writer for register TCD18_SLAST"]
pub type W = crate::W<u32, super::TCD18_SLAST>;
#[doc = "Register TCD18_SLAST `reset()`'s with value 0"]
impl crate::ResetValue for super::TCD18_SLAST {
    type Type = u32;
    #[inline(always)]
