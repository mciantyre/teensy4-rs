#[doc = "Reader of register TCD4_DLASTSGA"]
pub type R = crate::R<u32, super::TCD4_DLASTSGA>;
#[doc = "Writer for register TCD4_DLASTSGA"]
pub type W = crate::W<u32, super::TCD4_DLASTSGA>;
#[doc = "Register TCD4_DLASTSGA `reset()`'s with value 0"]
impl crate::ResetValue for super::TCD4_DLASTSGA {
    type Type = u32;
    #[inline(always)]
