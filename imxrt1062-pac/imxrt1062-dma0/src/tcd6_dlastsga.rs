#[doc = "Reader of register TCD6_DLASTSGA"]
pub type R = crate::R<u32, super::TCD6_DLASTSGA>;
#[doc = "Writer for register TCD6_DLASTSGA"]
pub type W = crate::W<u32, super::TCD6_DLASTSGA>;
#[doc = "Register TCD6_DLASTSGA `reset()`'s with value 0"]
impl crate::ResetValue for super::TCD6_DLASTSGA {
    type Type = u32;
    #[inline(always)]
