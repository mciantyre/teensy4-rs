#[doc = "Reader of register TCD7_DLASTSGA"]
pub type R = crate::R<u32, super::TCD7_DLASTSGA>;
#[doc = "Writer for register TCD7_DLASTSGA"]
pub type W = crate::W<u32, super::TCD7_DLASTSGA>;
#[doc = "Register TCD7_DLASTSGA `reset()`'s with value 0"]
impl crate::ResetValue for super::TCD7_DLASTSGA {
    type Type = u32;
    #[inline(always)]
