#[doc = "Reader of register TCD25_SLAST"]
pub type R = crate::R<u32, super::TCD25_SLAST>;
#[doc = "Writer for register TCD25_SLAST"]
pub type W = crate::W<u32, super::TCD25_SLAST>;
#[doc = "Register TCD25_SLAST `reset()`'s with value 0"]
impl crate::ResetValue for super::TCD25_SLAST {
    type Type = u32;
    #[inline(always)]
