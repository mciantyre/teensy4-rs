#[doc = "Reader of register TCD1_DLASTSGA"]
pub type R = crate::R<u32, super::TCD1_DLASTSGA>;
#[doc = "Writer for register TCD1_DLASTSGA"]
pub type W = crate::W<u32, super::TCD1_DLASTSGA>;
#[doc = "Register TCD1_DLASTSGA `reset()`'s with value 0"]
impl crate::ResetValue for super::TCD1_DLASTSGA {
    type Type = u32;
    #[inline(always)]
