#[doc = "Reader of register TCD9_DLASTSGA"]
pub type R = crate::R<u32, super::TCD9_DLASTSGA>;
#[doc = "Writer for register TCD9_DLASTSGA"]
pub type W = crate::W<u32, super::TCD9_DLASTSGA>;
#[doc = "Register TCD9_DLASTSGA `reset()`'s with value 0"]
impl crate::ResetValue for super::TCD9_DLASTSGA {
    type Type = u32;
    #[inline(always)]
