#[doc = "Reader of register TCD23_SLAST"]
pub type R = crate::R<u32, super::TCD23_SLAST>;
#[doc = "Writer for register TCD23_SLAST"]
pub type W = crate::W<u32, super::TCD23_SLAST>;
#[doc = "Register TCD23_SLAST `reset()`'s with value 0"]
impl crate::ResetValue for super::TCD23_SLAST {
    type Type = u32;
    #[inline(always)]
