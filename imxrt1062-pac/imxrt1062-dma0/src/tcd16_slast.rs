#[doc = "Reader of register TCD16_SLAST"]
pub type R = crate::R<u32, super::TCD16_SLAST>;
#[doc = "Writer for register TCD16_SLAST"]
pub type W = crate::W<u32, super::TCD16_SLAST>;
#[doc = "Register TCD16_SLAST `reset()`'s with value 0"]
impl crate::ResetValue for super::TCD16_SLAST {
    type Type = u32;
    #[inline(always)]
