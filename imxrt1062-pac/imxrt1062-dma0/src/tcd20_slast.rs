#[doc = "Reader of register TCD20_SLAST"]
pub type R = crate::R<u32, super::TCD20_SLAST>;
#[doc = "Writer for register TCD20_SLAST"]
pub type W = crate::W<u32, super::TCD20_SLAST>;
#[doc = "Register TCD20_SLAST `reset()`'s with value 0"]
impl crate::ResetValue for super::TCD20_SLAST {
    type Type = u32;
    #[inline(always)]
