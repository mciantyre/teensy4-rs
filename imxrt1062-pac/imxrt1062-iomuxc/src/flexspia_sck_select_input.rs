#[doc = "Reader of register FLEXSPIA_SCK_SELECT_INPUT"]
pub type R = crate::R<u32, super::FLEXSPIA_SCK_SELECT_INPUT>;
#[doc = "Writer for register FLEXSPIA_SCK_SELECT_INPUT"]
pub type W = crate::W<u32, super::FLEXSPIA_SCK_SELECT_INPUT>;
#[doc = "Register FLEXSPIA_SCK_SELECT_INPUT `reset()`'s with value 0"]
impl crate::ResetValue for super::FLEXSPIA_SCK_SELECT_INPUT {
    type Type = u32;
    #[inline(always)]
...
impl DAISY_R {
    ...
    pub fn variant(&self) -> DAISY_A {
        match self.bits {
            false => DAISY_A::GPIO_SD_B1_07_ALT1,
    ...
    pub fn is_gpio_sd_b1_07_alt1(&self) -> bool {
        *self == DAISY_A::GPIO_SD_B1_07_ALT1
    }
...
impl<'a> DAISY_W<'a> {
    ...
    pub fn gpio_sd_b1_07_alt1(self) -> &'a mut W {
        self.variant(DAISY_A::GPIO_SD_B1_07_ALT1)
    }
