#[doc = "Reader of register LPI2C3_SCL_SELECT_INPUT"]
pub type R = crate::R<u32, super::LPI2C3_SCL_SELECT_INPUT>;
#[doc = "Writer for register LPI2C3_SCL_SELECT_INPUT"]
pub type W = crate::W<u32, super::LPI2C3_SCL_SELECT_INPUT>;
#[doc = "Register LPI2C3_SCL_SELECT_INPUT `reset()`'s with value 0"]
impl crate::ResetValue for super::LPI2C3_SCL_SELECT_INPUT {
    type Type = u32;
    #[inline(always)]
...
pub enum DAISY_A {
    #[doc = "0: Selecting Pad: GPIO_EMC_22 for Mode: ALT2"]
    GPIO_EMC_22_ALT2,
    #[doc = "1: Selecting Pad: GPIO_SD_B0_00 for Mode: ALT2"]
    GPIO_SD_B0_00_ALT2,
    #[doc = "2: Selecting Pad: GPIO_AD_B1_07 for Mode: ALT1"]
    GPIO_AD_B1_07_ALT1,
}
impl From<DAISY_A> for u8 {
    ...
    fn from(variant: DAISY_A) -> Self {
        match variant {
            DAISY_A::GPIO_EMC_22_ALT2 => 0,
            DAISY_A::GPIO_SD_B0_00_ALT2 => 1,
            DAISY_A::GPIO_AD_B1_07_ALT1 => 2,
        }
    }
}
...
impl DAISY_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, DAISY_A> {
        use crate::Variant::*;
        match self.bits {
            0 => Val(DAISY_A::GPIO_EMC_22_ALT2),
            1 => Val(DAISY_A::GPIO_SD_B0_00_ALT2),
            2 => Val(DAISY_A::GPIO_AD_B1_07_ALT1),
            i => Res(i),
        }
    }
...
impl<'a> DAISY_W<'a> {
    ...
    pub fn gpio_emc_22_alt2(self) -> &'a mut W {
        self.variant(DAISY_A::GPIO_EMC_22_ALT2)
    }
