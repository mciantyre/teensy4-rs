#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_EMC_29"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_EMC_29>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_EMC_29"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_EMC_29>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_EMC_29 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_EMC_29 {
    type Type = u32;
    #[inline(always)]
...
#[repr(u8)]
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: SEMC_CS0 of instance: semc"]
    ALT0 = 0,
    #[doc = "1: Select mux mode: ALT1 mux port: FLEXPWM3_PWMA00 of instance: flexpwm3"]
    ALT1 = 1,
    #[doc = "2: Select mux mode: ALT2 mux port: LPUART6_RTS_B of instance: lpuart6"]
    ALT2 = 2,
    #[doc = "3: Select mux mode: ALT3 mux port: LPSPI1_SDI of instance: lpspi1"]
    ALT3 = 3,
    #[doc = "4: Select mux mode: ALT4 mux port: FLEXIO1_FLEXIO15 of instance: flexio1"]
    ALT4 = 4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO4_IO29 of instance: gpio4"]
    ALT5 = 5,
    #[doc = "8: Select mux mode: ALT8 mux port: FLEXSPI2_A_DATA03 of instance: flexspi2"]
    ALT8 = 8,
}
...
pub enum SION_A {
    ...
    DISABLED = 0,
    #[doc = "1: Force input path of pad GPIO_EMC_29"]
    ENABLED = 1,
}
