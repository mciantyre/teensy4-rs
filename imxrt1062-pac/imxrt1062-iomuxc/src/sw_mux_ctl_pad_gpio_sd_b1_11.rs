#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_SD_B1_11"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_SD_B1_11>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_SD_B1_11"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_SD_B1_11>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_SD_B1_11 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_SD_B1_11 {
    type Type = u32;
    #[inline(always)]
...
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: USDHC2_DATA7 of instance: usdhc2"]
    ALT0,
    #[doc = "1: Select mux mode: ALT1 mux port: FLEXSPIA_DATA03 of instance: flexspi"]
    ALT1,
    #[doc = "2: Select mux mode: ALT2 mux port: LPUART2_TX of instance: lpuart2"]
    ALT2,
    #[doc = "3: Select mux mode: ALT3 mux port: LPI2C2_SCL of instance: lpi2c2"]
    ALT3,
    #[doc = "4: Select mux mode: ALT4 mux port: LPSPI2_PCS3 of instance: lpspi2"]
    ALT4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO3_IO11 of instance: gpio3"]
    ALT5,
}
...
pub enum SION_A {
    ...
    DISABLED,
    #[doc = "1: Force input path of pad GPIO_SD_B1_11"]
    ENABLED,
}
