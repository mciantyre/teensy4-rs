#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_SPI_B1_00"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_SPI_B1_00>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_SPI_B1_00"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_SPI_B1_00>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_SPI_B1_00 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_SPI_B1_00 {
    type Type = u32;
    #[inline(always)]
...
pub enum SION_A {
    ...
    DISABLED = 0,
    #[doc = "1: Force input path of pad GPIO_SPI_B1_00"]
    ENABLED = 1,
}
...
impl<'a> SION_W<'a> {
    ...
    #[doc = "Force input path of pad GPIO_SPI_B1_00"]
    #[inline(always)]
