#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_B0_02"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_B0_02>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_B0_02"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_B0_02>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_B0_02 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_B0_02 {
    type Type = u32;
    #[inline(always)]
...
#[repr(u8)]
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: LCD_HSYNC of instance: lcdif"]
    ALT0 = 0,
    #[doc = "1: Select mux mode: ALT1 mux port: QTIMER1_TIMER2 of instance: qtimer1"]
    ALT1 = 1,
    #[doc = "2: Select mux mode: ALT2 mux port: FLEXCAN1_TX of instance: flexcan1"]
    ALT2 = 2,
    #[doc = "3: Select mux mode: ALT3 mux port: LPSPI4_SDO of instance: lpspi4"]
    ALT3 = 3,
    #[doc = "4: Select mux mode: ALT4 mux port: FLEXIO2_FLEXIO02 of instance: flexio2"]
    ALT4 = 4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO2_IO02 of instance: gpio2"]
    ALT5 = 5,
    #[doc = "6: Select mux mode: ALT6 mux port: SEMC_CSX03 of instance: semc"]
    ALT6 = 6,
...
pub enum SION_A {
    ...
    DISABLED = 0,
    #[doc = "1: Force input path of pad GPIO_B0_02"]
    ENABLED = 1,
}
