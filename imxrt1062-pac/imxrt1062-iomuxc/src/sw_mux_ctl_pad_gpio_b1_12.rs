#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_B1_12"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_B1_12>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_B1_12"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_B1_12>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_B1_12 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_B1_12 {
    type Type = u32;
    #[inline(always)]
...
pub enum MUX_MODE_A {
    #[doc = "1: Select mux mode: ALT1 mux port: LPUART5_TX of instance: lpuart5"]
    ALT1,
    #[doc = "2: Select mux mode: ALT2 mux port: CSI_PIXCLK of instance: csi"]
    ALT2,
    #[doc = "3: Select mux mode: ALT3 mux port: ENET_1588_EVENT0_IN of instance: enet"]
    ALT3,
    #[doc = "4: Select mux mode: ALT4 mux port: FLEXIO2_FLEXIO28 of instance: flexio2"]
    ALT4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO2_IO28 of instance: gpio2"]
    ALT5,
    #[doc = "6: Select mux mode: ALT6 mux port: USDHC1_CD_B of instance: usdhc1"]
    ALT6,
    #[doc = "9: Select mux mode: ALT9 mux port: FLEXIO3_FLEXIO28 of instance: flexio3"]
    ALT9,
}
...
pub enum SION_A {
    ...
    DISABLED,
    #[doc = "1: Force input path of pad GPIO_B1_12"]
    ENABLED,
}
