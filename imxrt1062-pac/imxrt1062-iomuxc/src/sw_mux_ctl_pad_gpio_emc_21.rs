#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_EMC_21"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_EMC_21>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_EMC_21"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_EMC_21>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_EMC_21 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_EMC_21 {
    type Type = u32;
    #[inline(always)]
...
#[repr(u8)]
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: SEMC_BA0 of instance: semc"]
    ALT0 = 0,
    #[doc = "1: Select mux mode: ALT1 mux port: FLEXPWM3_PWMA03 of instance: flexpwm3"]
    ALT1 = 1,
    #[doc = "2: Select mux mode: ALT2 mux port: LPI2C3_SDA of instance: lpi2c3"]
    ALT2 = 2,
    #[doc = "3: Select mux mode: ALT3 mux port: ENET_TDATA01 of instance: enet"]
    ALT3 = 3,
    #[doc = "4: Select mux mode: ALT4 mux port: QTIMER2_TIMER2 of instance: qtimer2"]
    ALT4 = 4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO4_IO21 of instance: gpio4"]
    ALT5 = 5,
}
...
pub enum SION_A {
    ...
    DISABLED = 0,
    #[doc = "1: Force input path of pad GPIO_EMC_21"]
    ENABLED = 1,
}
