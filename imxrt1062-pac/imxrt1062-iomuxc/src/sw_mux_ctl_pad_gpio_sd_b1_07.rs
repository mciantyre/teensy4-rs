#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_SD_B1_07"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_SD_B1_07>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_SD_B1_07"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_SD_B1_07>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_SD_B1_07 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_SD_B1_07 {
    type Type = u32;
    #[inline(always)]
...
#[repr(u8)]
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: SEMC_CSX01 of instance: semc"]
    ALT0 = 0,
    #[doc = "1: Select mux mode: ALT1 mux port: FLEXSPIA_SCLK of instance: flexspi"]
    ALT1 = 1,
    #[doc = "2: Select mux mode: ALT2 mux port: LPUART7_RTS_B of instance: lpuart7"]
    ALT2 = 2,
    #[doc = "3: Select mux mode: ALT3 mux port: SAI1_TX_DATA00 of instance: sai1"]
    ALT3 = 3,
    #[doc = "4: Select mux mode: ALT4 mux port: LPSPI2_SCK of instance: lpspi2"]
    ALT4 = 4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO3_IO07 of instance: gpio3"]
    ALT5 = 5,
}
...
pub enum SION_A {
    ...
    DISABLED = 0,
    #[doc = "1: Force input path of pad GPIO_SD_B1_07"]
    ENABLED = 1,
}
