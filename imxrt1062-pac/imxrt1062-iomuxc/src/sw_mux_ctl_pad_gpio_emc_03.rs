#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_EMC_03"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_EMC_03>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_EMC_03"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_EMC_03>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_EMC_03 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_EMC_03 {
    type Type = u32;
    #[inline(always)]
...
#[repr(u8)]
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: SEMC_DATA03 of instance: semc"]
    ALT0 = 0,
    #[doc = "1: Select mux mode: ALT1 mux port: FLEXPWM4_PWMB01 of instance: flexpwm4"]
    ALT1 = 1,
    #[doc = "2: Select mux mode: ALT2 mux port: LPSPI2_SDI of instance: lpspi2"]
    ALT2 = 2,
    #[doc = "3: Select mux mode: ALT3 mux port: XBAR1_INOUT05 of instance: xbar1"]
    ALT3 = 3,
    #[doc = "4: Select mux mode: ALT4 mux port: FLEXIO1_FLEXIO03 of instance: flexio1"]
    ALT4 = 4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO4_IO03 of instance: gpio4"]
    ALT5 = 5,
}
...
pub enum SION_A {
    ...
    DISABLED = 0,
    #[doc = "1: Force input path of pad GPIO_EMC_03"]
    ENABLED = 1,
}
