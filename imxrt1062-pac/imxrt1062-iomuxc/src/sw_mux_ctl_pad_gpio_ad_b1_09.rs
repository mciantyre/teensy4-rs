#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_AD_B1_09"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_AD_B1_09>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_AD_B1_09"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_AD_B1_09>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_AD_B1_09 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_AD_B1_09 {
    type Type = u32;
    #[inline(always)]
...
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: FLEXSPIA_DQS of instance: flexspi"]
    ALT0,
    #[doc = "1: Select mux mode: ALT1 mux port: FLEXPWM4_PWMA01 of instance: flexpwm4"]
    ALT1,
    #[doc = "2: Select mux mode: ALT2 mux port: FLEXCAN1_RX of instance: flexcan1"]
    ALT2,
    #[doc = "3: Select mux mode: ALT3 mux port: SAI1_MCLK of instance: sai1"]
    ALT3,
    #[doc = "4: Select mux mode: ALT4 mux port: CSI_DATA08 of instance: csi"]
    ALT4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO1_IO25 of instance: gpio1"]
    ALT5,
    #[doc = "6: Select mux mode: ALT6 mux port: USDHC2_CLK of instance: usdhc2"]
    ALT6,
    #[doc = "7: Select mux mode: ALT7 mux port: KPP_COL03 of instance: kpp"]
    ALT7,
    #[doc = "9: Select mux mode: ALT9 mux port: FLEXIO3_FLEXIO09 of instance: flexio3"]
    ALT9,
}
...
pub enum SION_A {
    ...
    DISABLED,
    #[doc = "1: Force input path of pad GPIO_AD_B1_09"]
    ENABLED,
}
