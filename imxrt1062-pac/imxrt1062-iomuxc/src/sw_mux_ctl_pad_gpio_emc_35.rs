#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_EMC_35"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_EMC_35>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_EMC_35"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_EMC_35>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_EMC_35 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_EMC_35 {
    type Type = u32;
    #[inline(always)]
...
#[repr(u8)]
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: SEMC_DATA13 of instance: semc"]
    ALT0 = 0,
    #[doc = "1: Select mux mode: ALT1 mux port: XBAR1_INOUT18 of instance: xbar1"]
    ALT1 = 1,
    #[doc = "2: Select mux mode: ALT2 mux port: GPT1_COMPARE1 of instance: gpt1"]
    ALT2 = 2,
    #[doc = "3: Select mux mode: ALT3 mux port: SAI3_RX_BCLK of instance: sai3"]
    ALT3 = 3,
    #[doc = "4: Select mux mode: ALT4 mux port: CSI_DATA18 of instance: csi"]
    ALT4 = 4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO3_IO21 of instance: gpio3"]
    ALT5 = 5,
...
pub enum SION_A {
    ...
    DISABLED = 0,
    #[doc = "1: Force input path of pad GPIO_EMC_35"]
    ENABLED = 1,
}
