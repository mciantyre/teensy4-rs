#[doc = "Reader of register LPSPI2_SDI_SELECT_INPUT"]
pub type R = crate::R<u32, super::LPSPI2_SDI_SELECT_INPUT>;
#[doc = "Writer for register LPSPI2_SDI_SELECT_INPUT"]
pub type W = crate::W<u32, super::LPSPI2_SDI_SELECT_INPUT>;
#[doc = "Register LPSPI2_SDI_SELECT_INPUT `reset()`'s with value 0"]
impl crate::ResetValue for super::LPSPI2_SDI_SELECT_INPUT {
    type Type = u32;
    #[inline(always)]
