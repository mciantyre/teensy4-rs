#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_SD_B0_01"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_SD_B0_01>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_SD_B0_01"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_SD_B0_01>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_SD_B0_01 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_SD_B0_01 {
    type Type = u32;
    #[inline(always)]
...
#[repr(u8)]
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: USDHC1_CLK of instance: usdhc1"]
    ALT0 = 0,
    #[doc = "1: Select mux mode: ALT1 mux port: FLEXPWM1_PWMB00 of instance: flexpwm1"]
    ALT1 = 1,
    #[doc = "2: Select mux mode: ALT2 mux port: LPI2C3_SDA of instance: lpi2c3"]
    ALT2 = 2,
    #[doc = "3: Select mux mode: ALT3 mux port: XBAR1_INOUT05 of instance: xbar1"]
    ALT3 = 3,
    #[doc = "4: Select mux mode: ALT4 mux port: LPSPI1_PCS0 of instance: lpspi1"]
    ALT4 = 4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO3_IO13 of instance: gpio3"]
    ALT5 = 5,
    #[doc = "6: Select mux mode: ALT6 mux port: FLEXSPIB_SS1_B of instance: flexspi"]
    ALT6 = 6,
    #[doc = "8: Select mux mode: ALT8 mux port: ENET2_TX_CLK of instance: enet2"]
    ALT8 = 8,
    #[doc = "9: Select mux mode: ALT9 mux port: ENET2_REF_CLK2 of instance: enet2"]
    ALT9 = 9,
}
...
pub enum SION_A {
    ...
    DISABLED = 0,
    #[doc = "1: Force input path of pad GPIO_SD_B0_01"]
    ENABLED = 1,
}
