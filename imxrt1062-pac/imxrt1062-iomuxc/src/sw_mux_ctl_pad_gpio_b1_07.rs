#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_B1_07"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_B1_07>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_B1_07"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_B1_07>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_B1_07 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_B1_07 {
    type Type = u32;
    #[inline(always)]
...
#[repr(u8)]
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: LCD_DATA19 of instance: lcdif"]
    ALT0 = 0,
    #[doc = "1: Select mux mode: ALT1 mux port: LPSPI4_SCK of instance: lpspi4"]
    ALT1 = 1,
    #[doc = "2: Select mux mode: ALT2 mux port: CSI_DATA12 of instance: csi"]
    ALT2 = 2,
    #[doc = "3: Select mux mode: ALT3 mux port: ENET_TX_DATA00 of instance: enet"]
    ALT3 = 3,
    #[doc = "4: Select mux mode: ALT4 mux port: FLEXIO2_FLEXIO23 of instance: flexio2"]
    ALT4 = 4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO2_IO23 of instance: gpio2"]
    ALT5 = 5,
    #[doc = "8: Select mux mode: ALT8 mux port: GPT1_COMPARE1 of instance: gpt1"]
    ALT8 = 8,
    #[doc = "9: Select mux mode: ALT9 mux port: FLEXIO3_FLEXIO23 of instance: flexio3"]
    ALT9 = 9,
}
...
pub enum SION_A {
    ...
    DISABLED = 0,
    #[doc = "1: Force input path of pad GPIO_B1_07"]
    ENABLED = 1,
}
