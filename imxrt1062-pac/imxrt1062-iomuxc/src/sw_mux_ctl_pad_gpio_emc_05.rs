#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_EMC_05"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_EMC_05>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_EMC_05"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_EMC_05>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_EMC_05 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_EMC_05 {
    type Type = u32;
    #[inline(always)]
...
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: SEMC_DATA05 of instance: semc"]
    ALT0,
    #[doc = "1: Select mux mode: ALT1 mux port: FLEXPWM4_PWMB02 of instance: flexpwm4"]
    ALT1,
    #[doc = "2: Select mux mode: ALT2 mux port: SAI2_TX_SYNC of instance: sai2"]
    ALT2,
    #[doc = "3: Select mux mode: ALT3 mux port: XBAR1_INOUT07 of instance: xbar1"]
    ALT3,
    #[doc = "4: Select mux mode: ALT4 mux port: FLEXIO1_FLEXIO05 of instance: flexio1"]
    ALT4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO4_IO05 of instance: gpio4"]
    ALT5,
}
...
pub enum SION_A {
    ...
    DISABLED,
    #[doc = "1: Force input path of pad GPIO_EMC_05"]
    ENABLED,
}
