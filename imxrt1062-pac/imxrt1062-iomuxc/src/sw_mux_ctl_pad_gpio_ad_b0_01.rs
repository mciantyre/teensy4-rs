#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_AD_B0_01"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_AD_B0_01>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_AD_B0_01"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_AD_B0_01>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_AD_B0_01 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_AD_B0_01 {
    type Type = u32;
    #[inline(always)]
...
#[repr(u8)]
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: FLEXPWM2_PWMB03 of instance: flexpwm2"]
    ALT0 = 0,
    #[doc = "1: Select mux mode: ALT1 mux port: XBAR1_INOUT15 of instance: xbar1"]
    ALT1 = 1,
    #[doc = "2: Select mux mode: ALT2 mux port: REF_CLK_24M of instance: anatop"]
    ALT2 = 2,
    #[doc = "3: Select mux mode: ALT3 mux port: USB_OTG1_ID of instance: anatop"]
    ALT3 = 3,
    #[doc = "4: Select mux mode: ALT4 mux port: LPI2C1_SDAS of instance: lpi2c1"]
    ALT4 = 4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO1_IO01 of instance: gpio1"]
    ALT5 = 5,
    #[doc = "6: Select mux mode: ALT6 mux port: EWM_OUT_B of instance: ewm"]
    ALT6 = 6,
    #[doc = "7: Select mux mode: ALT7 mux port: LPSPI3_SDO of instance: lpspi3"]
    ALT7 = 7,
}
...
pub enum SION_A {
    ...
    DISABLED = 0,
    #[doc = "1: Force input path of pad GPIO_AD_B0_01"]
    ENABLED = 1,
}
