#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_AD_B1_05"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_AD_B1_05>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_AD_B1_05"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_AD_B1_05>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_AD_B1_05 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_AD_B1_05 {
    type Type = u32;
    #[inline(always)]
...
#[repr(u8)]
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: FLEXSPIB_DATA02 of instance: flexspi"]
    ALT0 = 0,
    #[doc = "1: Select mux mode: ALT1 mux port: ENET_MDIO of instance: enet"]
    ALT1 = 1,
    #[doc = "2: Select mux mode: ALT2 mux port: LPUART3_RTS_B of instance: lpuart3"]
    ALT2 = 2,
    #[doc = "3: Select mux mode: ALT3 mux port: SPDIF_OUT of instance: spdif"]
    ALT3 = 3,
    #[doc = "4: Select mux mode: ALT4 mux port: CSI_MCLK of instance: csi"]
    ALT4 = 4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO1_IO21 of instance: gpio1"]
    ALT5 = 5,
    #[doc = "6: Select mux mode: ALT6 mux port: USDHC2_DATA1 of instance: usdhc2"]
    ALT6 = 6,
    #[doc = "7: Select mux mode: ALT7 mux port: KPP_COL05 of instance: kpp"]
    ALT7 = 7,
    #[doc = "8: Select mux mode: ALT8 mux port: GPT2_COMPARE1 of instance: gpt2"]
    ALT8 = 8,
    #[doc = "9: Select mux mode: ALT9 mux port: FLEXIO3_FLEXIO05 of instance: flexio3"]
    ALT9 = 9,
}
...
pub enum SION_A {
    ...
    DISABLED = 0,
    #[doc = "1: Force input path of pad GPIO_AD_B1_05"]
    ENABLED = 1,
}
