#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_SPI_B0_03"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_SPI_B0_03>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_SPI_B0_03"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_SPI_B0_03>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_SPI_B0_03 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_SPI_B0_03 {
    type Type = u32;
    #[inline(always)]
...
impl<'a> SION_W<'a> {
    ...
    #[doc = "Force input path of pad GPIO_SPI_B0_03"]
    #[inline(always)]
