#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_B0_06"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_B0_06>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_B0_06"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_B0_06>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_B0_06 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_B0_06 {
    type Type = u32;
    #[inline(always)]
...
#[repr(u8)]
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: LCD_DATA02 of instance: lcdif"]
    ALT0 = 0,
    #[doc = "1: Select mux mode: ALT1 mux port: QTIMER3_TIMER0 of instance: qtimer3"]
    ALT1 = 1,
    #[doc = "2: Select mux mode: ALT2 mux port: FLEXPWM2_PWMA00 of instance: flexpwm2"]
    ALT2 = 2,
    #[doc = "3: Select mux mode: ALT3 mux port: ARM_TRACE2 of instance: cm7_mx6rt"]
    ALT3 = 3,
    #[doc = "4: Select mux mode: ALT4 mux port: FLEXIO2_FLEXIO06 of instance: flexio2"]
    ALT4 = 4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO2_IO06 of instance: gpio2"]
    ALT5 = 5,
    #[doc = "6: Select mux mode: ALT6 mux port: SRC_BOOT_CFG02 of instance: src"]
    ALT6 = 6,
    #[doc = "8: Select mux mode: ALT8 mux port: ENET2_RX_CLK of instance: enet2"]
    ALT8 = 8,
}
...
pub enum SION_A {
    ...
    DISABLED = 0,
    #[doc = "1: Force input path of pad GPIO_B0_06"]
    ENABLED = 1,
}
