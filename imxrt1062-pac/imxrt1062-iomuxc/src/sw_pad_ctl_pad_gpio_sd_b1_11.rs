#[doc = "Reader of register SW_PAD_CTL_PAD_GPIO_SD_B1_11"]
pub type R = crate::R<u32, super::SW_PAD_CTL_PAD_GPIO_SD_B1_11>;
#[doc = "Writer for register SW_PAD_CTL_PAD_GPIO_SD_B1_11"]
pub type W = crate::W<u32, super::SW_PAD_CTL_PAD_GPIO_SD_B1_11>;
#[doc = "Register SW_PAD_CTL_PAD_GPIO_SD_B1_11 `reset()`'s with value 0x10b0"]
impl crate::ResetValue for super::SW_PAD_CTL_PAD_GPIO_SD_B1_11 {
    type Type = u32;
    #[inline(always)]
