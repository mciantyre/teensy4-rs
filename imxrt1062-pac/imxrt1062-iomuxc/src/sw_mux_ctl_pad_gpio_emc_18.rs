#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_EMC_18"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_EMC_18>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_EMC_18"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_EMC_18>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_EMC_18 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_EMC_18 {
    type Type = u32;
    #[inline(always)]
...
#[repr(u8)]
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: SEMC_ADDR09 of instance: semc"]
    ALT0 = 0,
    #[doc = "1: Select mux mode: ALT1 mux port: FLEXPWM4_PWMB03 of instance: flexpwm4"]
    ALT1 = 1,
    #[doc = "2: Select mux mode: ALT2 mux port: LPUART4_RTS_B of instance: lpuart4"]
    ALT2 = 2,
    #[doc = "3: Select mux mode: ALT3 mux port: FLEXCAN1_RX of instance: flexcan1"]
    ALT3 = 3,
    #[doc = "4: Select mux mode: ALT4 mux port: QTIMER3_TIMER3 of instance: qtimer3"]
    ALT4 = 4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO4_IO18 of instance: gpio4"]
    ALT5 = 5,
    #[doc = "6: Select mux mode: ALT6 mux port: SNVS_VIO_5_CTL of instance: snvs_hp"]
    ALT6 = 6,
}
...
pub enum SION_A {
    ...
    DISABLED = 0,
    #[doc = "1: Force input path of pad GPIO_EMC_18"]
    ENABLED = 1,
}
