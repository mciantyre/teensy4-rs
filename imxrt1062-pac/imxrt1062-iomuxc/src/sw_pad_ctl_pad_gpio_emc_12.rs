#[doc = "Reader of register SW_PAD_CTL_PAD_GPIO_EMC_12"]
pub type R = crate::R<u32, super::SW_PAD_CTL_PAD_GPIO_EMC_12>;
#[doc = "Writer for register SW_PAD_CTL_PAD_GPIO_EMC_12"]
pub type W = crate::W<u32, super::SW_PAD_CTL_PAD_GPIO_EMC_12>;
#[doc = "Register SW_PAD_CTL_PAD_GPIO_EMC_12 `reset()`'s with value 0x10b0"]
impl crate::ResetValue for super::SW_PAD_CTL_PAD_GPIO_EMC_12 {
    type Type = u32;
    #[inline(always)]
