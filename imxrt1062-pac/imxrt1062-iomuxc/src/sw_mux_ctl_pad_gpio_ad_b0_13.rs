#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_AD_B0_13"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_AD_B0_13>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_AD_B0_13"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_AD_B0_13>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_AD_B0_13 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_AD_B0_13 {
    type Type = u32;
    #[inline(always)]
...
#[repr(u8)]
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: LPI2C4_SDA of instance: lpi2c4"]
    ALT0 = 0,
    #[doc = "1: Select mux mode: ALT1 mux port: GPT1_CLK of instance: gpt1"]
    ALT1 = 1,
    #[doc = "2: Select mux mode: ALT2 mux port: LPUART1_RX of instance: lpuart1"]
    ALT2 = 2,
    #[doc = "3: Select mux mode: ALT3 mux port: EWM_OUT_B of instance: ewm"]
    ALT3 = 3,
    #[doc = "4: Select mux mode: ALT4 mux port: FLEXPWM1_PWMX03 of instance: flexpwm1"]
    ALT4 = 4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO1_IO13 of instance: gpio1"]
    ALT5 = 5,
    #[doc = "6: Select mux mode: ALT6 mux port: ENET_1588_EVENT1_IN of instance: enet"]
    ALT6 = 6,
    #[doc = "7: Select mux mode: ALT7 mux port: REF_CLK_24M of instance: anatop"]
    ALT7 = 7,
}
...
pub enum SION_A {
    ...
    DISABLED = 0,
    #[doc = "1: Force input path of pad GPIO_AD_B0_13"]
    ENABLED = 1,
}
