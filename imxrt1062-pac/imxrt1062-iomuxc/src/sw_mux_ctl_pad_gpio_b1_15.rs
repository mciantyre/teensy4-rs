#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_B1_15"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_B1_15>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_B1_15"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_B1_15>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_B1_15 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_B1_15 {
    type Type = u32;
    #[inline(always)]
...
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: ENET_MDIO of instance: enet"]
    ALT0,
    #[doc = "1: Select mux mode: ALT1 mux port: FLEXPWM4_PWMA03 of instance: flexpwm4"]
    ALT1,
    #[doc = "2: Select mux mode: ALT2 mux port: CSI_MCLK of instance: csi"]
    ALT2,
    #[doc = "3: Select mux mode: ALT3 mux port: XBAR1_IN03 of instance: xbar1"]
    ALT3,
    #[doc = "4: Select mux mode: ALT4 mux port: FLEXIO2_FLEXIO31 of instance: flexio2"]
    ALT4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO2_IO31 of instance: gpio2"]
    ALT5,
    #[doc = "6: Select mux mode: ALT6 mux port: USDHC1_RESET_B of instance: usdhc1"]
    ALT6,
    #[doc = "8: Select mux mode: ALT8 mux port: ENET2_TDATA01 of instance: enet2"]
    ALT8,
    #[doc = "9: Select mux mode: ALT9 mux port: FLEXIO3_FLEXIO31 of instance: flexio3"]
    ALT9,
}
...
pub enum SION_A {
    ...
    DISABLED,
    #[doc = "1: Force input path of pad GPIO_B1_15"]
    ENABLED,
}
