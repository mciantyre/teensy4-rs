#[doc = "Reader of register USDHC1_CD_B_SELECT_INPUT"]
pub type R = crate::R<u32, super::USDHC1_CD_B_SELECT_INPUT>;
#[doc = "Writer for register USDHC1_CD_B_SELECT_INPUT"]
pub type W = crate::W<u32, super::USDHC1_CD_B_SELECT_INPUT>;
#[doc = "Register USDHC1_CD_B_SELECT_INPUT `reset()`'s with value 0"]
impl crate::ResetValue for super::USDHC1_CD_B_SELECT_INPUT {
    type Type = u32;
    #[inline(always)]
...
pub enum DAISY_A {
    #[doc = "0: Selecting Pad: GPIO_EMC_35 for Mode: ALT6"]
    GPIO_EMC_35_ALT6,
    #[doc = "1: Selecting Pad: GPIO_AD_B1_02 for Mode: ALT6"]
    GPIO_AD_B1_02_ALT6,
    #[doc = "2: Selecting Pad: GPIO_B1_12 for Mode: ALT6"]
    GPIO_B1_12_ALT6,
}
impl From<DAISY_A> for u8 {
    ...
    fn from(variant: DAISY_A) -> Self {
        match variant {
            DAISY_A::GPIO_EMC_35_ALT6 => 0,
            DAISY_A::GPIO_AD_B1_02_ALT6 => 1,
            DAISY_A::GPIO_B1_12_ALT6 => 2,
        }
    }
}
...
impl DAISY_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, DAISY_A> {
        use crate::Variant::*;
        match self.bits {
            0 => Val(DAISY_A::GPIO_EMC_35_ALT6),
            1 => Val(DAISY_A::GPIO_AD_B1_02_ALT6),
            2 => Val(DAISY_A::GPIO_B1_12_ALT6),
            i => Res(i),
        }
    }
