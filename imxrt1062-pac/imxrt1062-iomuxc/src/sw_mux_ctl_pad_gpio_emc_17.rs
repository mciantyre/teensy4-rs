#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_EMC_17"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_EMC_17>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_EMC_17"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_EMC_17>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_EMC_17 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_EMC_17 {
    type Type = u32;
    #[inline(always)]
...
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: SEMC_ADDR08 of instance: semc"]
    ALT0,
    #[doc = "1: Select mux mode: ALT1 mux port: FLEXPWM4_PWMA03 of instance: flexpwm4"]
    ALT1,
    #[doc = "2: Select mux mode: ALT2 mux port: LPUART4_CTS_B of instance: lpuart4"]
    ALT2,
    #[doc = "3: Select mux mode: ALT3 mux port: FLEXCAN1_TX of instance: flexcan1"]
    ALT3,
    #[doc = "4: Select mux mode: ALT4 mux port: QTIMER3_TIMER2 of instance: qtimer3"]
    ALT4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO4_IO17 of instance: gpio4"]
    ALT5,
}
...
pub enum SION_A {
    ...
    DISABLED,
    #[doc = "1: Force input path of pad GPIO_EMC_17"]
    ENABLED,
}
