#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_EMC_01"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_EMC_01>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_EMC_01"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_EMC_01>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_EMC_01 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_EMC_01 {
    type Type = u32;
    #[inline(always)]
...
#[repr(u8)]
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: SEMC_DATA01 of instance: semc"]
    ALT0 = 0,
    #[doc = "1: Select mux mode: ALT1 mux port: FLEXPWM4_PWMB00 of instance: flexpwm4"]
    ALT1 = 1,
    #[doc = "2: Select mux mode: ALT2 mux port: LPSPI2_PCS0 of instance: lpspi2"]
    ALT2 = 2,
    #[doc = "3: Select mux mode: ALT3 mux port: XBAR1_IN03 of instance: xbar1"]
    ALT3 = 3,
    #[doc = "4: Select mux mode: ALT4 mux port: FLEXIO1_FLEXIO01 of instance: flexio1"]
    ALT4 = 4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO4_IO01 of instance: gpio4"]
    ALT5 = 5,
}
...
pub enum SION_A {
    ...
    DISABLED = 0,
    #[doc = "1: Force input path of pad GPIO_EMC_01"]
    ENABLED = 1,
}
