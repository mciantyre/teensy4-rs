#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_EMC_39"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_EMC_39>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_EMC_39"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_EMC_39>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_EMC_39 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_EMC_39 {
    type Type = u32;
    #[inline(always)]
...
#[repr(u8)]
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: SEMC_DQS of instance: semc"]
    ALT0 = 0,
    #[doc = "1: Select mux mode: ALT1 mux port: FLEXPWM1_PWMB03 of instance: flexpwm1"]
    ALT1 = 1,
    #[doc = "2: Select mux mode: ALT2 mux port: LPUART8_RX of instance: lpuart8"]
    ALT2 = 2,
    #[doc = "3: Select mux mode: ALT3 mux port: SAI3_TX_SYNC of instance: sai3"]
    ALT3 = 3,
    #[doc = "4: Select mux mode: ALT4 mux port: WDOG1_WDOG_B of instance: wdog1"]
    ALT4 = 4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO3_IO25 of instance: gpio3"]
    ALT5 = 5,
    #[doc = "6: Select mux mode: ALT6 mux port: USDHC2_CD_B of instance: usdhc2"]
    ALT6 = 6,
    #[doc = "8: Select mux mode: ALT8 mux port: ENET2_MDIO of instance: enet2"]
    ALT8 = 8,
...
pub enum SION_A {
    ...
    DISABLED = 0,
    #[doc = "1: Force input path of pad GPIO_EMC_39"]
    ENABLED = 1,
}
