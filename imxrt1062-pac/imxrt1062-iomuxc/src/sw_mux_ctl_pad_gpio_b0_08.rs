#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_B0_08"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_B0_08>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_B0_08"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_B0_08>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_B0_08 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_B0_08 {
    type Type = u32;
    #[inline(always)]
...
#[repr(u8)]
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: LCD_DATA04 of instance: lcdif"]
    ALT0 = 0,
    #[doc = "1: Select mux mode: ALT1 mux port: QTIMER3_TIMER2 of instance: qtimer3"]
    ALT1 = 1,
    #[doc = "2: Select mux mode: ALT2 mux port: FLEXPWM2_PWMA01 of instance: flexpwm2"]
    ALT2 = 2,
    #[doc = "3: Select mux mode: ALT3 mux port: LPUART3_TX of instance: lpuart3"]
    ALT3 = 3,
    #[doc = "4: Select mux mode: ALT4 mux port: FLEXIO2_FLEXIO08 of instance: flexio2"]
    ALT4 = 4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO2_IO08 of instance: gpio2"]
    ALT5 = 5,
    #[doc = "6: Select mux mode: ALT6 mux port: SRC_BOOT_CFG04 of instance: src"]
    ALT6 = 6,
    #[doc = "8: Select mux mode: ALT8 mux port: ENET2_RDATA03 of instance: enet2"]
    ALT8 = 8,
}
...
pub enum SION_A {
    ...
    DISABLED = 0,
    #[doc = "1: Force input path of pad GPIO_B0_08"]
    ENABLED = 1,
}
