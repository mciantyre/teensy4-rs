#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_AD_B0_14"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_AD_B0_14>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_AD_B0_14"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_AD_B0_14>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_AD_B0_14 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_AD_B0_14 {
    type Type = u32;
    #[inline(always)]
...
#[repr(u8)]
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: USB_OTG2_OC of instance: usb"]
    ALT0 = 0,
    #[doc = "1: Select mux mode: ALT1 mux port: XBAR1_IN24 of instance: xbar1"]
    ALT1 = 1,
    #[doc = "2: Select mux mode: ALT2 mux port: LPUART1_CTS_B of instance: lpuart1"]
    ALT2 = 2,
    ...
    ALT4 = 4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO1_IO14 of instance: gpio1"]
    ALT5 = 5,
...
pub enum SION_A {
    ...
    DISABLED = 0,
    #[doc = "1: Force input path of pad GPIO_AD_B0_14"]
    ENABLED = 1,
}
