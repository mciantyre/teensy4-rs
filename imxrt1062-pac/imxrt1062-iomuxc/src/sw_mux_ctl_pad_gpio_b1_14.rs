#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_B1_14"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_B1_14>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_B1_14"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_B1_14>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_B1_14 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_B1_14 {
    type Type = u32;
    #[inline(always)]
...
#[repr(u8)]
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: ENET_MDC of instance: enet"]
    ALT0 = 0,
    #[doc = "1: Select mux mode: ALT1 mux port: FLEXPWM4_PWMA02 of instance: flexpwm4"]
    ALT1 = 1,
    #[doc = "2: Select mux mode: ALT2 mux port: CSI_HSYNC of instance: csi"]
    ALT2 = 2,
    #[doc = "3: Select mux mode: ALT3 mux port: XBAR1_IN02 of instance: xbar1"]
    ALT3 = 3,
    #[doc = "4: Select mux mode: ALT4 mux port: FLEXIO2_FLEXIO30 of instance: flexio2"]
    ALT4 = 4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO2_IO30 of instance: gpio2"]
    ALT5 = 5,
    ...
    ALT8 = 8,
    #[doc = "9: Select mux mode: ALT9 mux port: FLEXIO3_FLEXIO30 of instance: flexio3"]
    ALT9 = 9,
}
...
pub enum SION_A {
    ...
    DISABLED = 0,
    #[doc = "1: Force input path of pad GPIO_B1_14"]
    ENABLED = 1,
}
