#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_AD_B0_04"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_AD_B0_04>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_AD_B0_04"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_AD_B0_04>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_AD_B0_04 `reset()`'s with value 0"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_AD_B0_04 {
    type Type = u32;
    #[inline(always)]
...
#[repr(u8)]
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: SRC_BOOT_MODE00 of instance: src"]
    ALT0 = 0,
    #[doc = "1: Select mux mode: ALT1 mux port: MQS_RIGHT of instance: mqs"]
    ALT1 = 1,
    #[doc = "2: Select mux mode: ALT2 mux port: ENET_TX_DATA03 of instance: enet"]
    ALT2 = 2,
    #[doc = "3: Select mux mode: ALT3 mux port: SAI2_TX_SYNC of instance: sai2"]
    ALT3 = 3,
    #[doc = "4: Select mux mode: ALT4 mux port: CSI_DATA09 of instance: csi"]
    ALT4 = 4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO1_IO04 of instance: gpio1"]
    ALT5 = 5,
    #[doc = "6: Select mux mode: ALT6 mux port: PIT_TRIGGER00 of instance: pit"]
    ALT6 = 6,
    #[doc = "7: Select mux mode: ALT7 mux port: LPSPI3_PCS1 of instance: lpspi3"]
    ALT7 = 7,
}
...
pub enum SION_A {
    ...
    DISABLED = 0,
    #[doc = "1: Force input path of pad GPIO_AD_B0_04"]
    ENABLED = 1,
}
