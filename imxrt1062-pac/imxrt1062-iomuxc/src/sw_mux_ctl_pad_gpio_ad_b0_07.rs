#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_AD_B0_07"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_AD_B0_07>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_AD_B0_07"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_AD_B0_07>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_AD_B0_07 `reset()`'s with value 0"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_AD_B0_07 {
    type Type = u32;
    #[inline(always)]
...
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: JTAG_TCK of instance: jtag_mux"]
    ALT0,
    #[doc = "1: Select mux mode: ALT1 mux port: GPT2_COMPARE2 of instance: gpt2"]
    ALT1,
    #[doc = "2: Select mux mode: ALT2 mux port: ENET_TX_ER of instance: enet"]
    ALT2,
    #[doc = "3: Select mux mode: ALT3 mux port: SAI2_RX_SYNC of instance: sai2"]
    ALT3,
    #[doc = "4: Select mux mode: ALT4 mux port: CSI_DATA06 of instance: csi"]
    ALT4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO1_IO07 of instance: gpio1"]
    ALT5,
    #[doc = "6: Select mux mode: ALT6 mux port: XBAR1_INOUT19 of instance: xbar1"]
    ALT6,
    #[doc = "7: Select mux mode: ALT7 mux port: ENET_1588_EVENT3_OUT of instance: enet"]
    ALT7,
}
...
pub enum SION_A {
    ...
    DISABLED,
    #[doc = "1: Force input path of pad GPIO_AD_B0_07"]
    ENABLED,
}
