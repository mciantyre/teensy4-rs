#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_AD_B0_09"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_AD_B0_09>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_AD_B0_09"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_AD_B0_09>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_AD_B0_09 `reset()`'s with value 0"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_AD_B0_09 {
    type Type = u32;
    #[inline(always)]
...
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: JTAG_TDI of instance: jtag_mux"]
    ALT0,
    #[doc = "1: Select mux mode: ALT1 mux port: FLEXPWM2_PWMA03 of instance: flexpwm2"]
    ALT1,
    #[doc = "2: Select mux mode: ALT2 mux port: ENET_RX_DATA02 of instance: enet"]
    ALT2,
    ...
    ALT4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO1_IO09 of instance: gpio1"]
    ALT5,
    #[doc = "6: Select mux mode: ALT6 mux port: XBAR1_IN21 of instance: xbar1"]
    ALT6,
    #[doc = "7: Select mux mode: ALT7 mux port: GPT2_CLK of instance: gpt2"]
    ALT7,
...
pub enum SION_A {
    ...
    DISABLED,
    #[doc = "1: Force input path of pad GPIO_AD_B0_09"]
    ENABLED,
}
