#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_AD_B1_14"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_AD_B1_14>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_AD_B1_14"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_AD_B1_14>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_AD_B1_14 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_AD_B1_14 {
    type Type = u32;
    #[inline(always)]
...
#[repr(u8)]
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: FLEXSPIA_SCLK of instance: flexspi"]
    ALT0 = 0,
    #[doc = "1: Select mux mode: ALT1 mux port: ACMP_OUT02 of instance: acmp"]
    ALT1 = 1,
    #[doc = "2: Select mux mode: ALT2 mux port: LPSPI3_SDO of instance: lpspi3"]
    ALT2 = 2,
    #[doc = "3: Select mux mode: ALT3 mux port: SAI1_TX_BCLK of instance: sai1"]
    ALT3 = 3,
    #[doc = "4: Select mux mode: ALT4 mux port: CSI_DATA03 of instance: csi"]
    ALT4 = 4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO1_IO30 of instance: gpio1"]
    ALT5 = 5,
    #[doc = "6: Select mux mode: ALT6 mux port: USDHC2_DATA6 of instance: usdhc2"]
    ALT6 = 6,
    #[doc = "7: Select mux mode: ALT7 mux port: KPP_ROW00 of instance: kpp"]
    ALT7 = 7,
    #[doc = "8: Select mux mode: ALT8 mux port: ENET2_1588_EVENT3_OUT of instance: enet2"]
    ALT8 = 8,
    #[doc = "9: Select mux mode: ALT9 mux port: FLEXIO3_FLEXIO14 of instance: flexio3"]
    ALT9 = 9,
}
...
pub enum SION_A {
    ...
    DISABLED = 0,
    #[doc = "1: Force input path of pad GPIO_AD_B1_14"]
    ENABLED = 1,
}
