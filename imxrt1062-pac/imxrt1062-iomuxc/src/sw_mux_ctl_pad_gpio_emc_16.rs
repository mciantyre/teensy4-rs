#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_EMC_16"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_EMC_16>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_EMC_16"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_EMC_16>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_EMC_16 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_EMC_16 {
    type Type = u32;
    #[inline(always)]
...
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: SEMC_ADDR07 of instance: semc"]
    ALT0,
    #[doc = "1: Select mux mode: ALT1 mux port: XBAR1_IN21 of instance: xbar1"]
    ALT1,
    ...
    ALT3,
    #[doc = "4: Select mux mode: ALT4 mux port: QTIMER3_TIMER1 of instance: qtimer3"]
    ALT4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO4_IO16 of instance: gpio4"]
    ALT5,
    #[doc = "8: Select mux mode: ALT8 mux port: FLEXSPI2_B_DATA03 of instance: flexspi2"]
    ALT8,
}
...
pub enum SION_A {
    ...
    DISABLED,
    #[doc = "1: Force input path of pad GPIO_EMC_16"]
    ENABLED,
}
