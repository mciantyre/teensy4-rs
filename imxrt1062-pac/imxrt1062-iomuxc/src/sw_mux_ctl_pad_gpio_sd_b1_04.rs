#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_SD_B1_04"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_SD_B1_04>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_SD_B1_04"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_SD_B1_04>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_SD_B1_04 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_SD_B1_04 {
    type Type = u32;
    #[inline(always)]
...
#[repr(u8)]
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: USDHC2_CLK of instance: usdhc2"]
    ALT0 = 0,
    #[doc = "1: Select mux mode: ALT1 mux port: FLEXSPIB_SCLK of instance: flexspi"]
    ALT1 = 1,
    #[doc = "2: Select mux mode: ALT2 mux port: LPI2C1_SCL of instance: lpi2c1"]
    ALT2 = 2,
    #[doc = "3: Select mux mode: ALT3 mux port: SAI1_RX_SYNC of instance: sai1"]
    ALT3 = 3,
    #[doc = "4: Select mux mode: ALT4 mux port: FLEXSPIA_SS1_B of instance: flexspi"]
    ALT4 = 4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO3_IO04 of instance: gpio3"]
    ALT5 = 5,
    #[doc = "6: Select mux mode: ALT6 mux port: CCM_STOP of instance: ccm"]
    ALT6 = 6,
    #[doc = "8: Select mux mode: ALT8 mux port: SAI3_MCLK of instance: sai3"]
    ALT8 = 8,
}
...
pub enum SION_A {
    ...
    DISABLED = 0,
    #[doc = "1: Force input path of pad GPIO_SD_B1_04"]
    ENABLED = 1,
}
