#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_EMC_04"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_EMC_04>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_EMC_04"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_EMC_04>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_EMC_04 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_EMC_04 {
    type Type = u32;
    #[inline(always)]
...
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: SEMC_DATA04 of instance: semc"]
    ALT0,
    #[doc = "1: Select mux mode: ALT1 mux port: FLEXPWM4_PWMA02 of instance: flexpwm4"]
    ALT1,
    #[doc = "2: Select mux mode: ALT2 mux port: SAI2_TX_DATA of instance: sai2"]
    ALT2,
    #[doc = "3: Select mux mode: ALT3 mux port: XBAR1_INOUT06 of instance: xbar1"]
    ALT3,
    #[doc = "4: Select mux mode: ALT4 mux port: FLEXIO1_FLEXIO04 of instance: flexio1"]
    ALT4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO4_IO04 of instance: gpio4"]
    ALT5,
}
...
pub enum SION_A {
    ...
    DISABLED,
    #[doc = "1: Force input path of pad GPIO_EMC_04"]
    ENABLED,
}
