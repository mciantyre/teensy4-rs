#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_SPI_B0_06"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_SPI_B0_06>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_SPI_B0_06"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_SPI_B0_06>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_SPI_B0_06 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_SPI_B0_06 {
    type Type = u32;
    #[inline(always)]
...
#[repr(u8)]
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: FLEXSPI2_A_DATA02 of instance: flexspi2"]
    ALT0 = 0,
}
...
pub enum SION_A {
    ...
    DISABLED = 0,
    #[doc = "1: Force input path of pad GPIO_SPI_B0_06"]
    ENABLED = 1,
}
...
impl<'a> SION_W<'a> {
    ...
    #[doc = "Force input path of pad GPIO_SPI_B0_06"]
    #[inline(always)]
