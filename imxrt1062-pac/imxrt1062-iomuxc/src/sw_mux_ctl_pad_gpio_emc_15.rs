#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_EMC_15"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_EMC_15>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_EMC_15"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_EMC_15>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_EMC_15 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_EMC_15 {
    type Type = u32;
    #[inline(always)]
...
#[repr(u8)]
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: SEMC_ADDR06 of instance: semc"]
    ALT0 = 0,
    #[doc = "1: Select mux mode: ALT1 mux port: XBAR1_IN20 of instance: xbar1"]
    ALT1 = 1,
    ...
    ALT3 = 3,
    #[doc = "4: Select mux mode: ALT4 mux port: QTIMER3_TIMER0 of instance: qtimer3"]
    ALT4 = 4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO4_IO15 of instance: gpio4"]
    ALT5 = 5,
    #[doc = "8: Select mux mode: ALT8 mux port: FLEXSPI2_B_DATA02 of instance: flexspi2"]
    ALT8 = 8,
}
...
pub enum SION_A {
    ...
    DISABLED = 0,
    #[doc = "1: Force input path of pad GPIO_EMC_15"]
    ENABLED = 1,
}
