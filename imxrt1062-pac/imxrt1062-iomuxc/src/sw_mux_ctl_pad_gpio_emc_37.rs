#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_EMC_37"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_EMC_37>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_EMC_37"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_EMC_37>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_EMC_37 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_EMC_37 {
    type Type = u32;
    #[inline(always)]
...
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: SEMC_DATA15 of instance: semc"]
    ALT0,
    #[doc = "1: Select mux mode: ALT1 mux port: XBAR1_IN23 of instance: xbar1"]
    ALT1,
    #[doc = "2: Select mux mode: ALT2 mux port: GPT1_COMPARE3 of instance: gpt1"]
    ALT2,
    #[doc = "3: Select mux mode: ALT3 mux port: SAI3_MCLK of instance: sai3"]
    ALT3,
    #[doc = "4: Select mux mode: ALT4 mux port: CSI_DATA16 of instance: csi"]
    ALT4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO3_IO23 of instance: gpio3"]
    ALT5,
    #[doc = "6: Select mux mode: ALT6 mux port: USDHC2_WP of instance: usdhc2"]
    ALT6,
    #[doc = "8: Select mux mode: ALT8 mux port: ENET2_RX_EN of instance: enet2"]
    ALT8,
    #[doc = "9: Select mux mode: ALT9 mux port: FLEXCAN3_RX of instance: flexcan3/canfd"]
    ALT9,
}
...
pub enum SION_A {
    ...
    DISABLED,
    #[doc = "1: Force input path of pad GPIO_EMC_37"]
    ENABLED,
}
