#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_AD_B1_00"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_AD_B1_00>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_AD_B1_00"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_AD_B1_00>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_AD_B1_00 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_AD_B1_00 {
    type Type = u32;
    #[inline(always)]
...
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: USB_OTG2_ID of instance: anatop"]
    ALT0,
    #[doc = "1: Select mux mode: ALT1 mux port: QTIMER3_TIMER0 of instance: qtimer3"]
    ALT1,
    #[doc = "2: Select mux mode: ALT2 mux port: LPUART2_CTS_B of instance: lpuart2"]
    ALT2,
    #[doc = "3: Select mux mode: ALT3 mux port: LPI2C1_SCL of instance: lpi2c1"]
    ALT3,
    #[doc = "4: Select mux mode: ALT4 mux port: WDOG1_B of instance: wdog1"]
    ALT4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO1_IO16 of instance: gpio1"]
    ALT5,
    #[doc = "6: Select mux mode: ALT6 mux port: USDHC1_WP of instance: usdhc1"]
    ALT6,
    #[doc = "7: Select mux mode: ALT7 mux port: KPP_ROW07 of instance: kpp"]
    ALT7,
    #[doc = "8: Select mux mode: ALT8 mux port: ENET2_1588_EVENT0_OUT of instance: enet2"]
    ALT8,
    #[doc = "9: Select mux mode: ALT9 mux port: FLEXIO3_FLEXIO00 of instance: flexio3"]
    ALT9,
}
...
pub enum SION_A {
    ...
    DISABLED,
    #[doc = "1: Force input path of pad GPIO_AD_B1_00"]
    ENABLED,
}
