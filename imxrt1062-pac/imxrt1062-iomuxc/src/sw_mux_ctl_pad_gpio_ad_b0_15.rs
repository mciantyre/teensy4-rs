#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_AD_B0_15"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_AD_B0_15>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_AD_B0_15"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_AD_B0_15>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_AD_B0_15 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_AD_B0_15 {
    type Type = u32;
    #[inline(always)]
...
#[repr(u8)]
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: USB_OTG2_PWR of instance: usb"]
    ALT0 = 0,
    #[doc = "1: Select mux mode: ALT1 mux port: XBAR1_IN25 of instance: xbar1"]
    ALT1 = 1,
    #[doc = "2: Select mux mode: ALT2 mux port: LPUART1_RTS_B of instance: lpuart1"]
    ALT2 = 2,
    ...
    ALT4 = 4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO1_IO15 of instance: gpio1"]
    ALT5 = 5,
    #[doc = "6: Select mux mode: ALT6 mux port: FLEXCAN2_RX of instance: flexcan2"]
    ALT6 = 6,
    #[doc = "7: Select mux mode: ALT7 mux port: WDOG1_WDOG_RST_B_DEB of instance: wdog1"]
    ALT7 = 7,
...
pub enum SION_A {
    ...
    DISABLED = 0,
    #[doc = "1: Force input path of pad GPIO_AD_B0_15"]
    ENABLED = 1,
}
