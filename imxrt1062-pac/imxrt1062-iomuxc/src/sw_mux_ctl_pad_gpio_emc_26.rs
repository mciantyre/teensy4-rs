#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_EMC_26"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_EMC_26>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_EMC_26"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_EMC_26>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_EMC_26 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_EMC_26 {
    type Type = u32;
    #[inline(always)]
...
#[repr(u8)]
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: SEMC_CLK of instance: semc"]
    ALT0 = 0,
    ...
    ALT3 = 3,
    #[doc = "4: Select mux mode: ALT4 mux port: FLEXIO1_FLEXIO12 of instance: flexio1"]
    ALT4 = 4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO4_IO26 of instance: gpio4"]
    ALT5 = 5,
    #[doc = "8: Select mux mode: ALT8 mux port: FLEXSPI2_A_DATA00 of instance: flexspi2"]
    ALT8 = 8,
}
...
pub enum SION_A {
    ...
    DISABLED = 0,
    #[doc = "1: Force input path of pad GPIO_EMC_26"]
    ENABLED = 1,
}
