#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_EMC_31"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_EMC_31>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_EMC_31"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_EMC_31>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_EMC_31 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_EMC_31 {
    type Type = u32;
    #[inline(always)]
...
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: SEMC_DATA09 of instance: semc"]
    ALT0,
    #[doc = "1: Select mux mode: ALT1 mux port: FLEXPWM3_PWMA01 of instance: flexpwm3"]
    ALT1,
    #[doc = "2: Select mux mode: ALT2 mux port: LPUART7_TX of instance: lpuart7"]
    ALT2,
    #[doc = "3: Select mux mode: ALT3 mux port: LPSPI1_PCS1 of instance: lpspi1"]
    ALT3,
    #[doc = "4: Select mux mode: ALT4 mux port: CSI_DATA22 of instance: csi"]
    ALT4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO4_IO31 of instance: gpio4"]
    ALT5,
...
pub enum SION_A {
    ...
    DISABLED,
    #[doc = "1: Force input path of pad GPIO_EMC_31"]
    ENABLED,
}
