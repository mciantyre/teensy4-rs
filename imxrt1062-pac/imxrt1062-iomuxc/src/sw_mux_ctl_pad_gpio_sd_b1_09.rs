#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_SD_B1_09"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_SD_B1_09>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_SD_B1_09"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_SD_B1_09>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_SD_B1_09 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_SD_B1_09 {
    type Type = u32;
    #[inline(always)]
...
#[repr(u8)]
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: USDHC2_DATA5 of instance: usdhc2"]
    ALT0 = 0,
    #[doc = "1: Select mux mode: ALT1 mux port: FLEXSPIA_DATA01 of instance: flexspi"]
    ALT1 = 1,
    ...
    ALT3 = 3,
    #[doc = "4: Select mux mode: ALT4 mux port: LPSPI2_SDI of instance: lpspi2"]
    ALT4 = 4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO3_IO09 of instance: gpio3"]
    ALT5 = 5,
}
...
pub enum SION_A {
    ...
    DISABLED = 0,
    #[doc = "1: Force input path of pad GPIO_SD_B1_09"]
    ENABLED = 1,
}
