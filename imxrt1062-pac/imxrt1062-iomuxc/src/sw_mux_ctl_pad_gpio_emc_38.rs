#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_EMC_38"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_EMC_38>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_EMC_38"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_EMC_38>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_EMC_38 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_EMC_38 {
    type Type = u32;
    #[inline(always)]
...
#[repr(u8)]
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: SEMC_DM01 of instance: semc"]
    ALT0 = 0,
    ...
    ALT2 = 2,
    #[doc = "3: Select mux mode: ALT3 mux port: SAI3_TX_BCLK of instance: sai3"]
    ALT3 = 3,
    #[doc = "4: Select mux mode: ALT4 mux port: CSI_FIELD of instance: csi"]
    ALT4 = 4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO3_IO24 of instance: gpio3"]
    ALT5 = 5,
    #[doc = "6: Select mux mode: ALT6 mux port: USDHC2_VSELECT of instance: usdhc2"]
    ALT6 = 6,
...
pub enum SION_A {
    ...
    DISABLED = 0,
    #[doc = "1: Force input path of pad GPIO_EMC_38"]
    ENABLED = 1,
}
