#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_EMC_10"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_EMC_10>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_EMC_10"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_EMC_10>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_EMC_10 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_EMC_10 {
    type Type = u32;
    #[inline(always)]
...
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: SEMC_ADDR01 of instance: semc"]
    ALT0,
    #[doc = "1: Select mux mode: ALT1 mux port: FLEXPWM2_PWMA02 of instance: flexpwm2"]
    ALT1,
    #[doc = "2: Select mux mode: ALT2 mux port: SAI2_RX_BCLK of instance: sai2"]
    ALT2,
    #[doc = "3: Select mux mode: ALT3 mux port: FLEXCAN2_RX of instance: flexcan2"]
    ALT3,
    #[doc = "4: Select mux mode: ALT4 mux port: FLEXIO1_FLEXIO10 of instance: flexio1"]
    ALT4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO4_IO10 of instance: gpio4"]
    ALT5,
    #[doc = "8: Select mux mode: ALT8 mux port: FLEXSPI2_B_SS0_B of instance: flexspi2"]
    ALT8,
}
...
pub enum SION_A {
    ...
    DISABLED,
    #[doc = "1: Force input path of pad GPIO_EMC_10"]
    ENABLED,
}
