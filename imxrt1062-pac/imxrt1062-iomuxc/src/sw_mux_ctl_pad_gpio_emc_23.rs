#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_EMC_23"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_EMC_23>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_EMC_23"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_EMC_23>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_EMC_23 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_EMC_23 {
    type Type = u32;
    #[inline(always)]
...
#[repr(u8)]
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: SEMC_ADDR10 of instance: semc"]
    ALT0 = 0,
    #[doc = "1: Select mux mode: ALT1 mux port: FLEXPWM1_PWMA00 of instance: flexpwm1"]
    ALT1 = 1,
    #[doc = "2: Select mux mode: ALT2 mux port: LPUART5_TX of instance: lpuart5"]
    ALT2 = 2,
    #[doc = "3: Select mux mode: ALT3 mux port: ENET_RX_EN of instance: enet"]
    ALT3 = 3,
    #[doc = "4: Select mux mode: ALT4 mux port: GPT1_CAPTURE2 of instance: gpt1"]
    ALT4 = 4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO4_IO23 of instance: gpio4"]
    ALT5 = 5,
    #[doc = "8: Select mux mode: ALT8 mux port: FLEXSPI2_A_DQS of instance: flexspi2"]
    ALT8 = 8,
}
...
pub enum SION_A {
    ...
    DISABLED = 0,
    #[doc = "1: Force input path of pad GPIO_EMC_23"]
    ENABLED = 1,
}
