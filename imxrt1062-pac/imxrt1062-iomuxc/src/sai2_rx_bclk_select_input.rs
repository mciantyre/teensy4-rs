#[doc = "Reader of register SAI2_RX_BCLK_SELECT_INPUT"]
pub type R = crate::R<u32, super::SAI2_RX_BCLK_SELECT_INPUT>;
#[doc = "Writer for register SAI2_RX_BCLK_SELECT_INPUT"]
pub type W = crate::W<u32, super::SAI2_RX_BCLK_SELECT_INPUT>;
#[doc = "Register SAI2_RX_BCLK_SELECT_INPUT `reset()`'s with value 0"]
impl crate::ResetValue for super::SAI2_RX_BCLK_SELECT_INPUT {
    type Type = u32;
    #[inline(always)]
...
pub enum DAISY_A {
    #[doc = "0: Selecting Pad: GPIO_EMC_10 for Mode: ALT2"]
    GPIO_EMC_10_ALT2,
...
impl From<DAISY_A> for bool {
    ...
    fn from(variant: DAISY_A) -> Self {
        match variant {
            DAISY_A::GPIO_EMC_10_ALT2 => false,
            DAISY_A::GPIO_AD_B0_06_ALT3 => true,
        }
    }
}
...
impl DAISY_R {
    ...
    pub fn variant(&self) -> DAISY_A {
        match self.bits {
            false => DAISY_A::GPIO_EMC_10_ALT2,
...
impl<'a> DAISY_W<'a> {
    ...
    pub fn gpio_emc_10_alt2(self) -> &'a mut W {
        self.variant(DAISY_A::GPIO_EMC_10_ALT2)
    }
