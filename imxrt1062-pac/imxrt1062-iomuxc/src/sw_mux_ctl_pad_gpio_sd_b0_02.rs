#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_SD_B0_02"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_SD_B0_02>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_SD_B0_02"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_SD_B0_02>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_SD_B0_02 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_SD_B0_02 {
    type Type = u32;
    #[inline(always)]
...
pub enum MUX_MODE_A {
    ...
    ALT1,
    #[doc = "2: Select mux mode: ALT2 mux port: LPUART8_CTS_B of instance: lpuart8"]
    ALT2,
    ...
    ALT4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO3_IO14 of instance: gpio3"]
    ALT5,
...
pub enum SION_A {
    ...
    DISABLED,
    #[doc = "1: Force input path of pad GPIO_SD_B0_02"]
    ENABLED,
}
