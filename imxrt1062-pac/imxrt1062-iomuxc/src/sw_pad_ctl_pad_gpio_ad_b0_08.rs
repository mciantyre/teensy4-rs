#[doc = "Reader of register SW_PAD_CTL_PAD_GPIO_AD_B0_08"]
pub type R = crate::R<u32, super::SW_PAD_CTL_PAD_GPIO_AD_B0_08>;
#[doc = "Writer for register SW_PAD_CTL_PAD_GPIO_AD_B0_08"]
pub type W = crate::W<u32, super::SW_PAD_CTL_PAD_GPIO_AD_B0_08>;
#[doc = "Register SW_PAD_CTL_PAD_GPIO_AD_B0_08 `reset()`'s with value 0xb0a0"]
impl crate::ResetValue for super::SW_PAD_CTL_PAD_GPIO_AD_B0_08 {
    type Type = u32;
    #[inline(always)]
...
impl DSE_R {
    ...
    pub fn variant(&self) -> DSE_A {
        match self.bits {
            0 => DSE_A::DSE_0_OUTPUT_DRIVER_DISABLED,
            1 => DSE_A::DSE_1_R0_150_OHM_3_3V_260_OHM_1_8V,
            2 => DSE_A::DSE_2_R0_2,
            3 => DSE_A::DSE_3_R0_3,
            4 => DSE_A::DSE_4_R0_4,
            5 => DSE_A::DSE_5_R0_5,
    ...
    pub fn is_dse_0_output_driver_disabled(&self) -> bool {
        *self == DSE_A::DSE_0_OUTPUT_DRIVER_DISABLED
    }
    ...
    pub fn is_dse_1_r0_150_ohm_3_3v_260_ohm_1_8v(&self) -> bool {
        *self == DSE_A::DSE_1_R0_150_OHM_3_3V_260_OHM_1_8V
    }
...
impl<'a> DSE_W<'a> {
    ...
    pub fn dse_0_output_driver_disabled(self) -> &'a mut W {
        self.variant(DSE_A::DSE_0_OUTPUT_DRIVER_DISABLED)
    }
    #[doc = "R0(150 Ohm @ 3.3V, 260 Ohm@1.8V)"]
    #[inline(always)]
    pub fn dse_1_r0_150_ohm_3_3v_260_ohm_1_8v(self) -> &'a mut W {
        self.variant(DSE_A::DSE_1_R0_150_OHM_3_3V_260_OHM_1_8V)
    }
    #[doc = "R0/2"]
    #[inline(always)]
...
impl SPEED_R {
    ...
    pub fn variant(&self) -> SPEED_A {
        match self.bits {
            0 => SPEED_A::SPEED_0_LOW_50MHZ,
            1 => SPEED_A::SPEED_1_MEDIUM_100MHZ,
            2 => SPEED_A::SPEED_2_MEDIUM_100MHZ,
            3 => SPEED_A::SPEED_3_MAX_200MHZ,
            _ => unreachable!(),
        }
    }
...
impl<'a> SPEED_W<'a> {
    ...
    pub fn speed_0_low_50mhz(self) -> &'a mut W {
        self.variant(SPEED_A::SPEED_0_LOW_50MHZ)
    }
    #[doc = "medium(100MHz)"]
    #[inline(always)]
    pub fn speed_1_medium_100mhz(self) -> &'a mut W {
        self.variant(SPEED_A::SPEED_1_MEDIUM_100MHZ)
    }
    #[doc = "medium(100MHz)"]
    #[inline(always)]
    pub fn speed_2_medium_100mhz(self) -> &'a mut W {
        self.variant(SPEED_A::SPEED_2_MEDIUM_100MHZ)
    }
    #[doc = "max(200MHz)"]
    #[inline(always)]
    pub fn speed_3_max_200mhz(self) -> &'a mut W {
        self.variant(SPEED_A::SPEED_3_MAX_200MHZ)
    }
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub fn bits(self, value: u8) -> &'a mut W {
