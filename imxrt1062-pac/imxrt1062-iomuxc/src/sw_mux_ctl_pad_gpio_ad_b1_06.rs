#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_AD_B1_06"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_AD_B1_06>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_AD_B1_06"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_AD_B1_06>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_AD_B1_06 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_AD_B1_06 {
    type Type = u32;
    #[inline(always)]
...
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: FLEXSPIB_DATA01 of instance: flexspi"]
    ALT0,
    #[doc = "1: Select mux mode: ALT1 mux port: LPI2C3_SDA of instance: lpi2c3"]
    ALT1,
    #[doc = "2: Select mux mode: ALT2 mux port: LPUART3_TX of instance: lpuart3"]
    ALT2,
    #[doc = "3: Select mux mode: ALT3 mux port: SPDIF_LOCK of instance: spdif"]
    ALT3,
    #[doc = "4: Select mux mode: ALT4 mux port: CSI_VSYNC of instance: csi"]
    ALT4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO1_IO22 of instance: gpio1"]
    ALT5,
    #[doc = "6: Select mux mode: ALT6 mux port: USDHC2_DATA2 of instance: usdhc2"]
    ALT6,
    #[doc = "7: Select mux mode: ALT7 mux port: KPP_ROW04 of instance: kpp"]
    ALT7,
    #[doc = "8: Select mux mode: ALT8 mux port: GPT2_COMPARE2 of instance: gpt2"]
    ALT8,
    #[doc = "9: Select mux mode: ALT9 mux port: FLEXIO3_FLEXIO06 of instance: flexio3"]
    ALT9,
}
...
pub enum SION_A {
    ...
    DISABLED,
    #[doc = "1: Force input path of pad GPIO_AD_B1_06"]
    ENABLED,
}
