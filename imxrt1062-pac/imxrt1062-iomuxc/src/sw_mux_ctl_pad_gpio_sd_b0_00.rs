#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_SD_B0_00"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_SD_B0_00>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_SD_B0_00"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_SD_B0_00>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_SD_B0_00 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_SD_B0_00 {
    type Type = u32;
    #[inline(always)]
...
#[repr(u8)]
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: USDHC1_CMD of instance: usdhc1"]
    ALT0 = 0,
    #[doc = "1: Select mux mode: ALT1 mux port: FLEXPWM1_PWMA00 of instance: flexpwm1"]
    ALT1 = 1,
    #[doc = "2: Select mux mode: ALT2 mux port: LPI2C3_SCL of instance: lpi2c3"]
    ALT2 = 2,
    #[doc = "3: Select mux mode: ALT3 mux port: XBAR1_INOUT04 of instance: xbar1"]
    ALT3 = 3,
    #[doc = "4: Select mux mode: ALT4 mux port: LPSPI1_SCK of instance: lpspi1"]
    ALT4 = 4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO3_IO12 of instance: gpio3"]
    ALT5 = 5,
    #[doc = "6: Select mux mode: ALT6 mux port: FLEXSPIA_SS1_B of instance: flexspi"]
    ALT6 = 6,
    #[doc = "8: Select mux mode: ALT8 mux port: ENET2_TX_EN of instance: enet2"]
    ALT8 = 8,
    #[doc = "9: Select mux mode: ALT9 mux port: SEMC_DQS4 of instance: semc"]
    ALT9 = 9,
}
...
pub enum SION_A {
    ...
    DISABLED = 0,
    #[doc = "1: Force input path of pad GPIO_SD_B0_00"]
    ENABLED = 1,
}
