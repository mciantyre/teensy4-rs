#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_SD_B1_01"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_SD_B1_01>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_SD_B1_01"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_SD_B1_01>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_SD_B1_01 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_SD_B1_01 {
    type Type = u32;
    #[inline(always)]
...
#[repr(u8)]
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: USDHC2_DATA2 of instance: usdhc2"]
    ALT0 = 0,
    #[doc = "1: Select mux mode: ALT1 mux port: FLEXSPIB_DATA02 of instance: flexspi"]
    ALT1 = 1,
    #[doc = "2: Select mux mode: ALT2 mux port: FLEXPWM1_PWMB03 of instance: flexpwm1"]
    ALT2 = 2,
    #[doc = "3: Select mux mode: ALT3 mux port: SAI1_TX_DATA02 of instance: sai1"]
    ALT3 = 3,
    #[doc = "4: Select mux mode: ALT4 mux port: LPUART4_RX of instance: lpuart4"]
    ALT4 = 4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO3_IO01 of instance: gpio3"]
    ALT5 = 5,
    #[doc = "8: Select mux mode: ALT8 mux port: SAI3_TX_DATA of instance: sai3"]
    ALT8 = 8,
}
...
pub enum SION_A {
    ...
    DISABLED = 0,
    #[doc = "1: Force input path of pad GPIO_SD_B1_01"]
    ENABLED = 1,
}
