#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_EMC_28"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_EMC_28>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_EMC_28"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_EMC_28>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_EMC_28 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_EMC_28 {
    type Type = u32;
    #[inline(always)]
...
#[repr(u8)]
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: SEMC_WE of instance: semc"]
    ALT0 = 0,
    #[doc = "1: Select mux mode: ALT1 mux port: FLEXPWM1_PWMB02 of instance: flexpwm1"]
    ALT1 = 1,
    #[doc = "2: Select mux mode: ALT2 mux port: LPUART5_CTS_B of instance: lpuart5"]
    ALT2 = 2,
    #[doc = "3: Select mux mode: ALT3 mux port: LPSPI1_SDO of instance: lpspi1"]
    ALT3 = 3,
    #[doc = "4: Select mux mode: ALT4 mux port: FLEXIO1_FLEXIO14 of instance: flexio1"]
    ALT4 = 4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO4_IO28 of instance: gpio4"]
    ALT5 = 5,
    #[doc = "8: Select mux mode: ALT8 mux port: FLEXSPI2_A_DATA02 of instance: flexspi2"]
    ALT8 = 8,
}
...
pub enum SION_A {
    ...
    DISABLED = 0,
    #[doc = "1: Force input path of pad GPIO_EMC_28"]
    ENABLED = 1,
}
