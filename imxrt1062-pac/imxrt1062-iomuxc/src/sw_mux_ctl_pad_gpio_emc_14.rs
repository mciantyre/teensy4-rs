#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_EMC_14"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_EMC_14>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_EMC_14"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_EMC_14>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_EMC_14 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_EMC_14 {
    type Type = u32;
    #[inline(always)]
...
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: SEMC_ADDR05 of instance: semc"]
    ALT0,
    #[doc = "1: Select mux mode: ALT1 mux port: XBAR1_INOUT19 of instance: xbar1"]
    ALT1,
    #[doc = "2: Select mux mode: ALT2 mux port: LPUART3_RX of instance: lpuart3"]
    ALT2,
    #[doc = "3: Select mux mode: ALT3 mux port: MQS_LEFT of instance: mqs"]
    ALT3,
    #[doc = "4: Select mux mode: ALT4 mux port: LPSPI2_PCS1 of instance: lpspi2"]
    ALT4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO4_IO14 of instance: gpio4"]
    ALT5,
    #[doc = "8: Select mux mode: ALT8 mux port: FLEXSPI2_B_DATA01 of instance: flexspi2"]
    ALT8,
}
...
pub enum SION_A {
    ...
    DISABLED,
    #[doc = "1: Force input path of pad GPIO_EMC_14"]
    ENABLED,
}
