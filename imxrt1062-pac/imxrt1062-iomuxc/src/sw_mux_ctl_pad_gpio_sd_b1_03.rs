#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_SD_B1_03"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_SD_B1_03>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_SD_B1_03"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_SD_B1_03>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_SD_B1_03 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_SD_B1_03 {
    type Type = u32;
    #[inline(always)]
...
#[repr(u8)]
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: USDHC2_DATA0 of instance: usdhc2"]
    ALT0 = 0,
    #[doc = "1: Select mux mode: ALT1 mux port: FLEXSPIB_DATA00 of instance: flexspi"]
    ALT1 = 1,
    #[doc = "2: Select mux mode: ALT2 mux port: FLEXPWM2_PWMB03 of instance: flexpwm2"]
    ALT2 = 2,
    #[doc = "3: Select mux mode: ALT3 mux port: SAI1_MCLK of instance: sai1"]
    ALT3 = 3,
    #[doc = "4: Select mux mode: ALT4 mux port: FLEXCAN1_RX of instance: flexcan1"]
    ALT4 = 4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO3_IO03 of instance: gpio3"]
    ALT5 = 5,
    #[doc = "6: Select mux mode: ALT6 mux port: CCM_PMIC_READY of instance: ccm"]
    ALT6 = 6,
    #[doc = "8: Select mux mode: ALT8 mux port: SAI3_TX_BCLK of instance: sai3"]
    ALT8 = 8,
}
...
pub enum SION_A {
    ...
    DISABLED = 0,
    #[doc = "1: Force input path of pad GPIO_SD_B1_03"]
    ENABLED = 1,
}
