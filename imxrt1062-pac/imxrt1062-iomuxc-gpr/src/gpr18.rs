#[doc = "Reader of register GPR18"]
pub type R = crate::R<u32, super::GPR18>;
#[doc = "Writer for register GPR18"]
pub type W = crate::W<u32, super::GPR18>;
#[doc = "Register GPR18 `reset()`'s with value 0"]
impl crate::ResetValue for super::GPR18 {
    type Type = u32;
    #[inline(always)]
...
impl From<LOCK_M7_APC_AC_R0_BOT_A> for bool {
    ...
    fn from(variant: LOCK_M7_APC_AC_R0_BOT_A) -> Self {
        match variant {
            LOCK_M7_APC_AC_R0_BOT_A::LOCK_M7_APC_AC_R0_BOT_0 => false,
            LOCK_M7_APC_AC_R0_BOT_A::LOCK_M7_APC_AC_R0_BOT_1 => true,
        }
    }
}
#[doc = "Reader of field `LOCK_M7_APC_AC_R0_BOT`"]
pub type LOCK_M7_APC_AC_R0_BOT_R = crate::R<bool, LOCK_M7_APC_AC_R0_BOT_A>;
...
#[doc = "Write proxy for field `LOCK_M7_APC_AC_R0_BOT`"]
pub struct LOCK_M7_APC_AC_R0_BOT_W<'a> {
    w: &'a mut W,
}
impl<'a> LOCK_M7_APC_AC_R0_BOT_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: LOCK_M7_APC_AC_R0_BOT_A) -> &'a mut W {
        {
...
#[doc = "Reader of field `M7_APC_AC_R0_BOT`"]
pub type M7_APC_AC_R0_BOT_R = crate::R<u32, u32>;
#[doc = "Write proxy for field `M7_APC_AC_R0_BOT`"]
pub struct M7_APC_AC_R0_BOT_W<'a> {
    w: &'a mut W,
}
impl<'a> M7_APC_AC_R0_BOT_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
...
impl R {
    ...
    pub fn lock_m7_apc_ac_r0_bot(&self) -> LOCK_M7_APC_AC_R0_BOT_R {
        LOCK_M7_APC_AC_R0_BOT_R::new((self.bits & 0x01) != 0)
    }
    #[doc = "Bits 3:31 - APC end address of memory region-0"]
    #[inline(always)]
    pub fn m7_apc_ac_r0_bot(&self) -> M7_APC_AC_R0_BOT_R {
        M7_APC_AC_R0_BOT_R::new(((self.bits >> 3) & 0x1fff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bit 0 - lock M7_APC_AC_R0_BOT field for changes"]
    #[inline(always)]
    pub fn lock_m7_apc_ac_r0_bot(&mut self) -> LOCK_M7_APC_AC_R0_BOT_W {
        LOCK_M7_APC_AC_R0_BOT_W { w: self }
    }
    #[doc = "Bits 3:31 - APC end address of memory region-0"]
    #[inline(always)]
    pub fn m7_apc_ac_r0_bot(&mut self) -> M7_APC_AC_R0_BOT_W {
        M7_APC_AC_R0_BOT_W { w: self }
    }
}
