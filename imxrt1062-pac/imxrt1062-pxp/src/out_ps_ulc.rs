#[doc = "Reader of register OUT_PS_ULC"]
pub type R = crate::R<u32, super::OUT_PS_ULC>;
#[doc = "Writer for register OUT_PS_ULC"]
pub type W = crate::W<u32, super::OUT_PS_ULC>;
#[doc = "Register OUT_PS_ULC `reset()`'s with value 0"]
impl crate::ResetValue for super::OUT_PS_ULC {
    type Type = u32;
    #[inline(always)]
