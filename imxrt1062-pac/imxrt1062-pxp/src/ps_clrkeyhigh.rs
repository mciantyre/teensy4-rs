#[doc = "Reader of register PS_CLRKEYHIGH"]
pub type R = crate::R<u32, super::PS_CLRKEYHIGH>;
#[doc = "Writer for register PS_CLRKEYHIGH"]
pub type W = crate::W<u32, super::PS_CLRKEYHIGH>;
#[doc = "Register PS_CLRKEYHIGH `reset()`'s with value 0"]
impl crate::ResetValue for super::PS_CLRKEYHIGH {
    type Type = u32;
    #[inline(always)]
