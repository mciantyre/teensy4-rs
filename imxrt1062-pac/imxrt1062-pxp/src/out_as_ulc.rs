#[doc = "Reader of register OUT_AS_ULC"]
pub type R = crate::R<u32, super::OUT_AS_ULC>;
#[doc = "Writer for register OUT_AS_ULC"]
pub type W = crate::W<u32, super::OUT_AS_ULC>;
#[doc = "Register OUT_AS_ULC `reset()`'s with value 0"]
impl crate::ResetValue for super::OUT_AS_ULC {
    type Type = u32;
    #[inline(always)]
