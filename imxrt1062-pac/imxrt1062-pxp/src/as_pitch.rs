#[doc = "Reader of register AS_PITCH"]
pub type R = crate::R<u32, super::AS_PITCH>;
#[doc = "Writer for register AS_PITCH"]
pub type W = crate::W<u32, super::AS_PITCH>;
#[doc = "Register AS_PITCH `reset()`'s with value 0"]
impl crate::ResetValue for super::AS_PITCH {
    type Type = u32;
    #[inline(always)]
