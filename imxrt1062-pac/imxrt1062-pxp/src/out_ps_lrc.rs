#[doc = "Reader of register OUT_PS_LRC"]
pub type R = crate::R<u32, super::OUT_PS_LRC>;
#[doc = "Writer for register OUT_PS_LRC"]
pub type W = crate::W<u32, super::OUT_PS_LRC>;
#[doc = "Register OUT_PS_LRC `reset()`'s with value 0"]
impl crate::ResetValue for super::OUT_PS_LRC {
    type Type = u32;
    #[inline(always)]
