#[doc = "Reader of register PIGEONCTRL1_CLR"]
pub type R = crate::R<u32, super::PIGEONCTRL1_CLR>;
#[doc = "Writer for register PIGEONCTRL1_CLR"]
pub type W = crate::W<u32, super::PIGEONCTRL1_CLR>;
#[doc = "Register PIGEONCTRL1_CLR `reset()`'s with value 0"]
impl crate::ResetValue for super::PIGEONCTRL1_CLR {
    type Type = u32;
    #[inline(always)]
