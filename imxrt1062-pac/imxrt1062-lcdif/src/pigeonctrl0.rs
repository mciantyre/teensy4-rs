#[doc = "Reader of register PIGEONCTRL0"]
pub type R = crate::R<u32, super::PIGEONCTRL0>;
#[doc = "Writer for register PIGEONCTRL0"]
pub type W = crate::W<u32, super::PIGEONCTRL0>;
#[doc = "Register PIGEONCTRL0 `reset()`'s with value 0"]
impl crate::ResetValue for super::PIGEONCTRL0 {
    type Type = u32;
    #[inline(always)]
