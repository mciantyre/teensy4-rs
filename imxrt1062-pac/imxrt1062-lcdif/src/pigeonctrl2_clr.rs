#[doc = "Reader of register PIGEONCTRL2_CLR"]
pub type R = crate::R<u32, super::PIGEONCTRL2_CLR>;
#[doc = "Writer for register PIGEONCTRL2_CLR"]
pub type W = crate::W<u32, super::PIGEONCTRL2_CLR>;
#[doc = "Register PIGEONCTRL2_CLR `reset()`'s with value 0"]
impl crate::ResetValue for super::PIGEONCTRL2_CLR {
    type Type = u32;
    #[inline(always)]
