#[doc = "Reader of register PIGEONCTRL0_SET"]
pub type R = crate::R<u32, super::PIGEONCTRL0_SET>;
#[doc = "Writer for register PIGEONCTRL0_SET"]
pub type W = crate::W<u32, super::PIGEONCTRL0_SET>;
#[doc = "Register PIGEONCTRL0_SET `reset()`'s with value 0"]
impl crate::ResetValue for super::PIGEONCTRL0_SET {
    type Type = u32;
    #[inline(always)]
