#[doc = "Reader of register PIGEONCTRL1_TOG"]
pub type R = crate::R<u32, super::PIGEONCTRL1_TOG>;
#[doc = "Writer for register PIGEONCTRL1_TOG"]
pub type W = crate::W<u32, super::PIGEONCTRL1_TOG>;
#[doc = "Register PIGEONCTRL1_TOG `reset()`'s with value 0"]
impl crate::ResetValue for super::PIGEONCTRL1_TOG {
    type Type = u32;
    #[inline(always)]
