#[doc = "Reader of register PIGEONCTRL2_SET"]
pub type R = crate::R<u32, super::PIGEONCTRL2_SET>;
#[doc = "Writer for register PIGEONCTRL2_SET"]
pub type W = crate::W<u32, super::PIGEONCTRL2_SET>;
#[doc = "Register PIGEONCTRL2_SET `reset()`'s with value 0"]
impl crate::ResetValue for super::PIGEONCTRL2_SET {
    type Type = u32;
    #[inline(always)]
