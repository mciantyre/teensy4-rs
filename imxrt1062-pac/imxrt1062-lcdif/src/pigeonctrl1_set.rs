#[doc = "Reader of register PIGEONCTRL1_SET"]
pub type R = crate::R<u32, super::PIGEONCTRL1_SET>;
#[doc = "Writer for register PIGEONCTRL1_SET"]
pub type W = crate::W<u32, super::PIGEONCTRL1_SET>;
#[doc = "Register PIGEONCTRL1_SET `reset()`'s with value 0"]
impl crate::ResetValue for super::PIGEONCTRL1_SET {
    type Type = u32;
    #[inline(always)]
