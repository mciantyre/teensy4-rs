#[doc = "Reader of register SCS_TOG"]
pub type R = crate::R<u32, super::SCS_TOG>;
#[doc = "Writer for register SCS_TOG"]
pub type W = crate::W<u32, super::SCS_TOG>;
#[doc = "Register SCS_TOG `reset()`'s with value 0"]
impl crate::ResetValue for super::SCS_TOG {
    type Type = u32;
    #[inline(always)]
