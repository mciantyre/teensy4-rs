#[doc = "Reader of register SCS_CLR"]
pub type R = crate::R<u32, super::SCS_CLR>;
#[doc = "Writer for register SCS_CLR"]
pub type W = crate::W<u32, super::SCS_CLR>;
#[doc = "Register SCS_CLR `reset()`'s with value 0"]
impl crate::ResetValue for super::SCS_CLR {
    type Type = u32;
    #[inline(always)]
