#[doc = "Reader of register FLSHA1CR0"]
pub type R = crate::R<u32, super::FLSHA1CR0>;
#[doc = "Writer for register FLSHA1CR0"]
pub type W = crate::W<u32, super::FLSHA1CR0>;
#[doc = "Register FLSHA1CR0 `reset()`'s with value 0x0001_0000"]
impl crate::ResetValue for super::FLSHA1CR0 {
    type Type = u32;
    #[inline(always)]
