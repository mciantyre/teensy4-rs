#[doc = "Reader of register FLSHB1CR0"]
pub type R = crate::R<u32, super::FLSHB1CR0>;
#[doc = "Writer for register FLSHB1CR0"]
pub type W = crate::W<u32, super::FLSHB1CR0>;
#[doc = "Register FLSHB1CR0 `reset()`'s with value 0x0001_0000"]
impl crate::ResetValue for super::FLSHB1CR0 {
    type Type = u32;
    #[inline(always)]
