#[doc = "Reader of register USB1_MISC_TOG"]
pub type R = crate::R<u32, super::USB1_MISC_TOG>;
#[doc = "Writer for register USB1_MISC_TOG"]
pub type W = crate::W<u32, super::USB1_MISC_TOG>;
#[doc = "Register USB1_MISC_TOG `reset()`'s with value 0x02"]
impl crate::ResetValue for super::USB1_MISC_TOG {
    type Type = u32;
    #[inline(always)]
