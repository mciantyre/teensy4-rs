#[doc = "Reader of register USB2_MISC_SET"]
pub type R = crate::R<u32, super::USB2_MISC_SET>;
#[doc = "Writer for register USB2_MISC_SET"]
pub type W = crate::W<u32, super::USB2_MISC_SET>;
#[doc = "Register USB2_MISC_SET `reset()`'s with value 0x02"]
impl crate::ResetValue for super::USB2_MISC_SET {
    type Type = u32;
    #[inline(always)]
