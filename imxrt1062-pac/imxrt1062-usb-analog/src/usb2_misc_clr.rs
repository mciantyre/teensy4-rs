#[doc = "Reader of register USB2_MISC_CLR"]
pub type R = crate::R<u32, super::USB2_MISC_CLR>;
#[doc = "Writer for register USB2_MISC_CLR"]
pub type W = crate::W<u32, super::USB2_MISC_CLR>;
#[doc = "Register USB2_MISC_CLR `reset()`'s with value 0x02"]
impl crate::ResetValue for super::USB2_MISC_CLR {
    type Type = u32;
    #[inline(always)]
