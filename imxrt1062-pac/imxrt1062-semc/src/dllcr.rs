...
#[doc = "Register DLLCR `reset()`'s with value 0x0100"]
...
impl R {
    ...
    #[doc = "Bits 3:6 - The delay target for slave delay line is: ((SLVDLYTARGET+1) * 1/32 * clock cycle of reference clock (ipgclock)."]
    #[inline(always)]
