#[doc = "Reader of register OSC_CONFIG1"]
pub type R = crate::R<u32, super::OSC_CONFIG1>;
#[doc = "Writer for register OSC_CONFIG1"]
pub type W = crate::W<u32, super::OSC_CONFIG1>;
#[doc = "Register OSC_CONFIG1 `reset()`'s with value 0x02ee"]
impl crate::ResetValue for super::OSC_CONFIG1 {
    type Type = u32;
    #[inline(always)]
