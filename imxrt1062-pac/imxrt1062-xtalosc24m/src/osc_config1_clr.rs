#[doc = "Reader of register OSC_CONFIG1_CLR"]
pub type R = crate::R<u32, super::OSC_CONFIG1_CLR>;
#[doc = "Writer for register OSC_CONFIG1_CLR"]
pub type W = crate::W<u32, super::OSC_CONFIG1_CLR>;
#[doc = "Register OSC_CONFIG1_CLR `reset()`'s with value 0x02ee"]
impl crate::ResetValue for super::OSC_CONFIG1_CLR {
    type Type = u32;
    #[inline(always)]
