#[doc = "Reader of register OSC_CONFIG1_SET"]
pub type R = crate::R<u32, super::OSC_CONFIG1_SET>;
#[doc = "Writer for register OSC_CONFIG1_SET"]
pub type W = crate::W<u32, super::OSC_CONFIG1_SET>;
#[doc = "Register OSC_CONFIG1_SET `reset()`'s with value 0x02ee"]
impl crate::ResetValue for super::OSC_CONFIG1_SET {
    type Type = u32;
    #[inline(always)]
