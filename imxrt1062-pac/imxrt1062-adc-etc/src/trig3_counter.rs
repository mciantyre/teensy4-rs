#[doc = "Reader of register TRIG3_COUNTER"]
pub type R = crate::R<u32, super::TRIG3_COUNTER>;
#[doc = "Writer for register TRIG3_COUNTER"]
pub type W = crate::W<u32, super::TRIG3_COUNTER>;
#[doc = "Register TRIG3_COUNTER `reset()`'s with value 0"]
impl crate::ResetValue for super::TRIG3_COUNTER {
    type Type = u32;
    #[inline(always)]
