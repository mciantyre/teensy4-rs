#[doc = "Reader of register TRIG2_COUNTER"]
pub type R = crate::R<u32, super::TRIG2_COUNTER>;
#[doc = "Writer for register TRIG2_COUNTER"]
pub type W = crate::W<u32, super::TRIG2_COUNTER>;
#[doc = "Register TRIG2_COUNTER `reset()`'s with value 0"]
impl crate::ResetValue for super::TRIG2_COUNTER {
    type Type = u32;
    #[inline(always)]
