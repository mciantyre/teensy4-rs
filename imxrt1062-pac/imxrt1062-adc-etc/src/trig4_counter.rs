#[doc = "Reader of register TRIG4_COUNTER"]
pub type R = crate::R<u32, super::TRIG4_COUNTER>;
#[doc = "Writer for register TRIG4_COUNTER"]
pub type W = crate::W<u32, super::TRIG4_COUNTER>;
#[doc = "Register TRIG4_COUNTER `reset()`'s with value 0"]
impl crate::ResetValue for super::TRIG4_COUNTER {
    type Type = u32;
    #[inline(always)]
