#[doc = "Reader of register TRIG6_COUNTER"]
pub type R = crate::R<u32, super::TRIG6_COUNTER>;
#[doc = "Writer for register TRIG6_COUNTER"]
pub type W = crate::W<u32, super::TRIG6_COUNTER>;
#[doc = "Register TRIG6_COUNTER `reset()`'s with value 0"]
impl crate::ResetValue for super::TRIG6_COUNTER {
    type Type = u32;
    #[inline(always)]
