#[doc = "Reader of register TRIG5_CHAIN_1_0"]
pub type R = crate::R<u32, super::TRIG5_CHAIN_1_0>;
#[doc = "Writer for register TRIG5_CHAIN_1_0"]
pub type W = crate::W<u32, super::TRIG5_CHAIN_1_0>;
#[doc = "Register TRIG5_CHAIN_1_0 `reset()`'s with value 0"]
impl crate::ResetValue for super::TRIG5_CHAIN_1_0 {
    type Type = u32;
    #[inline(always)]
