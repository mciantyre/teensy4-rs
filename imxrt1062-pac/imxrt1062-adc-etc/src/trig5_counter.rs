#[doc = "Reader of register TRIG5_COUNTER"]
pub type R = crate::R<u32, super::TRIG5_COUNTER>;
#[doc = "Writer for register TRIG5_COUNTER"]
pub type W = crate::W<u32, super::TRIG5_COUNTER>;
#[doc = "Register TRIG5_COUNTER `reset()`'s with value 0"]
impl crate::ResetValue for super::TRIG5_COUNTER {
    type Type = u32;
    #[inline(always)]
