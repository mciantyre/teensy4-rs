#[doc = "Reader of register TRIG7_COUNTER"]
pub type R = crate::R<u32, super::TRIG7_COUNTER>;
#[doc = "Writer for register TRIG7_COUNTER"]
pub type W = crate::W<u32, super::TRIG7_COUNTER>;
#[doc = "Register TRIG7_COUNTER `reset()`'s with value 0"]
impl crate::ResetValue for super::TRIG7_COUNTER {
    type Type = u32;
    #[inline(always)]
