#[doc = "Reader of register TRIG0_CHAIN_1_0"]
pub type R = crate::R<u32, super::TRIG0_CHAIN_1_0>;
#[doc = "Writer for register TRIG0_CHAIN_1_0"]
pub type W = crate::W<u32, super::TRIG0_CHAIN_1_0>;
#[doc = "Register TRIG0_CHAIN_1_0 `reset()`'s with value 0"]
impl crate::ResetValue for super::TRIG0_CHAIN_1_0 {
    type Type = u32;
    #[inline(always)]
