#[doc = "Reader of register TRIG0_COUNTER"]
pub type R = crate::R<u32, super::TRIG0_COUNTER>;
#[doc = "Writer for register TRIG0_COUNTER"]
pub type W = crate::W<u32, super::TRIG0_COUNTER>;
#[doc = "Register TRIG0_COUNTER `reset()`'s with value 0"]
impl crate::ResetValue for super::TRIG0_COUNTER {
    type Type = u32;
    #[inline(always)]
