#[doc = "Reader of register SM0CAPTCOMPB"]
pub type R = crate::R<u16, super::SM0CAPTCOMPB>;
#[doc = "Writer for register SM0CAPTCOMPB"]
pub type W = crate::W<u16, super::SM0CAPTCOMPB>;
#[doc = "Register SM0CAPTCOMPB `reset()`'s with value 0"]
impl crate::ResetValue for super::SM0CAPTCOMPB {
    type Type = u16;
    #[inline(always)]
