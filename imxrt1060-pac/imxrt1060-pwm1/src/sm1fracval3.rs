#[doc = "Reader of register SM1FRACVAL3"]
pub type R = crate::R<u16, super::SM1FRACVAL3>;
#[doc = "Writer for register SM1FRACVAL3"]
pub type W = crate::W<u16, super::SM1FRACVAL3>;
#[doc = "Register SM1FRACVAL3 `reset()`'s with value 0"]
impl crate::ResetValue for super::SM1FRACVAL3 {
    type Type = u16;
    #[inline(always)]
