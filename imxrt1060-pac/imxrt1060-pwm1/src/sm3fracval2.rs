#[doc = "Reader of register SM3FRACVAL2"]
pub type R = crate::R<u16, super::SM3FRACVAL2>;
#[doc = "Writer for register SM3FRACVAL2"]
pub type W = crate::W<u16, super::SM3FRACVAL2>;
#[doc = "Register SM3FRACVAL2 `reset()`'s with value 0"]
impl crate::ResetValue for super::SM3FRACVAL2 {
    type Type = u16;
    #[inline(always)]
