#[doc = "Reader of register SM0DISMAP0"]
pub type R = crate::R<u16, super::SM0DISMAP0>;
#[doc = "Writer for register SM0DISMAP0"]
pub type W = crate::W<u16, super::SM0DISMAP0>;
#[doc = "Register SM0DISMAP0 `reset()`'s with value 0xffff"]
impl crate::ResetValue for super::SM0DISMAP0 {
    type Type = u16;
    #[inline(always)]
