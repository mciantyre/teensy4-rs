#[doc = "Reader of register SM1INTEN"]
pub type R = crate::R<u16, super::SM1INTEN>;
#[doc = "Writer for register SM1INTEN"]
pub type W = crate::W<u16, super::SM1INTEN>;
#[doc = "Register SM1INTEN `reset()`'s with value 0"]
impl crate::ResetValue for super::SM1INTEN {
    type Type = u16;
    #[inline(always)]
...
impl From<CX0IE_A> for bool {
    ...
    fn from(variant: CX0IE_A) -> Self {
        match variant {
            CX0IE_A::CX0IE_0 => false,
            CX0IE_A::CX0IE_1 => true,
        }
    }
}
...
impl From<CX1IE_A> for bool {
    ...
    fn from(variant: CX1IE_A) -> Self {
        match variant {
            CX1IE_A::CX1IE_0 => false,
            CX1IE_A::CX1IE_1 => true,
        }
    }
}
...
impl From<CB0IE_A> for bool {
    ...
    fn from(variant: CB0IE_A) -> Self {
        match variant {
            CB0IE_A::CB0IE_0 => false,
            CB0IE_A::CB0IE_1 => true,
        }
    }
}
...
impl From<CB1IE_A> for bool {
    ...
    fn from(variant: CB1IE_A) -> Self {
        match variant {
            CB1IE_A::CB1IE_0 => false,
            CB1IE_A::CB1IE_1 => true,
        }
    }
}
...
impl From<CA0IE_A> for bool {
    ...
    fn from(variant: CA0IE_A) -> Self {
        match variant {
            CA0IE_A::CA0IE_0 => false,
            CA0IE_A::CA0IE_1 => true,
        }
    }
}
...
impl From<CA1IE_A> for bool {
    ...
    fn from(variant: CA1IE_A) -> Self {
        match variant {
            CA1IE_A::CA1IE_0 => false,
            CA1IE_A::CA1IE_1 => true,
        }
    }
}
