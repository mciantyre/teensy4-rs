#[doc = "Reader of register SM0CAPTCOMPA"]
pub type R = crate::R<u16, super::SM0CAPTCOMPA>;
#[doc = "Writer for register SM0CAPTCOMPA"]
pub type W = crate::W<u16, super::SM0CAPTCOMPA>;
#[doc = "Register SM0CAPTCOMPA `reset()`'s with value 0"]
impl crate::ResetValue for super::SM0CAPTCOMPA {
    type Type = u16;
    #[inline(always)]
