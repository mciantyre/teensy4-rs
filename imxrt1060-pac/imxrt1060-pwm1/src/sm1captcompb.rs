#[doc = "Reader of register SM1CAPTCOMPB"]
pub type R = crate::R<u16, super::SM1CAPTCOMPB>;
#[doc = "Writer for register SM1CAPTCOMPB"]
pub type W = crate::W<u16, super::SM1CAPTCOMPB>;
#[doc = "Register SM1CAPTCOMPB `reset()`'s with value 0"]
impl crate::ResetValue for super::SM1CAPTCOMPB {
    type Type = u16;
    #[inline(always)]
