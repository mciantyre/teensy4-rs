#[doc = "Reader of register SM2FRACVAL1"]
pub type R = crate::R<u16, super::SM2FRACVAL1>;
#[doc = "Writer for register SM2FRACVAL1"]
pub type W = crate::W<u16, super::SM2FRACVAL1>;
#[doc = "Register SM2FRACVAL1 `reset()`'s with value 0"]
impl crate::ResetValue for super::SM2FRACVAL1 {
    type Type = u16;
    #[inline(always)]
