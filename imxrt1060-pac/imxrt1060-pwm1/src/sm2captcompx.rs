#[doc = "Reader of register SM2CAPTCOMPX"]
pub type R = crate::R<u16, super::SM2CAPTCOMPX>;
#[doc = "Writer for register SM2CAPTCOMPX"]
pub type W = crate::W<u16, super::SM2CAPTCOMPX>;
#[doc = "Register SM2CAPTCOMPX `reset()`'s with value 0"]
impl crate::ResetValue for super::SM2CAPTCOMPX {
    type Type = u16;
    #[inline(always)]
