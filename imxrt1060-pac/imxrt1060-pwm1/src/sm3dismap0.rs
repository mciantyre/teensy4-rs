#[doc = "Reader of register SM3DISMAP0"]
pub type R = crate::R<u16, super::SM3DISMAP0>;
#[doc = "Writer for register SM3DISMAP0"]
pub type W = crate::W<u16, super::SM3DISMAP0>;
#[doc = "Register SM3DISMAP0 `reset()`'s with value 0xffff"]
impl crate::ResetValue for super::SM3DISMAP0 {
    type Type = u16;
    #[inline(always)]
