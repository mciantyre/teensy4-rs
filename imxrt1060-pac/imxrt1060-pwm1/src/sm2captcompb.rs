#[doc = "Reader of register SM2CAPTCOMPB"]
pub type R = crate::R<u16, super::SM2CAPTCOMPB>;
#[doc = "Writer for register SM2CAPTCOMPB"]
pub type W = crate::W<u16, super::SM2CAPTCOMPB>;
#[doc = "Register SM2CAPTCOMPB `reset()`'s with value 0"]
impl crate::ResetValue for super::SM2CAPTCOMPB {
    type Type = u16;
    #[inline(always)]
