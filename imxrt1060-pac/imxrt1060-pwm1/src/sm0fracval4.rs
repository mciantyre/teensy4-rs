#[doc = "Reader of register SM0FRACVAL4"]
pub type R = crate::R<u16, super::SM0FRACVAL4>;
#[doc = "Writer for register SM0FRACVAL4"]
pub type W = crate::W<u16, super::SM0FRACVAL4>;
#[doc = "Register SM0FRACVAL4 `reset()`'s with value 0"]
impl crate::ResetValue for super::SM0FRACVAL4 {
    type Type = u16;
    #[inline(always)]
