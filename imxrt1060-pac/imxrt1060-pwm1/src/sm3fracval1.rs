#[doc = "Reader of register SM3FRACVAL1"]
pub type R = crate::R<u16, super::SM3FRACVAL1>;
#[doc = "Writer for register SM3FRACVAL1"]
pub type W = crate::W<u16, super::SM3FRACVAL1>;
#[doc = "Register SM3FRACVAL1 `reset()`'s with value 0"]
impl crate::ResetValue for super::SM3FRACVAL1 {
    type Type = u16;
    #[inline(always)]
