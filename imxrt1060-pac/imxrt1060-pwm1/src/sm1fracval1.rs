#[doc = "Reader of register SM1FRACVAL1"]
pub type R = crate::R<u16, super::SM1FRACVAL1>;
#[doc = "Writer for register SM1FRACVAL1"]
pub type W = crate::W<u16, super::SM1FRACVAL1>;
#[doc = "Register SM1FRACVAL1 `reset()`'s with value 0"]
impl crate::ResetValue for super::SM1FRACVAL1 {
    type Type = u16;
    #[inline(always)]
