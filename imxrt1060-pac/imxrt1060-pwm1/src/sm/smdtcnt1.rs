#[doc = "Reader of register SMDTCNT1"]
pub type R = crate::R<u16, super::SMDTCNT1>;
#[doc = "Writer for register SMDTCNT1"]
pub type W = crate::W<u16, super::SMDTCNT1>;
#[doc = "Register SMDTCNT1 `reset()`'s with value 0x07ff"]
impl crate::ResetValue for super::SMDTCNT1 {
    type Type = u16;
    #[inline(always)]
