#[doc = "Reader of register SMTCTRL"]
pub type R = crate::R<u16, super::SMTCTRL>;
#[doc = "Writer for register SMTCTRL"]
pub type W = crate::W<u16, super::SMTCTRL>;
#[doc = "Register SMTCTRL `reset()`'s with value 0"]
impl crate::ResetValue for super::SMTCTRL {
    type Type = u16;
    #[inline(always)]
