#[doc = "Reader of register SMCAPTCOMPB"]
pub type R = crate::R<u16, super::SMCAPTCOMPB>;
#[doc = "Writer for register SMCAPTCOMPB"]
pub type W = crate::W<u16, super::SMCAPTCOMPB>;
#[doc = "Register SMCAPTCOMPB `reset()`'s with value 0"]
impl crate::ResetValue for super::SMCAPTCOMPB {
    type Type = u16;
    #[inline(always)]
