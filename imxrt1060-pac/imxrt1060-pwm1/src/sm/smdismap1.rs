#[doc = "Reader of register SMDISMAP1"]
pub type R = crate::R<u16, super::SMDISMAP1>;
#[doc = "Writer for register SMDISMAP1"]
pub type W = crate::W<u16, super::SMDISMAP1>;
#[doc = "Register SMDISMAP1 `reset()`'s with value 0xffff"]
impl crate::ResetValue for super::SMDISMAP1 {
    type Type = u16;
    #[inline(always)]
