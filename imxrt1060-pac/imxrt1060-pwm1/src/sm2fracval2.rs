#[doc = "Reader of register SM2FRACVAL2"]
pub type R = crate::R<u16, super::SM2FRACVAL2>;
#[doc = "Writer for register SM2FRACVAL2"]
pub type W = crate::W<u16, super::SM2FRACVAL2>;
#[doc = "Register SM2FRACVAL2 `reset()`'s with value 0"]
impl crate::ResetValue for super::SM2FRACVAL2 {
    type Type = u16;
    #[inline(always)]
