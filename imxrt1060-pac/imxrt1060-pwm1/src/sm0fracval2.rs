#[doc = "Reader of register SM0FRACVAL2"]
pub type R = crate::R<u16, super::SM0FRACVAL2>;
#[doc = "Writer for register SM0FRACVAL2"]
pub type W = crate::W<u16, super::SM0FRACVAL2>;
#[doc = "Register SM0FRACVAL2 `reset()`'s with value 0"]
impl crate::ResetValue for super::SM0FRACVAL2 {
    type Type = u16;
    #[inline(always)]
