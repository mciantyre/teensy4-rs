#[doc = "Reader of register SM0CAPTCTRLB"]
pub type R = crate::R<u16, super::SM0CAPTCTRLB>;
#[doc = "Writer for register SM0CAPTCTRLB"]
pub type W = crate::W<u16, super::SM0CAPTCTRLB>;
#[doc = "Register SM0CAPTCTRLB `reset()`'s with value 0"]
impl crate::ResetValue for super::SM0CAPTCTRLB {
    type Type = u16;
    #[inline(always)]
...
pub enum ARMB_A {
    ...
    ARMB_0,
    #[doc = "1: Input capture operation as specified by CAPTCTRLB\\[EDGBx\\] is enabled."]
    ARMB_1,
}
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum ONESHOTB_A {
    #[doc = "0: Free running mode is selected. If both capture circuits are enabled, then capture circuit 0 is armed first after CAPTCTRLB\\[ARMB\\] is set. Once a capture occurs, capture circuit 0 is disarmed and capture circuit 1 is armed. After capture circuit 1 performs a capture, it is disarmed and capture circuit 0 is re-armed. The process continues indefinitely.If only one of the capture circuits is enabled, then captures continue indefinitely on the enabled capture circuit."]
    ONESHOTB_0,
...
impl From<ONESHOTB_A> for bool {
    ...
    fn from(variant: ONESHOTB_A) -> Self {
        match variant {
            ONESHOTB_A::ONESHOTB_0 => false,
            ONESHOTB_A::ONESHOTB_1 => true,
        }
    }
}
...
impl From<INP_SELB_A> for bool {
    ...
    fn from(variant: INP_SELB_A) -> Self {
        match variant {
            INP_SELB_A::INP_SELB_0 => false,
            INP_SELB_A::INP_SELB_1 => true,
        }
    }
}
...
impl From<EDGCNTB_EN_A> for bool {
    ...
    fn from(variant: EDGCNTB_EN_A) -> Self {
        match variant {
            EDGCNTB_EN_A::EDGCNTB_EN_0 => false,
            EDGCNTB_EN_A::EDGCNTB_EN_1 => true,
        }
    }
}
