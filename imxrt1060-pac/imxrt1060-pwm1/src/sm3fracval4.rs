#[doc = "Reader of register SM3FRACVAL4"]
pub type R = crate::R<u16, super::SM3FRACVAL4>;
#[doc = "Writer for register SM3FRACVAL4"]
pub type W = crate::W<u16, super::SM3FRACVAL4>;
#[doc = "Register SM3FRACVAL4 `reset()`'s with value 0"]
impl crate::ResetValue for super::SM3FRACVAL4 {
    type Type = u16;
    #[inline(always)]
