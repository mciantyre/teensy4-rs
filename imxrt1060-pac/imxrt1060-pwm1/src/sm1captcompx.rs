#[doc = "Reader of register SM1CAPTCOMPX"]
pub type R = crate::R<u16, super::SM1CAPTCOMPX>;
#[doc = "Writer for register SM1CAPTCOMPX"]
pub type W = crate::W<u16, super::SM1CAPTCOMPX>;
#[doc = "Register SM1CAPTCOMPX `reset()`'s with value 0"]
impl crate::ResetValue for super::SM1CAPTCOMPX {
    type Type = u16;
    #[inline(always)]
