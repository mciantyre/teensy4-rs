#[doc = "Reader of register FLEXPWM4_PWMA1_SELECT_INPUT"]
pub type R = crate::R<u32, super::FLEXPWM4_PWMA1_SELECT_INPUT>;
#[doc = "Writer for register FLEXPWM4_PWMA1_SELECT_INPUT"]
pub type W = crate::W<u32, super::FLEXPWM4_PWMA1_SELECT_INPUT>;
#[doc = "Register FLEXPWM4_PWMA1_SELECT_INPUT `reset()`'s with value 0"]
impl crate::ResetValue for super::FLEXPWM4_PWMA1_SELECT_INPUT {
    type Type = u32;
    #[inline(always)]
...
pub enum DAISY_A {
    ...
    GPIO_EMC_02_ALT1,
    #[doc = "1: Selecting Pad: GPIO_AD_B1_09 for Mode: ALT1"]
    GPIO_AD_B1_09_ALT1,
}
impl From<DAISY_A> for bool {
    ...
    fn from(variant: DAISY_A) -> Self {
        match variant {
            DAISY_A::GPIO_EMC_02_ALT1 => false,
            DAISY_A::GPIO_AD_B1_09_ALT1 => true,
        }
    }
}
...
impl DAISY_R {
    ...
    pub fn variant(&self) -> DAISY_A {
        match self.bits {
            ...
            true => DAISY_A::GPIO_AD_B1_09_ALT1,
        }
    }
    ...
    pub fn is_gpio_ad_b1_09_alt1(&self) -> bool {
        *self == DAISY_A::GPIO_AD_B1_09_ALT1
    }
}
...
impl<'a> DAISY_W<'a> {
    ...
    pub fn gpio_ad_b1_09_alt1(self) -> &'a mut W {
        self.variant(DAISY_A::GPIO_AD_B1_09_ALT1)
    }
