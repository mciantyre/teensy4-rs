#[doc = "Reader of register LPUART5_RX_SELECT_INPUT"]
pub type R = crate::R<u32, super::LPUART5_RX_SELECT_INPUT>;
#[doc = "Writer for register LPUART5_RX_SELECT_INPUT"]
pub type W = crate::W<u32, super::LPUART5_RX_SELECT_INPUT>;
#[doc = "Register LPUART5_RX_SELECT_INPUT `reset()`'s with value 0"]
impl crate::ResetValue for super::LPUART5_RX_SELECT_INPUT {
    type Type = u32;
    #[inline(always)]
...
pub enum DAISY_A {
    #[doc = "0: Selecting Pad: GPIO_EMC_24 for Mode: ALT2"]
    GPIO_EMC_24_ALT2,
    #[doc = "1: Selecting Pad: GPIO_B1_13 for Mode: ALT1"]
    GPIO_B1_13_ALT1,
}
impl From<DAISY_A> for bool {
    ...
    fn from(variant: DAISY_A) -> Self {
        match variant {
            DAISY_A::GPIO_EMC_24_ALT2 => false,
            DAISY_A::GPIO_B1_13_ALT1 => true,
        }
    }
}
