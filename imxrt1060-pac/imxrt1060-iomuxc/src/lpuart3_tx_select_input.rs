#[doc = "Reader of register LPUART3_TX_SELECT_INPUT"]
pub type R = crate::R<u32, super::LPUART3_TX_SELECT_INPUT>;
#[doc = "Writer for register LPUART3_TX_SELECT_INPUT"]
pub type W = crate::W<u32, super::LPUART3_TX_SELECT_INPUT>;
#[doc = "Register LPUART3_TX_SELECT_INPUT `reset()`'s with value 0"]
impl crate::ResetValue for super::LPUART3_TX_SELECT_INPUT {
    type Type = u32;
    #[inline(always)]
...
impl DAISY_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, DAISY_A> {
        use crate::Variant::*;
        match self.bits {
            0 => Val(DAISY_A::GPIO_AD_B1_06_ALT2),
            1 => Val(DAISY_A::GPIO_EMC_13_ALT2),
            2 => Val(DAISY_A::GPIO_B0_08_ALT3),
            i => Res(i),
        }
    }
    ...
    pub fn is_gpio_ad_b1_06_alt2(&self) -> bool {
        *self == DAISY_A::GPIO_AD_B1_06_ALT2
    }
...
impl<'a> DAISY_W<'a> {
    ...
    pub fn gpio_ad_b1_06_alt2(self) -> &'a mut W {
        self.variant(DAISY_A::GPIO_AD_B1_06_ALT2)
    }
    ...
    pub fn gpio_b0_08_alt3(self) -> &'a mut W {
        self.variant(DAISY_A::GPIO_B0_08_ALT3)
    }
