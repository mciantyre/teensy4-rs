#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_SD_B1_08"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_SD_B1_08>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_SD_B1_08"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_SD_B1_08>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_SD_B1_08 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_SD_B1_08 {
    type Type = u32;
    #[inline(always)]
...
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: USDHC2_DATA4 of instance: usdhc2"]
    ALT0,
    #[doc = "1: Select mux mode: ALT1 mux port: FLEXSPIA_DATA00 of instance: flexspi"]
    ALT1,
    ...
    ALT3,
    #[doc = "4: Select mux mode: ALT4 mux port: LPSPI2_SD0 of instance: lpspi2"]
    ALT4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO3_IO08 of instance: gpio3"]
    ALT5,
...
pub enum SION_A {
    ...
    DISABLED,
    #[doc = "1: Force input path of pad GPIO_SD_B1_08"]
    ENABLED,
}
