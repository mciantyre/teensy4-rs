#[doc = "Reader of register CSI_DATA09_SELECT_INPUT"]
pub type R = crate::R<u32, super::CSI_DATA09_SELECT_INPUT>;
#[doc = "Writer for register CSI_DATA09_SELECT_INPUT"]
pub type W = crate::W<u32, super::CSI_DATA09_SELECT_INPUT>;
#[doc = "Register CSI_DATA09_SELECT_INPUT `reset()`'s with value 0"]
impl crate::ResetValue for super::CSI_DATA09_SELECT_INPUT {
    type Type = u32;
    #[inline(always)]
...
pub enum DAISY_A {
    #[doc = "0: Selecting Pad: GPIO_AD_B1_08 for Mode: ALT4"]
    GPIO_AD_B1_08_ALT4,
...
impl From<DAISY_A> for bool {
    ...
    fn from(variant: DAISY_A) -> Self {
        match variant {
            DAISY_A::GPIO_AD_B1_08_ALT4 => false,
            DAISY_A::GPIO_AD_B0_04_ALT4 => true,
        }
    }
}
...
impl<'a> DAISY_W<'a> {
    ...
    pub fn gpio_ad_b1_08_alt4(self) -> &'a mut W {
        self.variant(DAISY_A::GPIO_AD_B1_08_ALT4)
    }
