#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_B0_03"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_B0_03>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_B0_03"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_B0_03>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_B0_03 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_B0_03 {
    type Type = u32;
    #[inline(always)]
...
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: LCD_VSYNC of instance: lcdif"]
    ALT0,
    #[doc = "1: Select mux mode: ALT1 mux port: QTIMER2_TIMER0 of instance: qtimer2"]
    ALT1,
    #[doc = "2: Select mux mode: ALT2 mux port: FLEXCAN1_RX of instance: flexcan1"]
    ALT2,
    #[doc = "3: Select mux mode: ALT3 mux port: LPSPI4_SCK of instance: lpspi4"]
    ALT3,
    #[doc = "4: Select mux mode: ALT4 mux port: FLEXIO2_FLEXIO03 of instance: flexio2"]
    ALT4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO2_IO03 of instance: gpio2"]
    ALT5,
    #[doc = "6: Select mux mode: ALT6 mux port: WDOG2_RESET_B_DEB of instance: wdog2"]
    ALT6,
...
pub enum SION_A {
    ...
    DISABLED,
    #[doc = "1: Force input path of pad GPIO_B0_03"]
    ENABLED,
}
