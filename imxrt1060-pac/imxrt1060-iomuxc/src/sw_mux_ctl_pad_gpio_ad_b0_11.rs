#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_AD_B0_11"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_AD_B0_11>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_AD_B0_11"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_AD_B0_11>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_AD_B0_11 `reset()`'s with value 0"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_AD_B0_11 {
    type Type = u32;
    #[inline(always)]
...
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: JTAG_TRSTB of instance: jtag_mux"]
    ALT0,
    #[doc = "1: Select mux mode: ALT1 mux port: FLEXPWM1_PWMB03 of instance: flexpwm1"]
    ALT1,
    #[doc = "2: Select mux mode: ALT2 mux port: ENET_COL of instance: enet"]
    ALT2,
    #[doc = "3: Select mux mode: ALT3 mux port: WDOG1_WDOG_B of instance: wdog1"]
    ALT3,
    #[doc = "4: Select mux mode: ALT4 mux port: CSI_DATA02 of instance: csi"]
    ALT4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO1_IO11 of instance: gpio1"]
    ALT5,
    #[doc = "6: Select mux mode: ALT6 mux port: XBAR1_IN23 of instance: xbar1"]
    ALT6,
    #[doc = "7: Select mux mode: ALT7 mux port: ENET_1588_EVENT0_IN of instance: enet"]
    ALT7,
    #[doc = "8: Select mux mode: ALT8 mux port: FLEXCAN3_RX of instance: flexcan3/canfd"]
    ALT8,
...
pub enum SION_A {
    ...
    DISABLED,
    #[doc = "1: Force input path of pad GPIO_AD_B0_11"]
    ENABLED,
}
