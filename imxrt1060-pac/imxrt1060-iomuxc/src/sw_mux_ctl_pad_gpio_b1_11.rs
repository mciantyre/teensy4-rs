#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_B1_11"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_B1_11>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_B1_11"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_B1_11>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_B1_11 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_B1_11 {
    type Type = u32;
    #[inline(always)]
...
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: LCD_DATA23 of instance: lcdif"]
    ALT0,
    #[doc = "1: Select mux mode: ALT1 mux port: QTIMER4_TIMER3 of instance: qtimer4"]
    ALT1,
    #[doc = "2: Select mux mode: ALT2 mux port: CSI_DATA01 of instance: csi"]
    ALT2,
    #[doc = "3: Select mux mode: ALT3 mux port: ENET_RX_ER of instance: enet"]
    ALT3,
    #[doc = "4: Select mux mode: ALT4 mux port: FLEXIO2_FLEXIO27 of instance: flexio2"]
    ALT4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO2_IO27 of instance: gpio2"]
    ALT5,
    #[doc = "6: Select mux mode: ALT6 mux port: LPSPI4_PCS3 of instance: lpspi4"]
    ALT6,
    #[doc = "9: Select mux mode: ALT9 mux port: FLEXIO3_FLEXIO27 of instance: flexio3"]
    ALT9,
}
...
pub enum SION_A {
    ...
    DISABLED,
    #[doc = "1: Force input path of pad GPIO_B1_11"]
    ENABLED,
}
