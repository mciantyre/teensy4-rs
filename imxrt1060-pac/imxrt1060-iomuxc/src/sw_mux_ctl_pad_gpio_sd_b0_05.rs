#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_SD_B0_05"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_SD_B0_05>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_SD_B0_05"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_SD_B0_05>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_SD_B0_05 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_SD_B0_05 {
    type Type = u32;
    #[inline(always)]
...
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: USDHC1_DATA3 of instance: usdhc1"]
    ALT0,
    #[doc = "1: Select mux mode: ALT1 mux port: FLEXPWM1_PWMB02 of instance: flexpwm1"]
    ALT1,
    #[doc = "2: Select mux mode: ALT2 mux port: LPUART8_RX of instance: lpuart8"]
    ALT2,
    #[doc = "3: Select mux mode: ALT3 mux port: XBAR1_INOUT09 of instance: xbar1"]
    ALT3,
    #[doc = "4: Select mux mode: ALT4 mux port: FLEXSPIB_DQS of instance: flexspi"]
    ALT4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO3_IO17 of instance: gpio3"]
    ALT5,
    #[doc = "6: Select mux mode: ALT6 mux port: CCM_CLKO2 of instance: ccm"]
    ALT6,
...
pub enum SION_A {
    ...
    DISABLED,
    #[doc = "1: Force input path of pad GPIO_SD_B0_05"]
    ENABLED,
}
