#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_B0_13"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_B0_13>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_B0_13"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_B0_13>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_B0_13 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_B0_13 {
    type Type = u32;
    #[inline(always)]
...
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: LCD_DATA09 of instance: lcdif"]
    ALT0,
    #[doc = "1: Select mux mode: ALT1 mux port: XBAR1_INOUT11 of instance: xbar1"]
    ALT1,
    #[doc = "2: Select mux mode: ALT2 mux port: ARM_TRACE_SWO of instance: cm7_mx6rt"]
    ALT2,
    #[doc = "3: Select mux mode: ALT3 mux port: SAI1_MCLK of instance: sai1"]
    ALT3,
    #[doc = "4: Select mux mode: ALT4 mux port: FLEXIO2_FLEXIO13 of instance: flexio2"]
    ALT4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO2_IO13 of instance: gpio2"]
    ALT5,
    #[doc = "6: Select mux mode: ALT6 mux port: SRC_BOOT_CFG09 of instance: src"]
    ALT6,
...
pub enum SION_A {
    ...
    DISABLED,
    #[doc = "1: Force input path of pad GPIO_B0_13"]
    ENABLED,
}
