#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_B0_07"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_B0_07>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_B0_07"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_B0_07>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_B0_07 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_B0_07 {
    type Type = u32;
    #[inline(always)]
...
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: LCD_DATA03 of instance: lcdif"]
    ALT0,
    #[doc = "1: Select mux mode: ALT1 mux port: QTIMER3_TIMER1 of instance: qtimer3"]
    ALT1,
    #[doc = "2: Select mux mode: ALT2 mux port: FLEXPWM2_PWMB00 of instance: flexpwm2"]
    ALT2,
    #[doc = "3: Select mux mode: ALT3 mux port: ARM_TRACE3 of instance: cm7_mx6rt"]
    ALT3,
    #[doc = "4: Select mux mode: ALT4 mux port: FLEXIO2_FLEXIO07 of instance: flexio2"]
    ALT4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO2_IO07 of instance: gpio2"]
    ALT5,
    #[doc = "6: Select mux mode: ALT6 mux port: SRC_BOOT_CFG03 of instance: src"]
    ALT6,
    #[doc = "8: Select mux mode: ALT8 mux port: ENET2_TX_ER of instance: enet2"]
    ALT8,
}
...
pub enum SION_A {
    ...
    DISABLED,
    #[doc = "1: Force input path of pad GPIO_B0_07"]
    ENABLED,
}
