#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_AD_B1_11"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_AD_B1_11>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_AD_B1_11"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_AD_B1_11>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_AD_B1_11 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_AD_B1_11 {
    type Type = u32;
    #[inline(always)]
...
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: FLEXSPIA_DATA02 of instance: flexspi"]
    ALT0,
    #[doc = "1: Select mux mode: ALT1 mux port: EWM_OUT_B of instance: ewm"]
    ALT1,
    #[doc = "2: Select mux mode: ALT2 mux port: LPUART8_RX of instance: lpuart8"]
    ALT2,
    #[doc = "3: Select mux mode: ALT3 mux port: SAI1_RX_BCLK of instance: sai1"]
    ALT3,
    #[doc = "4: Select mux mode: ALT4 mux port: CSI_DATA06 of instance: csi"]
    ALT4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO1_IO27 of instance: gpio1"]
    ALT5,
    #[doc = "6: Select mux mode: ALT6 mux port: USDHC2_RESET_B of instance: usdhc2"]
    ALT6,
    #[doc = "7: Select mux mode: ALT7 mux port: KPP_COL02 of instance: kpp"]
    ALT7,
    #[doc = "8: Select mux mode: ALT8 mux port: ENET2_1588_EVENT1_IN of instance: enet2"]
    ALT8,
    #[doc = "9: Select mux mode: ALT9 mux port: FLEXIO3_FLEXIO11 of instance: flexio3"]
    ALT9,
}
...
pub enum SION_A {
    ...
    DISABLED,
    #[doc = "1: Force input path of pad GPIO_AD_B1_11"]
    ENABLED,
}
