#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_EMC_30"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_EMC_30>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_EMC_30"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_EMC_30>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_EMC_30 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_EMC_30 {
    type Type = u32;
    #[inline(always)]
...
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: SEMC_DATA08 of instance: semc"]
    ALT0,
    #[doc = "1: Select mux mode: ALT1 mux port: FLEXPWM3_PWMB00 of instance: flexpwm3"]
    ALT1,
    #[doc = "2: Select mux mode: ALT2 mux port: LPUART6_CTS_B of instance: lpuart6"]
    ALT2,
    #[doc = "3: Select mux mode: ALT3 mux port: LPSPI1_PCS0 of instance: lpspi1"]
    ALT3,
    #[doc = "4: Select mux mode: ALT4 mux port: CSI_DATA23 of instance: csi"]
    ALT4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO4_IO30 of instance: gpio4"]
    ALT5,
...
pub enum SION_A {
    ...
    DISABLED,
    #[doc = "1: Force input path of pad GPIO_EMC_30"]
    ENABLED,
}
