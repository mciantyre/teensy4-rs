#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_SD_B0_04"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_SD_B0_04>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_SD_B0_04"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_SD_B0_04>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_SD_B0_04 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_SD_B0_04 {
    type Type = u32;
    #[inline(always)]
...
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: USDHC1_DATA2 of instance: usdhc1"]
    ALT0,
    ...
    ALT2,
    #[doc = "3: Select mux mode: ALT3 mux port: XBAR1_INOUT08 of instance: xbar1"]
    ALT3,
    #[doc = "4: Select mux mode: ALT4 mux port: FLEXSPIB_SS0_B of instance: flexspi"]
    ALT4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO3_IO16 of instance: gpio3"]
    ALT5,
    #[doc = "6: Select mux mode: ALT6 mux port: CCM_CLKO1 of instance: ccm"]
    ALT6,
