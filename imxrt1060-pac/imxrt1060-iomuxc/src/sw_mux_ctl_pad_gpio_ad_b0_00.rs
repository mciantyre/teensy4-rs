#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_AD_B0_00"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_AD_B0_00>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_AD_B0_00"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_AD_B0_00>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_AD_B0_00 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_AD_B0_00 {
    type Type = u32;
    #[inline(always)]
...
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: FLEXPWM2_PWMA03 of instance: flexpwm2"]
    ALT0,
    #[doc = "1: Select mux mode: ALT1 mux port: XBAR1_INOUT14 of instance: xbar1"]
    ALT1,
    #[doc = "2: Select mux mode: ALT2 mux port: REF_CLK_32K of instance: xtalosc"]
    ALT2,
    #[doc = "3: Select mux mode: ALT3 mux port: USB_OTG2_ID of instance: usb"]
    ALT3,
    #[doc = "4: Select mux mode: ALT4 mux port: LPI2C1_SCLS of instance: lpi2c1"]
    ALT4,
    ...
    ALT6,
    #[doc = "7: Select mux mode: ALT7 mux port: LPSPI3_SCK of instance: lpspi3"]
    ALT7,
}
