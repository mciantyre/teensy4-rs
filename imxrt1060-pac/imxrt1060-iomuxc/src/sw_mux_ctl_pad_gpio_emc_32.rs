#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_EMC_32"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_EMC_32>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_EMC_32"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_EMC_32>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_EMC_32 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_EMC_32 {
    type Type = u32;
    #[inline(always)]
...
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: SEMC_DATA10 of instance: semc"]
    ALT0,
    #[doc = "1: Select mux mode: ALT1 mux port: FLEXPWM3_PWMB01 of instance: flexpwm3"]
    ALT1,
    #[doc = "2: Select mux mode: ALT2 mux port: LPUART7_RX of instance: lpuart7"]
    ALT2,
    #[doc = "3: Select mux mode: ALT3 mux port: CCM_PMIC_RDY of instance: ccm"]
    ALT3,
    #[doc = "4: Select mux mode: ALT4 mux port: CSI_DATA21 of instance: csi"]
    ALT4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO3_IO18 of instance: gpio3"]
    ALT5,
...
pub enum SION_A {
    ...
    DISABLED,
    #[doc = "1: Force input path of pad GPIO_EMC_32"]
    ENABLED,
}
