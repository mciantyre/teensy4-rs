#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_SD_B1_02"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_SD_B1_02>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_SD_B1_02"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_SD_B1_02>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_SD_B1_02 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_SD_B1_02 {
    type Type = u32;
    #[inline(always)]
...
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: USDHC2_DATA1 of instance: usdhc2"]
    ALT0,
    #[doc = "1: Select mux mode: ALT1 mux port: FLEXSPIB_DATA01 of instance: flexspi"]
    ALT1,
    #[doc = "2: Select mux mode: ALT2 mux port: FLEXPWM2_PWMA03 of instance: flexpwm2"]
    ALT2,
    #[doc = "3: Select mux mode: ALT3 mux port: SAI1_TX_DATA01 of instance: sai1"]
    ALT3,
    #[doc = "4: Select mux mode: ALT4 mux port: FLEXCAN1_TX of instance: flexcan1"]
    ALT4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO3_IO02 of instance: gpio3"]
    ALT5,
    #[doc = "6: Select mux mode: ALT6 mux port: CCM_WAIT of instance: ccm"]
    ALT6,
    #[doc = "8: Select mux mode: ALT8 mux port: SAI3_TX_SYNC of instance: sai3"]
    ALT8,
}
...
pub enum SION_A {
    ...
    DISABLED,
    #[doc = "1: Force input path of pad GPIO_SD_B1_02"]
    ENABLED,
}
