#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_B1_09"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_B1_09>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_B1_09"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_B1_09>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_B1_09 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_B1_09 {
    type Type = u32;
    #[inline(always)]
...
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: LCD_DATA21 of instance: lcdif"]
    ALT0,
    #[doc = "1: Select mux mode: ALT1 mux port: QTIMER2_TIMER3 of instance: qtimer2"]
    ALT1,
    #[doc = "2: Select mux mode: ALT2 mux port: CSI_DATA10 of instance: csi"]
    ALT2,
    #[doc = "3: Select mux mode: ALT3 mux port: ENET_TX_EN of instance: enet"]
    ALT3,
    #[doc = "4: Select mux mode: ALT4 mux port: FLEXIO2_FLEXIO25 of instance: flexio2"]
    ALT4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO2_IO25 of instance: gpio2"]
    ALT5,
    #[doc = "6: Select mux mode: ALT6 mux port: FLEXCAN2_RX of instance: flexcan2"]
    ALT6,
    #[doc = "8: Select mux mode: ALT8 mux port: GPT1_COMPARE3 of instance: gpt1"]
    ALT8,
    #[doc = "9: Select mux mode: ALT9 mux port: FLEXIO3_FLEXIO25 of instance: flexio3"]
    ALT9,
}
...
pub enum SION_A {
    ...
    DISABLED,
    #[doc = "1: Force input path of pad GPIO_B1_09"]
    ENABLED,
}
