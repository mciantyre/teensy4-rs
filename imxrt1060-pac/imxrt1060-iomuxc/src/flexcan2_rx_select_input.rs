#[doc = "Reader of register FLEXCAN2_RX_SELECT_INPUT"]
pub type R = crate::R<u32, super::FLEXCAN2_RX_SELECT_INPUT>;
#[doc = "Writer for register FLEXCAN2_RX_SELECT_INPUT"]
pub type W = crate::W<u32, super::FLEXCAN2_RX_SELECT_INPUT>;
#[doc = "Register FLEXCAN2_RX_SELECT_INPUT `reset()`'s with value 0"]
impl crate::ResetValue for super::FLEXCAN2_RX_SELECT_INPUT {
    type Type = u32;
    #[inline(always)]
...
pub enum DAISY_A {
    #[doc = "0: Selecting Pad: GPIO_EMC_10 for Mode: ALT3"]
    GPIO_EMC_10_ALT3,
    #[doc = "1: Selecting Pad: GPIO_AD_B0_03 for Mode: ALT0"]
    GPIO_AD_B0_03_ALT0,
    #[doc = "2: Selecting Pad: GPIO_AD_B0_15 for Mode: ALT6"]
    GPIO_AD_B0_15_ALT6,
    #[doc = "3: Selecting Pad: GPIO_B1_09 for Mode: ALT6"]
    GPIO_B1_09_ALT6,
}
impl From<DAISY_A> for u8 {
    ...
    fn from(variant: DAISY_A) -> Self {
        match variant {
            DAISY_A::GPIO_EMC_10_ALT3 => 0,
            DAISY_A::GPIO_AD_B0_03_ALT0 => 1,
            DAISY_A::GPIO_AD_B0_15_ALT6 => 2,
            DAISY_A::GPIO_B1_09_ALT6 => 3,
        }
    }
}
...
impl DAISY_R {
    ...
    pub fn variant(&self) -> DAISY_A {
        match self.bits {
            0 => DAISY_A::GPIO_EMC_10_ALT3,
            1 => DAISY_A::GPIO_AD_B0_03_ALT0,
            2 => DAISY_A::GPIO_AD_B0_15_ALT6,
            3 => DAISY_A::GPIO_B1_09_ALT6,
            _ => unreachable!(),
        }
    }
