#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_AD_B0_03"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_AD_B0_03>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_AD_B0_03"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_AD_B0_03>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_AD_B0_03 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_AD_B0_03 {
    type Type = u32;
    #[inline(always)]
...
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: FLEXCAN2_RX of instance: flexcan2"]
    ALT0,
    #[doc = "1: Select mux mode: ALT1 mux port: XBAR1_INOUT17 of instance: xbar1"]
    ALT1,
    #[doc = "2: Select mux mode: ALT2 mux port: LPUART6_RX of instance: lpuart6"]
    ALT2,
    #[doc = "3: Select mux mode: ALT3 mux port: USB_OTG1_OC of instance: usb"]
    ALT3,
    #[doc = "4: Select mux mode: ALT4 mux port: FLEXPWM1_PWMX01 of instance: flexpwm1"]
    ALT4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO1_IO03 of instance: gpio1"]
    ALT5,
    #[doc = "6: Select mux mode: ALT6 mux port: REF_CLK_24M of instance: anatop"]
    ALT6,
    #[doc = "7: Select mux mode: ALT7 mux port: LPSPI3_PCS0 of instance: lpspi3"]
    ALT7,
}
...
pub enum SION_A {
    ...
    DISABLED,
    #[doc = "1: Force input path of pad GPIO_AD_B0_03"]
    ENABLED,
}
