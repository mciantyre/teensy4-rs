#[doc = "Reader of register SW_PAD_CTL_PAD_GPIO_SD_B1_09"]
pub type R = crate::R<u32, super::SW_PAD_CTL_PAD_GPIO_SD_B1_09>;
#[doc = "Writer for register SW_PAD_CTL_PAD_GPIO_SD_B1_09"]
pub type W = crate::W<u32, super::SW_PAD_CTL_PAD_GPIO_SD_B1_09>;
#[doc = "Register SW_PAD_CTL_PAD_GPIO_SD_B1_09 `reset()`'s with value 0x10b0"]
impl crate::ResetValue for super::SW_PAD_CTL_PAD_GPIO_SD_B1_09 {
    type Type = u32;
    #[inline(always)]
