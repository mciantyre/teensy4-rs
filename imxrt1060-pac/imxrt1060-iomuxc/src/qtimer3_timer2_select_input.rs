#[doc = "Reader of register QTIMER3_TIMER2_SELECT_INPUT"]
pub type R = crate::R<u32, super::QTIMER3_TIMER2_SELECT_INPUT>;
#[doc = "Writer for register QTIMER3_TIMER2_SELECT_INPUT"]
pub type W = crate::W<u32, super::QTIMER3_TIMER2_SELECT_INPUT>;
#[doc = "Register QTIMER3_TIMER2_SELECT_INPUT `reset()`'s with value 0"]
impl crate::ResetValue for super::QTIMER3_TIMER2_SELECT_INPUT {
    type Type = u32;
    #[inline(always)]
...
pub enum DAISY_A {
    #[doc = "0: Selecting Pad: GPIO_EMC_17 for Mode: ALT4"]
    GPIO_EMC_17_ALT4,
    #[doc = "1: Selecting Pad: GPIO_AD_B1_02 for Mode: ALT1"]
    GPIO_AD_B1_02_ALT1,
    #[doc = "2: Selecting Pad: GPIO_B0_08 for Mode: ALT1"]
    GPIO_B0_08_ALT1,
}
impl From<DAISY_A> for u8 {
    ...
    fn from(variant: DAISY_A) -> Self {
        match variant {
            DAISY_A::GPIO_EMC_17_ALT4 => 0,
            DAISY_A::GPIO_AD_B1_02_ALT1 => 1,
            DAISY_A::GPIO_B0_08_ALT1 => 2,
        }
    }
}
...
impl DAISY_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, DAISY_A> {
        use crate::Variant::*;
        match self.bits {
            0 => Val(DAISY_A::GPIO_EMC_17_ALT4),
            1 => Val(DAISY_A::GPIO_AD_B1_02_ALT1),
            2 => Val(DAISY_A::GPIO_B0_08_ALT1),
            i => Res(i),
        }
    }
