#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_EMC_22"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_EMC_22>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_EMC_22"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_EMC_22>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_EMC_22 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_EMC_22 {
    type Type = u32;
    #[inline(always)]
...
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: SEMC_BA1 of instance: semc"]
    ALT0,
    #[doc = "1: Select mux mode: ALT1 mux port: FLEXPWM3_PWMB03 of instance: flexpwm3"]
    ALT1,
    #[doc = "2: Select mux mode: ALT2 mux port: LPI2C3_SCL of instance: lpi2c3"]
    ALT2,
    #[doc = "3: Select mux mode: ALT3 mux port: ENET_TDATA00 of instance: enet"]
    ALT3,
    #[doc = "4: Select mux mode: ALT4 mux port: QTIMER2_TIMER3 of instance: qtimer2"]
    ALT4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO4_IO22 of instance: gpio4"]
    ALT5,
    #[doc = "8: Select mux mode: ALT8 mux port: FLEXSPI2_A_SS1_B of instance: flexspi2"]
    ALT8,
}
...
pub enum SION_A {
    ...
    DISABLED,
    #[doc = "1: Force input path of pad GPIO_EMC_22"]
    ENABLED,
}
