#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_EMC_19"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_EMC_19>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_EMC_19"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_EMC_19>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_EMC_19 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_EMC_19 {
    type Type = u32;
    #[inline(always)]
...
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: SEMC_ADDR11 of instance: semc"]
    ALT0,
    ...
    ALT2,
    #[doc = "3: Select mux mode: ALT3 mux port: ENET_RDATA01 of instance: enet"]
    ALT3,
    #[doc = "4: Select mux mode: ALT4 mux port: QTIMER2_TIMER0 of instance: qtimer2"]
    ALT4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO4_IO19 of instance: gpio4"]
    ALT5,
    #[doc = "6: Select mux mode: ALT6 mux port: SNVS_VIO_5 of instance: snvs_hp"]
    ALT6,
}
...
pub enum SION_A {
    ...
    DISABLED,
    #[doc = "1: Force input path of pad GPIO_EMC_19"]
    ENABLED,
}
