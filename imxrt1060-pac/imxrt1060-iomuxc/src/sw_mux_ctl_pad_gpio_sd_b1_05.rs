#[doc = "Reader of register SW_MUX_CTL_PAD_GPIO_SD_B1_05"]
pub type R = crate::R<u32, super::SW_MUX_CTL_PAD_GPIO_SD_B1_05>;
#[doc = "Writer for register SW_MUX_CTL_PAD_GPIO_SD_B1_05"]
pub type W = crate::W<u32, super::SW_MUX_CTL_PAD_GPIO_SD_B1_05>;
#[doc = "Register SW_MUX_CTL_PAD_GPIO_SD_B1_05 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::SW_MUX_CTL_PAD_GPIO_SD_B1_05 {
    type Type = u32;
    #[inline(always)]
...
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: USDHC2_CMD of instance: usdhc2"]
    ALT0,
    #[doc = "1: Select mux mode: ALT1 mux port: FLEXSPIA_DQS of instance: flexspi"]
    ALT1,
    #[doc = "2: Select mux mode: ALT2 mux port: LPI2C1_SDA of instance: lpi2c1"]
    ALT2,
    #[doc = "3: Select mux mode: ALT3 mux port: SAI1_RX_BCLK of instance: sai1"]
    ALT3,
    #[doc = "4: Select mux mode: ALT4 mux port: FLEXSPIB_SS0_B of instance: flexspi"]
    ALT4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO3_IO05 of instance: gpio3"]
    ALT5,
    #[doc = "8: Select mux mode: ALT8 mux port: SAI3_RX_SYNC of instance: sai3"]
    ALT8,
}
...
pub enum SION_A {
    ...
    DISABLED,
    #[doc = "1: Force input path of pad GPIO_SD_B1_05"]
    ENABLED,
}
